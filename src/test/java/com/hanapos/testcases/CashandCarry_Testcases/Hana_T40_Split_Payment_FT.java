...
public class Hana_T40_Split_Payment_FT extends TestBaseClass {
    ...
    @Owner("Balaji N")
    @Description("Hana_T40 :- Split Payment functionality on Cash And Carry Page")
    ...
    public void Validate_Hana_T40_Split_Payment_Test(String searchandselectitemcode, String customername, String occasion, String ccfname, String cclname, String creditcardtype, String cccardnumber, String cccvv, String cczipcode, String ccamount, String checkamount,
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow1(), "Check", "Test Step - 16 - Check payment is not displayed on payment details table in row 1");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow1(), "($" + checkamount + ".00)", "Test Step - 16 - Added Check Paid amount is not matched on payment details table in row 1");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow2(), "Cash", "Test Step - 20 - cash payment is not displayed on payment details table in row 2");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow2().contains(cashandcarrypayment.getEnteredGivenAmountOnCashTab()), true, "Test Step - 20 - Added amount is not matched on payment details table in row 2");
            ...
            softassert.assertEquals(cashandcarrypayment.getEnteredPOHAmountOnPOHPaymentTab(), pohamount, "Test Step - 24 - Entered POH Amount Textbox field value is not displayed on cash and carry payment page");
            cashandcarrypayment.ClickProcessPaymentBtn();

            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow3(), "Paid Outside Hana", "Test Step - 24 - POH payment is not displayed on payment details table in row 3");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow3().contains(cashandcarrypayment.getEnteredPOHAmountOnPOHPaymentTab()), true, "Test Step - 24 - Added amount is not matched on payment details table in row 3");
            ...
            //   softassert.assertEquals(cashandcarrypayment.getDisplayedPaymentAmtOnGiftCardPaymentTab(), balance, "Test Step - 26 - Balance amount is not displayed on Gift Card payment tab");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow4(), "Gift Card", "Test Step - 27 - Gift Card payment type is not displayed on payment details table in row 4");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow4(), "($" + giftamt + ".00)", "Test Step - 27 - Added gift payment amount is not matched on payment details table in row 4");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow1(), "Check", "Test Step - 31: Payment type is not displayed on Check tab");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow1(), "($" + checkamount + ".00)", "Test Step - 31: Entered check Payment amount is not displayed on Check tab");

            delayWithGivenTime(1000);
            cashandcarrypayment.ClickCashTab();
            delayWithGivenTime(1000);
            softassert.assertFalse(cashandcarrypayment.VerifyProcessPaymentButton(), " Test Step - 31: Process payment button is not disabled on Cash tab");

            delayWithGivenTime(1000);
            cashandcarrypayment.SelectRegistryOnCashTab(prop.getProperty("cashandcarryclerkname"));
            softassert.assertEquals(cashandcarrypayment.get_selected_registry(), prop.getProperty("cashandcarryclerkname"), "Test Step 31: Selected cash registry is not displayed");

            delayWithGivenTime(1000);
            cashandcarrypayment.EnterGivenAmountOnCashTab(cashamount);
            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.getEnteredGivenAmountOnCashTab(), cashamount, "Test Step - 31: Entered given amount is not displayed");
            cashandcarrypayment.ClickProcessPaymentBtn();

            delayWithGivenTime(1000);//contains(cashandcarrypayment.getEnteredGivenAmountOnCashTab())
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow2(), "Cash", "Test Step - 31: Payment type as Cash is not displayed on payment details row 2");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow2(), "($" + cashamount + ".00)", "Test Step - 31: Entered Cash Paid amount is not displayed on payment details row 2");
            ...
            delayWithGivenTime(1000);
            cashandcarrypayment.EnterPOHAmountOnPOHPaymentTab(pohamount);
            softassert.assertEquals(cashandcarrypayment.getEnteredPOHAmountOnPOHPaymentTab(), pohamount, "Test Step - 31: Entered POH amount is not displayed on cash and carry payment tab");
            cashandcarrypayment.ClickProcessPaymentBtn();
            delayWithGivenTime(1000);

            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow3(), "Paid Outside Hana", "Test Step - 31: Payment type as Paid Outside Hana is not displayed on payment details row 3");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow3().contains(cashandcarrypayment.getEnteredPOHAmountOnPOHPaymentTab()), true, "Test Step - 31: Paid amount is not displayed on payment details row 3");
            ...
            cashandcarrypayment.EnterGiftCardNumberOnGiftCardPaymentTab(giftcardnum);
            softassert.assertEquals(cashandcarrypayment.getEnteredGiftCardAmountOnGiftCardPaymentTab(), giftcardnum, "Test Step - 31 - Entered Gift Card Number is not displayed on Gift Card payment tab");
            softassert.assertEquals(cashandcarrypayment.getDisplayedCustNameOnGiftCardPaymentTab(), "Abish David", "Test Step - 31 - Customer name is not displayed on Gift Card payment tab");
            //  softassert.assertEquals(cashandcarrypayment.getDisplayedPaymentAmtOnGiftCardPaymentTab() + "0", balance, "Test Step - 31 - Balance amount is not displayed on Gift Card payment tab");

            delayWithGivenTime(1000);
            cashandcarrypayment.EnterPaymentAmtOnGiftCardPaymentTab(giftamt);
            softassert.assertEquals(cashandcarrypayment.getDisplayedPaymentAmtOnGiftCardPaymentTab(), giftamt, "Test Step - 31 - Gift Card payment amount is not displayed on Gift Card payment tab");
            cashandcarrypayment.ClickProcessPaymentBtn();

            delayWithGivenTime(1000);
            softassert.assertEquals(cashandcarrypayment.VerifyPaymentTypeOnTableRow4(), "Gift Card", "Test Step - 31 - Gift Card payment type is not displayed on payment details table in row 4");
            softassert.assertEquals(cashandcarrypayment.VerifyPaidAmountOnTableRow4(), "($" + giftamt + ".00)", "Test Step - 31 - Added gift payment amount is not matched on payment details table in row 4");
