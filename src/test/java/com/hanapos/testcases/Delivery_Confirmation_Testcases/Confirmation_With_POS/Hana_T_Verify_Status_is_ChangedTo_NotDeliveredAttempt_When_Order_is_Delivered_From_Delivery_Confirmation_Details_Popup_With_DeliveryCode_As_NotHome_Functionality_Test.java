...
public class Hana_T_Verify_Status_is_ChangedTo_NotDeliveredAttempt_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_NotHome_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T_Verify_Status_is_ChangedTo_NotDeliveredAttempt_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_NotHome_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//            softassert.assertEquals(dashboardorder.validateDashboardOrderPage(), prop.getProperty("livedashboardorderURL"), "Test Step - 18 - All orders page is not displayed");
            ...
            // Test Step - 22, 23, 24
            confirmationPage.select_delivery_code_Confirmation_Page("Not Home");
            softassert.assertEquals(confirmationPage.get_selected_delivery_code_Confirmation_Page(), "Not Home", "Test Step - 22 - Selected delivery code is not displayed properly on confirmation page");
...
//            dashboard.ClickOrder();
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Code_On_Dispatch_Tab(), "Not Home - NH", "Test Step - 26 - Delivered code is not displayed properly on dispatch tab of order info popup");
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Date_Time_LeftSide(), deliveryconfirmation_date_time + " 6:00PM (Not Home - NH)", "Test Step - 26 - Delivered date and time is not displayed properly in left side of order info popup");
