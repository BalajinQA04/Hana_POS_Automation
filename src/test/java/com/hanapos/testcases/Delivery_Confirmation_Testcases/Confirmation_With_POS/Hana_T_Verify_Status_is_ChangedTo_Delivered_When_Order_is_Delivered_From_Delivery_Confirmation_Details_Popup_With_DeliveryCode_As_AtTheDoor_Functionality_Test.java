...
public class Hana_T_Verify_Status_is_ChangedTo_Delivered_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_AtTheDoor_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T_Verify_Status_is_ChangedTo_Delivered_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//            softassert.assertEquals(dashboardorder.validateDashboardOrderPage(), prop.getProperty("livedashboardorderURL"), "Test Step - 18 - All orders page is not displayed");
           ...
           // dashboardorder.click_Close_Icon_QuickView_Popup();
            ...
            softassert.assertEquals(confirmationPage.get_selected_delivery_code_Confirmation_Page(), "At The Door", "Test Step - 22 - Selected delivery code is not displayed properly on confirmation page");

            confirmationPage.click_Delivery_Time_Field();
            confirmationPage.select_Delivery_Time("3:15 PM");
           ...
           // dashboard.ClickOrder();
            ...
            softassert.assertEquals(dashboardorder.get_OrderStatus_DeliveryPopup(), "Delivered", "Test Step - 13 - Order status is not updated as expected in invoice popup");
            delayWithGivenTime(2000);
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivery_Confirmation_Message(),
                    "DELIVERY CONFIRMATION\n" +
                            deliveryconfirmation_date_time + " 3:15PM\n" +
                            "Delivery : " + deliveryconfirmation_date_time + " 3:15PM\n" +
                            "At The Door - AD\n" +
                            "DRIVER : LJB\n" +
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Date_Time_LeftSide(), deliveryconfirmation_date_time + " 3:15PM (At The Door - AD)", "Test Step - 26 - Delivered date and time is not displayed properly in left side of order info popup"); // 3:15 PM
