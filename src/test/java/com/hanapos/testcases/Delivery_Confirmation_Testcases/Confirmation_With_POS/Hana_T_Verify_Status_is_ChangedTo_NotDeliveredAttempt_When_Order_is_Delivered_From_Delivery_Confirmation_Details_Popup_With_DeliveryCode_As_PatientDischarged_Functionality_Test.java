...
public class Hana_T_Verify_Status_is_ChangedTo_NotDeliveredAttempt_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_PatientDischarged_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T_Verify_Status_is_ChangedTo_NotDeliveredAttempt_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_PatientDischarged_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//            dashboardorder.close_QuickView();
            ...
            // Test Step - 22, 23, 24
            confirmationPage.select_delivery_code_Confirmation_Page("Patient Discharged");
            softassert.assertEquals(confirmationPage.get_selected_delivery_code_Confirmation_Page(), "Patient Discharged", "Test Step - 22 - Selected delivery code is not displayed properly on confirmation page");
            ...
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "Not Delivered Delivery Attempted\nDriver: Liam Jack Benjamin", "Test Step - 26 - Order status is not displayed as Not Delivered Delivery Attempted for the respective order");
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Code_On_Dispatch_Tab(), "Not Delivered. Patient Dischar - PD", "Test Step - 26 - Delivered code is not displayed properly on dispatch tab of order info popup");
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivery_Confirmation_Message(),
                    "DELIVERY CONFIRMATION\n" +
                            ...
                            "Not Delivered. Patient Dischar - PD\n" +
                            "DRIVER : LJB\n" +
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Date_Time_LeftSide(), deliveryconfirmation_date_time + " 6:00PM (Not Delivered. Patient Dischar - PD)", "Test Step - 26 - Delivered date and time is not displayed properly in left side of order info popup");
