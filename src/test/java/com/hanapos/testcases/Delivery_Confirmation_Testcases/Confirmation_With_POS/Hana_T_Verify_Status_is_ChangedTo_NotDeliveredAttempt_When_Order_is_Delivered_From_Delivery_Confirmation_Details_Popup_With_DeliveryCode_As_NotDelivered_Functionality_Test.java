...
public class Hana_T_Verify_Status_is_ChangedTo_NotDeliveredAttempt_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_NotDelivered_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T_Verify_Status_is_ChangedTo_NotDeliveredAttempt_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_With_DeliveryCode_As_NotDelivered_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            phoneorder.SearchAndSelectReciAddress1("125 Campbellton Meadows Rd, New Haven, MO");
            delayWithGivenTime(2000);
...
//            softassert.assertEquals(dashboardorder.validateDashboardOrderPage(), prop.getProperty("livedashboardorderURL"), "Test Step - 18 - All orders page is not displayed");
          ...
          //  dashboardorder.close_QuickView();
            ...
            softassert.assertEquals(confirmationPage.get_selected_delivery_code_Confirmation_Page(), "Not Delivered", "Test Step - 22 - Selected delivery code is not displayed properly on confirmation page");
            ...
            softassert.assertEquals(dashboardorder.get_OrderStatus_DeliveryPopup(), "Not Delivered Delivery Attempted", "Test Step - 26 - Order status is not updated as expected in invoice popup");
            delayWithGivenTime(2000);
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Code_On_Dispatch_Tab(), "Not Delivered - We Attempted Delivery on: " + getCurrentDateInAST() + " 06:00 PM We attempted delivery on this order but we were unable to finish delivery because of unavailability of recipient. Thank You.", "Test Step - 26 - Delivered code is not displayed properly on dispatch tab of order info popup");
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivery_Confirmation_Message(),
                    "DELIVERY CONFIRMATION\n" +
                            ...
                            "Not Delivered - We Attempted Delivery on: " + getCurrentDateInAST() + " 06:00 PM We attempted delivery on this order but we were unable to finish delivery because of unavailability of recipient. Thank You." +
                            "\nDRIVER : LJB\n" +
            ...
            softassert.assertEquals(dashboardorder.get_Displayed_Delivered_Date_Time_LeftSide(), deliveryconfirmation_date_time + " 6:00PM (Not Delivered - We Attempted Delivery on: " + getCurrentDateInAST() + " 06:00 PM We attempted delivery on this order but we were unable to finish delivery because of unavailability of recipient. Thank You.)", "Test Step - 26 - Delivered date and time is not displayed properly in left side of order info popup");
