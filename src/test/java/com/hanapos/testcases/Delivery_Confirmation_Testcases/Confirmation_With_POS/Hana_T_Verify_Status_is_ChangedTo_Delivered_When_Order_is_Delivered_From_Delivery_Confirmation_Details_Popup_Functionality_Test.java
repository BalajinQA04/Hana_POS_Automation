...
public class Hana_T_Verify_Status_is_ChangedTo_Delivered_When_Order_is_Delivered_From_Delivery_Confirmation_Details_Popup_Functionality_Test extends TestBaseClass {
...
//            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoiceNumber), "Test Step - 10 - Respective Invoice number : " + invoiceNumber + " is not displayed on all orders page");
         ...
         //   dashboardorder.click_Close_Icon_QuickView_Popup();
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(ordertype, deliverytype, mop), "Test Step - 12 - In orders summary page - " + mop + " payment type invoice number is not displayed for placed order");
