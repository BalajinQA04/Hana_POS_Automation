...
public class Hana_T1454_OrderPage_AllOrders_Verify_Status_is_ChangedTo_Not_Delivered_Delivery_Attempted_When_Order_is_Delivered_From_Hana_Viewers_App_Functionality_Test extends TestBaseClass {
    ...
    @Description("Verify Phone Order Status Changed to Not Delivered (Delivery Attempted) by Hana Viewers mobile App with existing customer functionality")
    @Test(enabled = true, groups = {"Regression", "Smoke", "Sanity"}, dataProvider = "fetch_Excel_Data")
    public void Validate_Hana_T1454_OrderPage_AllOrders_Verify_Status_is_ChangedTo_Not_Delivered_Delivery_Attempted_When_Order_is_Delivered_From_Hana_Viewers_App_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(invoiceNumber), "Invoice Order is not displayed on trip section");
            ...
            softassert.assertEquals(dashboardorder.validate_DeliveryType_On_AllOrdersPage(invoiceNumber), deliverytype, "Test Step - 19 - In orders summary page - " + deliverytype + " payment type invoice number is not displayed for placed order");
