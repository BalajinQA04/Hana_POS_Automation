...
public class Hana_T1241_Webadmin_Categories_Edit_Categories_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T1241_Webadmin_Categories_Edit_Categories_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(webadmin_categoriespage.get_Category_Name_On_Web_Categories_Page_Table_Grid(), categoryName, "Test Step - 7: Category is not added successfully");

            delayWithGivenTime(2000);
            webadmin_categoriespage.click_Edit_Icon_On_Web_Categories_Page_Table_Grid();

            delayWithGivenTime(2000);
            editcategoryName = generateWebCategoryName();
            editmetaTitle = generateCategoryMetaTitle();
            editmetaKeywords = generate_Meta_Keywords();
            webadmin_categoriespage.edit_Category_Name(editcategoryName);
            webadmin_categoriespage.select_Edit_Parent_Category("Balaji Flower category");
            webadmin_categoriespage.edit_Category_Description(editcategoryName + " Balaji Flower category as parent category ");
            webadmin_categoriespage.edit_Meta_Title(editmetaTitle);
            webadmin_categoriespage.edit_Meta_Keywords(editmetaKeywords);
            delayWithGivenTime(2000);
            webadmin_categoriespage.click_Update_Web_Category_Button();
            delayWithGivenTime(2000);

            softassert.assertEquals(webadmin_productspage.validate_toaster_message_Text(), "Category Details Updated.", "Test Step - 7: Product Saved Successfully toaster message is not displayed");

            webadmin_categoriespage.search_Web_Category(editcategoryName);
            delayWithGivenTime(2000);
            softassert.assertEquals(webadmin_categoriespage.get_Category_Name_On_Web_Categories_Page_Table_Grid(), editcategoryName, "Test Step - 7: Category is not added successfully");
