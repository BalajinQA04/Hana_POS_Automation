...
public class Hana_T1247_Webadmin_Categories_SortBy_Category_Name_Cancel_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T1247_Webadmin_Categories_SortBy_Category_Name_Cancel_Functionality_Test() {
        ...
        try {
            ...
            // Test Step - 6
            webadmin_categoriespage.click_Cancel_Button_On_Alert_Popup();

            // Test Step - 7
            delayWithGivenTime(2000);
            softassert.assertEquals(webadmin_categoriespage.get_Selected_SortBy_Dropdown_Value(), "Select Sort Order", "Test Step - 7: Sort by dropdown value is not matching with expected value - Select Sort Order");
