...
public class Hana_T1218_Webadmin_Product_Add_New_Products_Availability_Active_Disabled_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T1218_Webadmin_Product_Add_New_Products_Availability_Active_Disabled_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(2000);
            webadmin_productspage.Deactivate_Availability_toogle_button();
//            webadmin_productspage.Activate_Web_toogle_button();
//            webadmin_productspage.Activate_Store_toogle_button();

            webadmin_productspage.Enter_Product_Variant_Name1("Small");
            ...
            softassert.assertEquals(webadmin_productspage.get_entered_product_variant_name1(), "Small", "Test Step - 6: Entered item name Product Variant for row 1 is not matched");
            ...
            delayWithGivenTime(2000);
            webadmin_productspage.drag_And_Drop_Image_On_ProductVariant1("roses red.jpg");
