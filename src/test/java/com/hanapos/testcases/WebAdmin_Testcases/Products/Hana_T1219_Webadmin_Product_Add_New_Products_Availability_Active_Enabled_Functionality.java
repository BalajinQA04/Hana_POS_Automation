...
public class Hana_T1219_Webadmin_Product_Add_New_Products_Availability_Active_Enabled_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T1219_Webadmin_Product_Add_New_Products_Availability_Active_Enabled_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(productDetailsPage.Verify_Product_Displayed_Description(), item_name, "Test Step - 4: Product description is not matching with expected product description");
