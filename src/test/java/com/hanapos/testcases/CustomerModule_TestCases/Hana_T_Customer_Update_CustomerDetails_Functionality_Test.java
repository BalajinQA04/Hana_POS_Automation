...
public class Hana_T_Customer_Update_CustomerDetails_Functionality_Test extends TestBaseClass {
    ...
    @Owner("Balaji N")
    @Description("Hana_T :- Update Customer Details Functionality Test")
    @Epic("Customers Module")
    @Test(groups = {"Regression", "Sanity", "Smoke"})
    public void Validate_Hana_T_Customer_Update_CustomerDetails_Functionality_Test() {
