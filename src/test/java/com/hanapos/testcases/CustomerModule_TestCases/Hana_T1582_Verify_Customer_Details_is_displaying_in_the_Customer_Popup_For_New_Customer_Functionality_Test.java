...
public class Hana_T1582_Verify_Customer_Details_is_displaying_in_the_Customer_Popup_For_New_Customer_Functionality_Test extends TestBaseClass {
    ...
    @Owner("Balaji N")
    @Description("Hana_T :- Create New Customer Functionality Test")
    @Epic("Customers Module")
    @Test(groups = {"Regression", "Sanity", "Smoke"})
    public void Validate_Hana_T_Verify_Customer_Details_is_displaying_in_the_Customer_Popup_For_New_Customer_Functionality_Test() {
        ...
        try {
            ...
            softassert.assertEquals(customerpage.get_Displayed_Customer_Name_On_Customer_Details_Popup_Header(), customerfullname, "Test Step - 8 - Customer Full Name on customer details popup header is not displayed properly");
            ...
            softassert.assertEquals(customerpage.get_Displayed_Customer_Phonenumber_On_Customer_Details_Popup_Header(), customerPhoneNumber, "Test Step - 8 - Customer phone number on customer details popup header is not displayed properly");
            softassert.assertEquals(customerpage.get_Displayed_Customer_CompanyName_On_Customer_Details_Popup_Header(), companyname, "Test Step - 8 - Customer Company Name on customer details popup header is not displayed properly");
            delayWithGivenTime(2000);
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(10, 11);
