...
public class Hana_T_Ecommerce_Checkout_Page_Payments_Invoice_House_Account_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T_Ecommerce_Checkout_Page_Payments_Invoice_House_Account_Functionality_Test() {
...
//            }
            ...
            checkoutPage.Select_Payment_Method(prop.getProperty("ecommerce_invoice_payment_type"));
            softassert.assertEquals(checkoutPage.get_selected_payment_method(), prop.getProperty("ecommerce_invoice_payment_type"), "Test Step - 7: Selected payment method is not matching with expected payment method");
...
//            softassert.assertEquals(checkoutPage.get_entered_CVV_on_Payment_Info(), prop.getProperty("ecommerce_cvv"), "Test Step - 7: Entered CVV is not matching with expected CVV");
            ...
            checkoutPage.click_ContinueToReview_Button();
            delayWithGivenTime(2000);
            ...
            softassert.assertEquals(checkoutPage.get_Displayed_CreditCardInfo_on_ReviewPage(), "Invoice/House Account", "Test Step - 9: Displayed Credit Card information on review page is not matching with expected recipient information on review page");
            ...
            softassert.assertEquals(order_confirmationPage.getTotalProductCostText(), "$" + order_confirmationPage.Expected_Total_Cost_Without_Processing_Fee(), "Test Step - 12: Total Product Cost text is not empty");
            ...
            softassert.assertEquals(order_confirmationPage.getDeliveryInformationText(), recifname1 + " " + recilname2 + "\n" +
                    ...
                    "Delivery Date: " + formattedDate, "Test Step - 14: Delivery Information text is not empty");

            softassert.assertEquals(order_confirmationPage.getPaymentTypeText(), "INVOICE/HOUSE ACCOUNT", "Test Step - 15: Payment Type text is not empty");
            softassert.assertEquals(order_confirmationPage.getCommentsOrSpecialInstructionsText(), prop.getProperty("cart_card_message"), "Test Step - 16: Comments or Special Instructions text is not empty");
