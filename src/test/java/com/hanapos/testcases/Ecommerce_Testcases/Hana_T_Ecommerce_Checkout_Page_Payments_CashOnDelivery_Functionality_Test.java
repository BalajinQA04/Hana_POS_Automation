...
public class Hana_T_Ecommerce_Checkout_Page_Payments_CashOnDelivery_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T_Ecommerce_Checkout_Page_Payments_CashOnDelivery_Functionality_Test() {
...
//            }
            ...
            checkoutPage.Select_Payment_Method(prop.getProperty("ecommerce_COD"));
            softassert.assertEquals(checkoutPage.get_selected_payment_method(), prop.getProperty("ecommerce_COD"), "Test Step - 7: Selected payment method is not matching with expected payment method");
            ...
            softassert.assertEquals(checkoutPage.get_Displayed_CreditCardInfo_on_ReviewPage(), "Cash On Delivery", "Test Step - 9: Displayed Credit Card information on review page is not matching with expected recipient information on review page");
            ...
            softassert.assertEquals(order_confirmationPage.getPaymentTypeText(), "COD", "Test Step - 15: Selected Payment Type text is not properly displayed");
            softassert.assertEquals(order_confirmationPage.getCommentsOrSpecialInstructionsText(), prop.getProperty("cart_card_message"), "Test Step - 16: Comments or Special Instructions text is not properly displayed");
