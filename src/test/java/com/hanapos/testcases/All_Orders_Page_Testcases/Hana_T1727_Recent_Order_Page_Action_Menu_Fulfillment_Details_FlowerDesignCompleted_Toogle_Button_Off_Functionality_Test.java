...
public class Hana_T1727_Recent_Order_Page_Action_Menu_Fulfillment_Details_FlowerDesignCompleted_Toogle_Button_Off_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1727_Recent_Order_Page_Action_Menu_Fulfillment_Details_FlowerDesignCompleted_Toogle_Button_Off_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            dashboardorder.click_Flower_Design_Completed_Toogle_Button_Off();
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_Off_State(), "Test Step - 16: By default flower design completed toggle button is not in off state");
            softassert.assertTrue(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 16: Notify customer toogle button is not disabled");
            ...
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "New\nDesigner : Stuart Markwood", "Test Step - 18: Designed status is displayed for non - designed order");
            ...
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_Off_State(), "Test Step - 18: By default flower design completed toggle button is not in off state");
            softassert.assertTrue(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 18: Notify customer toogle button is not disabled");
