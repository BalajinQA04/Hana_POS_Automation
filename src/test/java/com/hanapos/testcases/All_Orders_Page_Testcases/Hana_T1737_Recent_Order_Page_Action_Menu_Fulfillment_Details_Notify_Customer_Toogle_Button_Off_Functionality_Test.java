...
public class Hana_T1737_Recent_Order_Page_Action_Menu_Fulfillment_Details_Notify_Customer_Toogle_Button_Off_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1737_Recent_Order_Page_Action_Menu_Fulfillment_Details_Notify_Customer_Toogle_Button_Off_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertEquals(dashboardorder.get_Selected_Designer_On_FulFillment_Details_Popup(), prop.getProperty("salesperson"), "Test Step - 14 : Selected designer is not displayed");
            delayWithGivenTime(2000);
            ...
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_On_State(), "Test Step - 16: After turn on - flower design completed toggle button is not in on state");
            softassert.assertFalse(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 15: Notify customer toogle button is not Enabled After turn on - flower design completed toggle button");

            dashboardorder.turn_On_Notify_Customer_Toogle_Button_On_FulfilmentPopup();
            softassert.assertTrue(dashboardorder.verify_Notify_Customer_Toogle_Button_On_State_FulfilmentPopup(), "Test Step - 16: After turn on - notify customer toggle button is not in on state");

            dashboardorder.turn_Off_Notify_Customer_Toogle_Button_On_FulfilmentPopup();
            softassert.assertFalse(dashboardorder.verify_Notify_Customer_Toogle_Button_On_State_FulfilmentPopup(), "Test Step - 16: After turn off - notify customer toggle button is not in off state");
            ...
            softassert.assertEquals(dashboardorder.validate_Designed_Status_On_AllOrdersPage(invoiceNumber), "Designer : " + prop.getProperty("salesperson"), "Test Step - 17 - Order status as Designed : Stuart Markwood  is not displayed as delivered for order");
            softassert.assertEquals(dashboardorder.validate_Designed_label_Status_On_AllOrdersPage(invoiceNumber), "Designed: " + fullfillment_date_time, "Test Step - 17: Designed label is not displayed for designed order");

            // Test Step - 18
            delayWithGivenTime(2000);
            dashboardorder.EnterGlobalSearch(invoiceNumber);
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.validate_Designed_Status_On_AllOrdersPage(invoiceNumber), "Designer : " + prop.getProperty("salesperson"), "Test Step - 18 - Order status as Designed : Stuart Markwood  is not displayed as delivered for order");
            softassert.assertEquals(dashboardorder.validate_Designed_label_Status_On_AllOrdersPage(invoiceNumber), "Designed: " + fullfillment_date_time, "Test Step - 18: Designed label is not displayed for designed order");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.get_Selected_Designer_On_FulFillment_Details_Popup(), prop.getProperty("salesperson"), "Test Step - 18 : Selected designer is not displayed");
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_On_State(), "Test Step - 18: After turn on - flower design completed toggle button is not in on state");
            softassert.assertFalse(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 18: Notify customer toogle button is not Enabled After turn on - flower design completed toggle button");
            softassert.assertEquals(dashboardorder.get_Entered_Design_Recipe_On_Fullfillment_Details_Popup(), prop.getProperty("Design_Recipe"), "Test Step - 18: Entered Design recipe is not properly displayed");
            softassert.assertTrue(dashboardorder.verify_Notify_Customer_Toogle_Button_Off_State_FulfilmentPopup(), "Test Step - 18: After turn off - notify customer toggle button is not in off state");
            softassert.assertTrue(dashboardorder.is_Customer_Notification_Notes_Label_Not_Displayed(), "Test Step - 18: Customer notification label is displayed Even disabled the notifiy customer toogle button");
