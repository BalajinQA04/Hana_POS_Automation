...
public class Hana_T1493_AllOrdersView_Pending_Pickup_View_Phone_Order_And_Status_Pending_Functionality_Test extends TestBaseClass {
    ...
    //,invocationCount=5
    public void Validate_Hana_T1493_AllOrdersView_Pending_Pickup_View_Phone_Order_And_Status_Pending_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            // Test Step - 14
            dashboardorder.click_Pending_Pickup_Tab();
            delayWithGivenTime(2000);

            dashboardorder.click_Filters_Icon_On_All_Orders_Page();
            delayWithGivenTime(3000);
            softassert.assertEquals(dashboardorder.get_Displayed_Status_On_Filters_In_AllOrdersPage(), "Pending", "Test Step - 15: Status as Pending is not displayed on filters");
            softassert.assertEquals(dashboardorder.get_Displayed_Delivery_Option1_On_Filters_In_AllOrdersPage(), "Pick Up", "Test Step - 15: Delivery option is not displayed on filters in all orders page");
            softassert.assertEquals(dashboardorder.get_Order_Type_Dropdown_On_Filters(), "Phone Order", "Test Step - 15: Order Type filter dropdown is not displayed as phone order");
