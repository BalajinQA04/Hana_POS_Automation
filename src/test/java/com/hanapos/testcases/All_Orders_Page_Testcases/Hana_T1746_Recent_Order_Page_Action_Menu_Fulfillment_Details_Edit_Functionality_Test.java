...
public class Hana_T1746_Recent_Order_Page_Action_Menu_Fulfillment_Details_Edit_Functionality_Test extends TestBaseClass {
    ...
    String fullfillment_date_time;
    String customer_notify_date_time;
    ...
    public void Validate_Hana_T1746_Recent_Order_Page_Action_Menu_Fulfillment_Details_Edit_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.verify_FullFillment_Details_Popup_IsDisplayed(), "Test Step - 13 - Fullfillment details popup is not displayed");
            delayWithGivenTime(2000);

            dashboardorder.select_Designer_On_Fulfillment_Details_Popup("--Select User--");

            softassert.assertEquals(dashboardorder.get_Selected_Designer_On_FulFillment_Details_Popup(), "--Select User--", "Test Step - 14 : Selected designer as --Select User-- is not displayed");
            delayWithGivenTime(2000);

            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_Off_State(), "Test Step - 15: By default flower design completed toggle button is not in off state");
            softassert.assertTrue(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 15: Notify customer toogle button is not disabled by default");

            // Test Step - 17
            dashboardorder.Enter_Design_Recipe(prop.getProperty("Design_Recipe"));
            softassert.assertEquals(dashboardorder.get_Entered_Design_Recipe_On_Fullfillment_Details_Popup(), prop.getProperty("Design_Recipe"), "Test Step - 17: Entered Design recipe is not properly displayed");

            dashboardorder.clear_Entered_Design_Recipe();
            softassert.assertEquals(dashboardorder.get_Entered_Design_Recipe_On_Fullfillment_Details_Popup(), "", "Test Step - 17: Entered Design recipe is not properly displayed");

            dashboardorder.click_SubmitButton_On_Fulfillment_Details_Popup();

            softassert.assertEquals(dashboardorder.Verify_Success_Toaster_Message_Text(), "Fulfillment Saved Successfully", "Test Step - 17: Fulfillment saved successfully toaster message is not displayed");
            softassert.assertTrue(dashboardorder.verify_Designer_Name_On_Status_Cell_Not_Displayed(invoiceNumber), "Test Step - 17: Designer name is displayed on status cell");
            ...
            dashboardorder.click_Fullfillment_Submenu();
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.verify_FullFillment_Details_Popup_IsDisplayed(), "Test Step - 18 - Fullfillment details popup is not displayed");
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.get_Selected_Designer_On_FulFillment_Details_Popup(), "--Select User--", "Test Step - 18 : Selected designer is not displayed");
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_Off_State(), "Test Step - 18: After turn off - flower design completed toggle button is not in off state");
            softassert.assertTrue(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 18: Notify customer toogle button is  Enabled After turn off - flower design completed toggle button");
            softassert.assertEquals(dashboardorder.get_Entered_Design_Recipe_On_Fullfillment_Details_Popup(), "", "Test Step - 18: Entered Design recipe is not properly displayed");

            delayWithGivenTime(2000);
            dashboardorder.select_Designer_On_Fulfillment_Details_Popup(prop.getProperty("salesperson"));
            softassert.assertEquals(dashboardorder.get_Selected_Designer_On_FulFillment_Details_Popup(), prop.getProperty("salesperson"), "Test Step - 19 : Selected designer as --Select User-- is not displayed");
            dashboardorder.click_Flower_Design_Completed_Toogle_Button_On();
            delayWithGivenTime(300);
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_On_State(), "Test Step - 19: After turn on - flower design completed toggle button is not in on state");
            softassert.assertFalse(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 19: Notify customer toogle button is not Enabled After turn on - flower design completed toggle button");
            dashboardorder.Enter_Design_Recipe(prop.getProperty("Design_Recipe"));
            softassert.assertEquals(dashboardorder.get_Entered_Design_Recipe_On_Fullfillment_Details_Popup(), prop.getProperty("Design_Recipe"), "Test Step - 19: Entered Design recipe is not properly displayed");

            dashboardorder.click_SubmitButton_On_Fulfillment_Details_Popup();
            fullfillment_date_time = getAtlanticTime_NumberDateFormat();
            customer_notify_date_time = get_AST_DateAndTime();
            ...
            dashboardorder.click_Fullfillment_Submenu();
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.verify_FullFillment_Details_Popup_IsDisplayed(), "Test Step - 20 - Fullfillment details popup is not displayed");
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.get_Selected_Designer_On_FulFillment_Details_Popup(), prop.getProperty("salesperson"), "Test Step - 20 : Selected designer is not displayed");
            softassert.assertTrue(dashboardorder.is_Flower_Design_Completed_Toogle_Button_On_State(), "Test Step - 20: After turn on - flower design completed toggle button is not in on state");
            softassert.assertFalse(dashboardorder.is_Notify_Customer_Toggle_Button_Disabled(), "Test Step - 20: Notify customer toogle button is not Enabled After turn on - flower design completed toggle button");
            softassert.assertEquals(dashboardorder.get_Entered_Design_Recipe_On_Fullfillment_Details_Popup(), prop.getProperty("Design_Recipe"), "Test Step - 20: Entered Design recipe is not properly displayed");
            dashboardorder.click_Close_Icon_Fullfilment_Details_Popup();

            dashboardorder.EnterGlobalSearch(invoiceNumber);
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.validate_Designed_Status_On_AllOrdersPage(invoiceNumber), "Designer : " + prop.getProperty("salesperson"), "Test Step - 20 - Order status as Designed : Stuart Markwood  is not displayed as delivered for order");
            softassert.assertEquals(dashboardorder.validate_Designed_label_Status_On_AllOrdersPage(invoiceNumber), "Designed: " + fullfillment_date_time, "Test Step - 20: Designed label is not displayed for designed order");
