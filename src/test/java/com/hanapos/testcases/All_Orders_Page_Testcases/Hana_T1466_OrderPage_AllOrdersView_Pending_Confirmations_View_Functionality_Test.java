...
public class Hana_T1466_OrderPage_AllOrdersView_Pending_Confirmations_View_Functionality_Test extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T1465";
    ...
    public void Validate_Hana_T1466_OrderPage_AllOrdersView_Pending_Confirmations_View_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertEquals(dashboardorder.validate_OrderType_On_AllOrdersPage(invoiceNumber), ordertype, "Test Step - 6: Order Type is not properly displayed for order");
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber),mop, "Test Step - 6 - In orders summary page - " + mop + " payment type invoice number is not displayed for placed order");
            ...
            softassert.assertEquals(dispatch.get_Selected_Driver(), drivername, "Test Step - 10 - Selected Driver is not displayed on the dropdown");

            dispatch.Click_DispatchSave_Button(); // Hana Delivery Network is not enabled. Payment method is missing! Please add payment details in HDN
            //  softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Hana Delivery Network is not enabled. Payment method is missing! Please add payment details in HDN", "Test Step - 10 - Success Toaster Message is not display on quick dispatch section");
            delayWithGivenTime(2000);
            ...
            softassert.assertEquals(dashboardorder.get_Selected_View_On_AllOrdersPage(), selectview, "Test Steps - 11: Selected view is not displayed on all orders page");
            ...
            softassert.assertEquals(dashboardorder.validate_OrderType_On_AllOrdersPage(invoiceNumber), ordertype, "Test Step - 11: Order Type is not properly displayed for cash and carry order");
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber),mop, "Test Step - 11 - In orders summary page - " + mop + " payment type invoice number is not displayed for placed order");

            // Test Step - 12
            dashboardorder.click_Filters_Icon_On_All_Orders_Page();
            delayWithGivenTime(3000);
            softassert.assertEquals(dashboardorder.get_Displayed_Status_On_Filters_In_AllOrdersPage(), "Dispatched", "Test Step - 12: Status as Dispatched is not displayed on filters");
