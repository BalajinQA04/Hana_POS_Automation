...
public class Hana_T1512_AllOrdersPage_Filters_InvoiceFilter_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1512_AllOrdersPage_Filters_InvoiceFilter_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            dashboardorder.Enter_Invoice_Number_FilterIcon_On_AllOrdersPage(invoiceNumber);
            delayWithGivenTime(1000);

            softassert.assertEquals(dashboardorder.get_Entered_Invoice_Number_FilterIcon_On_AllOrdersPage(), invoiceNumber, "Test Step - 10 - Entered Invoice Number is not displayed on filters in all orders page");
            delayWithGivenTime(3000);
