...
public class Hana_T1592_HanaPOS_Orders_Cancel_Order_Credit_For_Customer_Complaint_Functionality extends TestBaseClass {
    ...
    @Description("Hana T1592 :- HanaPOS_Orders_Cancel_Order_Credit_For_Customer_Complaint_Functionality")
    @Test(enabled = true, groups = {"Smoke", "Regression", "Sanity"}, dataProvider = "fetch_Excel_Data")
    public void Validate_Hana_T1592_HanaPOS_Orders_Cancel_Order_Credit_For_Customer_Complaint_Functionality(String username,
                                                                                                       String password,
                                                                                                       String shopname,
                                                                                                       String clerkname,
                                                                                                       String employeename,
        ...
        try {
            ...
            String time = get_Current_EST_Time();
            System.out.println("Cash and Carry Payment Time : " + time);
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.get_cancelOrder_Reason(), "Credit For Customer Complaint", "Test Step - 15 - Cancel order reason is not displayed on cancel order popup");

            // Test Step - 16
            dashboardorder.Click_NoButton_CancelOrder_Popup();
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoicenumber), "Delivered", "Test Step - 16 - Cancelled order status is not displayed on order page after clicking the yes button on cancel order popup");
            ...
            dashboardorder.Select_CancelOrder_Reason("Credit For Customer Complaint");
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.get_cancelOrder_Reason(), "Credit For Customer Complaint", "Test Step - 17 - Cancel order reason is not displayed on cancel order popup");
            ...
            dashboardorder.EnterGlobalSearch(invoicenumber);
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoicenumber), "Cancelled", "Test Step - 18 - Cancelled order status is not displayed on order page after clicking the yes button on cancel order popup");
            ...
            softassert.assertTrue(
                    ...
                    "Refund message content mismatch"
            );
