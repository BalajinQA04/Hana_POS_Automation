...
public class Hana_T1729_Recent_Order_Page_Action_Menu_Fulfillment_Details_Notify_Customer_Toogle_Button_On_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1729_Recent_Order_Page_Action_Menu_Fulfillment_Details_Notify_Customer_Toogle_Button_On_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(dashboardorder.verify_Notify_Customer_Toogle_Button_On_State_FulfilmentPopup(), "Test Step - 18: After turn on - notify customer toggle button is not in on state");
            softassert.assertEquals(dashboardorder.get_Actual_Customer_Notification_Notes(), dashboardorder.getCustomerNotificationNote(customer_notify_date_time), "Test Step - 18: Customer notification label is not displayed for notified customer");
