...
public class Hana_T1465_OrderPage_AllOrdersView_Non_Deliveries_View_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1465_OrderPage_AllOrdersView_Non_Deliveries_View_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertEquals(confirmationPage.get_selected_delivery_code_Confirmation_Page(), deliverycode, "Test Step - 13 - Selected delivery code is not displayed properly on confirmation page");
            ...
            // Test Step - 15
            dashboardorder.Select_views_dropdown_on_all_ordersPage(againselectview);
            delayWithGivenTime(3000);
            softassert.assertEquals(dashboardorder.get_Selected_View_On_AllOrdersPage(), againselectview, "Test Steps - 15: Selected view as " + againselectview + " is not displayed on all orders page");
