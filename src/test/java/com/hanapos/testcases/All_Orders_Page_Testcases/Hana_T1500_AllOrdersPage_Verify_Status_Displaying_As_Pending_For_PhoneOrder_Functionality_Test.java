...
public class Hana_T1500_AllOrdersPage_Verify_Status_Displaying_As_Pending_For_PhoneOrder_Functionality_Test extends TestBaseClass {
    ...
    //,invocationCount=5
    public void Validate_Hana_T1500_AllOrdersPage_Verify_Status_Displaying_As_Pending_For_PhoneOrder_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertEquals(dashboardorder.get_pickup_confirmation_alert_message(), confirm_pickup_alert_message, "Test Step - 14: Pickup confirmation alert message is not displayed");
            delayWithGivenTime(1000);
            dashboardorder.click_yes_button_on_pickup_confirmation_alert_message();
            softassert.assertEquals(dashboardorder.Verify_Success_Toaster_Message_Text(), "Order marked as 'Picked Up'", "Test Step - 14 - Order marked as Picked Up toaster message is not displayed");

            // Test Step - 15
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "Delivered", "Test Step - 15 - Order status as New is not displayed as delivered for order");
