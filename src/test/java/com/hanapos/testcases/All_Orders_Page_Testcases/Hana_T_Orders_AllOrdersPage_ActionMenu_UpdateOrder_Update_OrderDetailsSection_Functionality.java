...
public class Hana_T_Orders_AllOrdersPage_ActionMenu_UpdateOrder_Update_OrderDetailsSection_Functionality extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T1048";
    ...
    public void Validate_Hana_T_Orders_AllOrdersPage_ActionMenu_UpdateOrder_Update_OrderDetailsSection_Functionality(
...
//========================= Above are pre - requisite steps for this test case =============================================
            ...
            String updaterecifname;
            String updaterecilname;
            String reci_phone_number1;


            updaterecifname = faker.name().firstName();
            updaterecilname = faker.name().lastName();
            reci_phone_number1 = faker.numerify("###-###-####");

            dashboardorder.update_Recipient_FirstName(updaterecifname);
            dashboardorder.update_Recipient_LastName(updaterecilname);
            dashboardorder.update_Recipient_PhoneNumber1(reci_phone_number1);
            dashboardorder.search_And_Select_Address1_On_UpdateOrder_Popup("615 Locust Street, Washington, MO 63090");
            dashboardorder.select_Updated_Country_On_UpdateOrder_Popup("United Kingdom");
            dashboardorder.select_Updated_Zone_On_UpdateOrder_Popup("Automation Zone");

            softassert.assertEquals(dashboardorder.get_Recipient_FirstName_On_UpdateOrder_Popup(), updaterecifname, "Test Step - 5 - Updated Recipient first name is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Recipient_LastName_On_UpdateOrder_Popup(), updaterecilname, "Test Step - 5 - Updated Recipient last name is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Recipient_PhoneNumber1_On_UpdateOrder_Popup(), reci_phone_number1, "Test Step - 5 - Updated Recipient phone number1 is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Recipient_Address1_On_UpdateOrder_Popup(), "615 Locust St", "Test Step - 5 - Updated Recipient address1 is not displayed");
            softassert.assertEquals(dashboardorder.get_Zipcode_On_UpdateOrder_Popup(), "63090", "Test Step - 5 - Updated Recipient zipcode is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_City_On_UpdateOrder_Popup(), "Washington", "Test Step - 5 - Updated Recipient city is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_State_On_UpdateOrder_Popup(), "MO", "Test Step - 5 - Updated Recipient state is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Country_On_UpdateOrder_Popup(), "United Kingdom", "Test Step - 5 - Updated Recipient country is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Zone_On_UpdateOrder_Popup(), "Automation Zone", "Test Step - 5 - Updated Recipient zone is not displayed on update order popup");

            dashboardorder.select_Updated_SalesRep_On_UpdateOrder_Popup("Abish David");
            dashboardorder.select_OrderType_On_UpdateOrder_Popup("Pick Up");
            dashboardorder.select_Occasion_Dropdown_On_UpdateOrder_Popup("Anniversary");
            dashboardorder.update_Email_On_UpdateOrder_Popup("balaji.nagamanickam@hanasoftware.com");

            softassert.assertEquals(dashboardorder.get_SalesRep_On_UpdateOrder_Popup(), "Abish David", "Test Step - 5 - Updated sales rep is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_OrderType_On_UpdateOrder_Popup(), "Pick Up", "Test Step - 5 - Updated order type is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Occasion_On_UpdateOrder_Popup(), "Anniversary", "Test Step - 5 - Updated occasion is not displayed on update order popup");
            softassert.assertEquals(dashboardorder.get_Email_On_UpdateOrder_Popup(), "balaji.nagamanickam@hanasoftware.com", "Test Step - 5 - Updated email is not displayed on update order popup");
            ...
            dashboardorder.hover_On_Toaster_Message();
            ...
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "Confirm Pickup\n" +
                    "\n" +
                    "Pending", "Test Step - 12 - order status is not displayed properly on all orders page after updating the order");
            ...
            softassert.assertEquals(dashboardorder.getRecipientName_OnDeliveryPopup(), updaterecifname + " " + updaterecilname, "Test Step - 12 - Updated recipient name is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.getRecipientAddress_OnDeliveryPopup(), "615 Locust St Washington MO 63090 GB", "Test Step - 12 - Updated recipient address is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.getRecipientPhoneNum_OnDeliveryPopup(), reci_phone_number1, "Test Step - 12 - Updated recipient phone number is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.get_Updated_ProductName(), "rrd - Red Rose Premium", "Test Step - 12 - Updated product name is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.get_Sold_By_On_Invoice_Order_Popup(), "Abish David", "Test Step - 12 - Updated sales rep is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.get_OrderType_On_Invoice_Order_Popup(), "Pick Up Phone Order", "Test Step - 12 - Updated order type is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.get_Occasion_On_Invoice_Order_Popup(), "Anniversary", "Test Step - 12 - Updated occasion is not properly displayed on order invoice details popup");
            softassert.assertEquals(dashboardorder.get_OrderStatus_DeliveryPopup(), "Pending", "Test Step - 12 - Order status is not properly displayed on order invoice details popup at center of the popup");
