...
public class Hana_Orders_09_HanaPOS_Orders_CancelOrder_Credit_For_Duplicate_Order_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_Orders_09_HanaPOS_Orders_CancelOrder_Credit_For_Duplicate_Order_Functionality_Test(
...
//========================= Above are pre - requisite steps for this test case =============================================
            ...
            delayWithGivenTime(1000);
            dashboardorder.Select_CancelOrder_Reason("Credit: Duplicate Order");
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.get_cancelOrder_Reason(), "Credit: Duplicate Order", "Test Step - 5 - Cancel order reason is not displayed on cancel order popup");
            ...
            softassert.assertTrue(
                    ...
                    "Refund message content mismatch for the Reason: Duplicate Order"
            );
