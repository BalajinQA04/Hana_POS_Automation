...
public class Hana_T835_Advance_Dispatch_Footer_Icon_Section_Timed_Order_Functionality extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T835";
    String recipient_fulladdress;
    ...
    public void Validate_Hana_T835_Advance_Dispatch_Footer_Icon_Section_Timed_Order_Functionality(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            recipient_fulladdress = "16415 Village Plaza View Dr, Wildwood, MO";
            delayWithGivenTime(1000);
            phoneorder.SearchAndSelectReciAddress1(recipient_fulladdress);
            delayWithGivenTime(2000);
            ...
            // Test Step - 14
            softassert.assertTrue(advanceDispatch.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoiceNumber), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");
            ...
            softassert.assertTrue(advanceDispatch.verify_Timed_Delivery_Icon_Is_Displayed(invoiceNumber), "Test Step - 15 - Timed Delivery icon is not displayed for invoice number: " + invoiceNumber);
            ...
            softassert.assertTrue(advanceDispatch.verify_Timed_Delivery_Icon_Is_Not_Displayed(second_invoiceNumber), "Test Step - 16 - Timed Delivery icon is displayed for invoice number: " + second_invoiceNumber + " which is not configured the timed delivery feature");
