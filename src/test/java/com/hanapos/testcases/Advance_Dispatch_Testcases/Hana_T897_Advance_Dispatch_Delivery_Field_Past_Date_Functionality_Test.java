...
public class Hana_T897_Advance_Dispatch_Delivery_Field_Past_Date_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T897_Advance_Dispatch_Delivery_Field_Past_Date_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(1000);
            phoneorder.EnterDeliveryDateOnReciSection(PreviousDate_AST());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(18, 30);
            phoneorder.Select_DeliveryOnTime_Dropdown(deliveryontime);
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.getDeliveryDateOnReciSection(), PreviousDate_AST(), "Test Step - 3: Selected delivery date as " + CurrentDate() + " is not displayed");
            ...
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Delivery_Date_On_Advance_Dispatch(), automationshop_deliverydate, "Test Step - 7: By default delivery date is not displayed as current date on advance dispatch page");
            ...
            delayWithGivenTime(2000);
            advanceDispatchPage.Set_Delivery_Date_on_Advance_Dispatch(PreviousDate_AST());
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoice_number), "Test Step - 8 - Past date Invoice " + invoice_number + " is not displaying in the pending Deliveries section");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Delivery Date should be greater than today", "Test Step - 10 - Delivery Date should be greater than today - Toaster Message is not displayed for past date invoice");
