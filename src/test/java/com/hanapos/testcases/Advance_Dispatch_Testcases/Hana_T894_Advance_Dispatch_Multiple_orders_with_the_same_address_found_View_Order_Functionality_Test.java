...
public class Hana_T894_Advance_Dispatch_Multiple_orders_with_the_same_address_found_View_Order_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T894_Advance_Dispatch_Multiple_orders_with_the_same_address_found_View_Order_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            if (advanceDispatchPage.multiple_order_with_same_address_popup_is_displayed()) {
                ...
                advanceDispatchPage.click_Invoice_Number_HyperLink_On_MultipleOrder_WithSame_Address(invoice_number);
            }

            delayWithGivenTime(1000);
            dashboardorder = new DashboardOrderPage();

            softassert.assertEquals(dashboardorder.validate_All_Orders_Page_Title(), "Hana | Orders", "Test Step - 8: All orders page is not displayed");
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoice_number), "Test Step - 8 - Respective Invoice number is not displayed on all orders page");
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoice_number), "New", "Test Step - 8 - Respective Invoice status is not displayed on all orders page");
