...
public class Hana_T966_Advance_Dispatch_Trip_Section_New_Trip_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T966_Advance_Dispatch_Trip_Section_New_Trip_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//======================================= Second Invoice Number =====================
            ...
            advanceDispatchPage.click_New_Trip_Button_Tripsection();
            delayWithGivenTime(2000);
            if (advanceDispatchPage.verifying_invalid_address_pop_up_is_displaying_or_not()) {
                advanceDispatchPage.click_proceed_without_address_button();
            }
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isNotDisplayed(invoice_number), "Test Step - 18 - Invoice is not displaying in the pending Deliveries section");
            ...
            //Test Step - 19
            advanceDispatchPage.Click_DispatchSave_Button();
            String time = Atlantic_TimeZone_In_MM_dd_yyyy_hhmm();
            phoneorder = new OrderEntry_Alais_PhoneOrderPage();
            delayWithGivenTime(1500);
            ...
            softassert.assertEquals(advanceDispatchPage.get_Actual_TimeStamp_Displayed_On_Trip_Section(), time, "Test Step - 19: Time Stamp on trip section - Advance dispatch page");
            softassert.assertTrue(advanceDispatchPage.is_TripNumber_Displayed_On_Trip_Section(), "Test Step - 16: Trip number is not displayed on trip section");

            advanceDispatchPage.click_Route_Dropdown_In_Trip_Section();
            softassert.assertTrue(advanceDispatchPage.is_Existing_Trip_Displayed(second_routenumber), "Test Step - 19: Saved trip invoice number : " + invoice_number + " is not displayed in saved trip section");
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isNotDisplayed(second_invoice_number), "Test Step - 18 - Invoice is not displaying in the pending Deliveries section");
