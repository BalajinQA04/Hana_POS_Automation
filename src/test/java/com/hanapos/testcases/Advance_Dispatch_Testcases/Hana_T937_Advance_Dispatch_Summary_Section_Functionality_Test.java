...
public class Hana_T937_Advance_Dispatch_Summary_Section_Functionality_Test extends TestBaseClass {
    ...
    String firstinvoiceNumber, secondinvoiceNumber, thirdinvoiceNumber;
    public static final String dataSheetName = "Hana_T937";
    ...
    public void Validate_Hana_T937_Advance_Dispatch_Summary_Section_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            firstinvoiceNumber = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            softassert.assertTrue(orderconfirmationpage.VerifyOrderConfirmationPage(), "Test Step - 5 - Order confirmation page is not displayed");
            delayWithGivenTime(500);
            secondinvoiceNumber = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            softassert.assertTrue(orderconfirmationpage.VerifyOrderConfirmationPage(), "Test Step - 5 - Order confirmation page is not displayed");
            delayWithGivenTime(500);
            thirdinvoiceNumber = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(firstinvoiceNumber), "Test Step - 6 - Respective Invoice number is not displayed on all orders page");
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(firstinvoiceNumber), "New", "Test Step - 6 - Respective Invoice status is not displayed on all orders page");
            delayWithGivenTime(1000);

            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(secondinvoiceNumber), "Test Step - 6 - Respective Invoice number is not displayed on all orders page");
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(secondinvoiceNumber), "New", "Test Step - 6 - Respective Invoice status is not displayed on all orders page");
            delayWithGivenTime(1000);

            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(thirdinvoiceNumber), "Test Step - 6 - Respective Invoice number is not displayed on all orders page");
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(thirdinvoiceNumber), "New", "Test Step - 6 - Respective Invoice status is not displayed on all orders page");
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(firstinvoiceNumber), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(secondinvoiceNumber), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(thirdinvoiceNumber), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");

            // Test Step - 15
            softassert.assertTrue(advanceDispatchPage.is_summary_section_advance_dispatch_page_Displayed(), "Test Step - 15 - Summary section is not displayed for advance dispatched page");
            advanceDispatchPage.click_Summarized_Recipient_City_Advance_Dispatch(recipientcity);

            // Confirm the multiple order with same address pop-up
            ...
            // Test Step - 16
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(firstinvoiceNumber), "Test Step: 16 - Invoice Order : " + firstinvoiceNumber + " in trip section");
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(secondinvoiceNumber), "Test Step: 16 - Invoice Order : " + secondinvoiceNumber + " in trip section");
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(thirdinvoiceNumber), "Test Step: 16 - Invoice Order : " + thirdinvoiceNumber + " in trip section");
