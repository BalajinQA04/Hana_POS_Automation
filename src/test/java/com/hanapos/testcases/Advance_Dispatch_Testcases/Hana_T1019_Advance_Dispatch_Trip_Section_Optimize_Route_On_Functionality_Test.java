...
public class Hana_T1019_Advance_Dispatch_Trip_Section_Optimize_Route_On_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1019_Advance_Dispatch_Trip_Section_Optimize_Route_On_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(advanceDispatchPage.is_Optimize_Route_Toogle_Button_Displayed(), "Test Step - 18: Optimize route toogle button is not displayed on trip section");

            // Test Step - 19
            softassert.assertTrue(advanceDispatchPage.is_Optimize_Route_Toogle_Button_In_Off_State(), "Test Step - 19: Optimize route toogle button is not displayed as off state on trip section");

            // Test Step - 20
            delayWithGivenTime(2000);
            advanceDispatchPage.click_Optimize_Route_Toogle_On_TripSection();
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Optimize_Route_Toogle_Button_In_On_State(), "Test Step - 19: Optimize route toogle button is not displayed as on state on trip section");
