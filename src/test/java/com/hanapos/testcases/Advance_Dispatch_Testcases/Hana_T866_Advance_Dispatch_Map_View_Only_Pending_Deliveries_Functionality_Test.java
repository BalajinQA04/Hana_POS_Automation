...
public class Hana_T866_Advance_Dispatch_Map_View_Only_Pending_Deliveries_Functionality_Test extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T866";
    ...
    public void Validate_Hana_T866_Advance_Dispatch_Map_View_Only_Pending_Deliveries_Functionality_Test(
            String username,
            String password,
            String shopname,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatchPage.get_Selected_Map_View_on_Advance_Dispatch_Page(), mapview, "Test Step - 15: Selected map view is not displayed on advance dispatch page");
