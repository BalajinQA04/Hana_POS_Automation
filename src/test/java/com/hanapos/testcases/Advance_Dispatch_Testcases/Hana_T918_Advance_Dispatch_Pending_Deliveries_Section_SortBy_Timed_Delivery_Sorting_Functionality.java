...
public class Hana_T918_Advance_Dispatch_Pending_Deliveries_Section_SortBy_Timed_Delivery_Sorting_Functionality extends TestBaseClass {
    ...
    String invoiceNumber2, invoiceNumber3;
    ...
    public void Validate_Hana_T918_Advance_Dispatch_Pending_Deliveries_Section_SortBy_Timed_Delivery_Sorting_Functionality(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(orderconfirmationpage.VerifyOrderConfirmationPage(), "Test Step - 8 - Order confirmation page is not displayed");
            delayWithGivenTime(500);
            invoiceNumber2 = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            softassert.assertTrue(orderconfirmationpage.VerifyOrderConfirmationPage(), "Test Step - 8 - Order confirmation page is not displayed");
            delayWithGivenTime(500);
            invoiceNumber3 = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(advanceDispatch.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoiceNumber2), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");
            delayWithGivenTime(1000);
            softassert.assertTrue(advanceDispatch.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoiceNumber3), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");

            // Test Step - 15
            advanceDispatch.select_SortBy_Option_On_Pending_Deliveries_Section("Timed deliveries");
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatch.get_Selected_SortBy_Option_On_Pending_Deliveries_Section(), "Timed deliveries", "Test Step - 15: Sort By Selected Option on pending deliveries section is not displayed");

            // Test Step - 16
            advanceDispatch.click_Sort_Icon_On_Pending_Deliveries_Section();
