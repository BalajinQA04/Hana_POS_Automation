...
public class Hana_T973_Advance_Dispatch_Trip_Section_Manual_Print_Download_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T973_Advance_Dispatch_Trip_Section_Manual_Print_Download_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//======================================= Second Invoice Number =====================
            ...
            // Test Step - 19
            softassert.assertTrue(advanceDispatchPage.is_Manual_Print_Button_Displayed(), "Test Step - 19: Remote Print button is not displayed on trip section");

            // Test Step - 20
            advanceDispatchPage.click_Manual_Print_Button_Tripsection();
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.is_Manual_Print_Popup_Header_Displayed(), "Test Step - 20 - Manual Print popup header is not displayed");
