...
public class Hana_T1021_Advance_Dispatch_Trip_Section_Round_Trip_On_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1021_Advance_Dispatch_Trip_Section_Round_Trip_On_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(advanceDispatchPage.is_Round_Trip_Toogle_Button_Displayed(), "Test Step - 18: Round Trip toogle button is not displayed on trip section");

            // Test Step - 19
            softassert.assertTrue(advanceDispatchPage.is_Round_Trip_Toogle_Button_In_On_State(), "Test Step - 19: Round Trip toogle button is not displayed as 'on' state on trip section");

            // Test Step - 20
            delayWithGivenTime(2000);
            advanceDispatchPage.click_Round_Trip_Toogle_Off_TripSection();
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Round_Trip_Toogle_Button_In_Off_State(), "Test Step - 20: Round Trip toogle button is not displayed as 'off' state on trip section");
