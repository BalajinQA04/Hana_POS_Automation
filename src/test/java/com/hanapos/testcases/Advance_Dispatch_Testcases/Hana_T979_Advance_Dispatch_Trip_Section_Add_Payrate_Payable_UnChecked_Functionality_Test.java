...
public class Hana_T979_Advance_Dispatch_Trip_Section_Add_Payrate_Payable_UnChecked_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T979_Advance_Dispatch_Trip_Section_Add_Payrate_Payable_UnChecked_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            // Test Step - 22
            advanceDispatchPage.unchecked_The_Payable_Checkbox_Add_Payrate_Popup();
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Driver_Payrate_On_Add_Payrate_TableGrid(), "0.00", "Test Step - 22 - Driver payrate is not matched on add payrate table grid");
            defaultContent();
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Driver_Payrate_On_Add_Payrate_TableGrid(), "0.00", "Test Step - 23 - Driver payrate is not matched on add payrate table grid");
            ...
            //Test Step 30
            delayWithGivenTime(2000);
            softassert.assertFalse(payrollreportpage.is_Payable_Checkbox_Checked_On_Payroll_Report_Table_Grid(invoice_number), "Test Step 30 - Payable checkbox is not displayed for invoice number: " + invoice_number + " on Payroll Report Table Grid");
