...
public class Hana_T1016_Advance_Dispatch_Trip_Section_Optimize_Configuration_Unit_Miles_Off_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1016_Advance_Dispatch_Trip_Section_Optimize_Configuration_Unit_Miles_Off_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            // Test Step - 21
            advanceDispatchPage.turn_ON_Unit_Miles_Toogle_On_Optimize_Configuration_Popup();
            ...
            // Test Step - 24
            // values are dynamically changing
          //  softassert.assertEquals(advanceDispatchPage.get_Total_Distance_Displayed_On_Print_Map_Page(), "1995.7 miles", "Test Step - 24: Total distance is not displayed on print map page");
