...
public class Hana_T955_Advance_Dispatch_Trip_Section_Delete_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T955_Advance_Dispatch_Trip_Section_Delete_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.verify_Invoice_Is_Not_Displayed_On_Trip_Section(invoice_number), "Test Step - 17: After delete the invoice number : " + invoice_number + " from trip section it is displayed");
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(invoice_number), "Test Step - 17: After delete the invoice number : " + invoice_number + " from trip section it is not displayed in pending deliveries section");
