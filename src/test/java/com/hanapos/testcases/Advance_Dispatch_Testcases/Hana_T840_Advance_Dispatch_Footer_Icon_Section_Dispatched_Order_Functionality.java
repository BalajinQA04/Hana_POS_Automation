...
public class Hana_T840_Advance_Dispatch_Footer_Icon_Section_Dispatched_Order_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T840_Advance_Dispatch_Footer_Icon_Section_Dispatched_Order_Functionality(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "Dispatched", "Test Step - 19 - Order status is not displayed as Dispacted for order");
            ...
            // Test Step - 14
            softassert.assertTrue(advanceDispatch.verify_pending_deliveries_invoice_isDisplayed(second_invoiceNumber), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");
