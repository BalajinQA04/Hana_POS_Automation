...
public class Hana_T1001_Advance_Dispatch_Trip_Section_Print_Map_Download_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1001_Advance_Dispatch_Trip_Section_Print_Map_Download_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Print_Button_Displayed_On_Print_Map_Page(), "Print button is not displayed on print map page");

            // We are not able to print the map in automation
            // delayWithGivenTime(2000);
//            pressEnterRobot();
//            delayWithGivenTime(2000);
//            pressEscapeRobot();
//            delayWithGivenTime(2000);
           ...
           /* advanceDispatchPage.click_Print_Button_On_Print_Map_Page();
            delayWithGivenTime(2000);
            pressEnterRobot();*/
