...
public class Hana_T944_Advance_Dispatch_Trip_Section_Scan_Invoice_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T944_Advance_Dispatch_Trip_Section_Scan_Invoice_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoice_number), "Test Step - 14 - Invoice " + invoice_number + " is not displaying in the pending Deliveries section");


            // Test Step - 7
            advanceDispatchPage.enter_InvoiceNumber_On_ScanOrder_Trip_Section(invoice_number);
            ...
            // Test Step - 8
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(invoice_number), "Test Step - 8 - Scanned Invoice " + invoice_number + " is not displaying in the trip section");
