...
public class Hana_T957_Advance_Dispatch_Trip_Section_Saved_Trip_Delete_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T957_Advance_Dispatch_Trip_Section_Saved_Trip_Delete_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoice_number), "Test Step - 14 - Invoice is not displaying in the pending Deliveries section");
            ...
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(invoice_number), "Test Step - 18 - Invoice is not displaying in the Trip Section");
            softassert.assertTrue(advanceDispatchPage.verify_Dispatch_Icon_On_Trip_Section(), "Test Step - 18: Dispatch yellow icon is not displayed on trip section");

            // Test Step - 19
            delayWithGivenTime(2000);
            advanceDispatchPage.click_Delete_Icon_for_Respective_Invoice_In_Trip_Section(invoice_number);
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.verify_Invoice_Is_Not_Displayed_On_Trip_Section(invoice_number), "Test Step - 19: After delete the invoice number : " + invoice_number + " from trip section it is displayed");
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(invoice_number), "Test Step - 19: After delete the invoice number : " + invoice_number + " from trip section it is not displayed in pending deliveries section");
            ...
            advanceDispatchPage.click_Route_Dropdown_In_Trip_Section();
            delayWithGivenTime(1000);
            softassert.assertTrue(advanceDispatchPage.is_Deleted_Trip_Displayed(routenumber), "Test Step - 20: After delete the invoice number : " + invoice_number + " from trip section it is  displayed in saved trip section");
