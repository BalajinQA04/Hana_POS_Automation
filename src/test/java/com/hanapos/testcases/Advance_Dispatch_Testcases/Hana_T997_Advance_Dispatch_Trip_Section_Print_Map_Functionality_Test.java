...
public class Hana_T997_Advance_Dispatch_Trip_Section_Print_Map_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T997_Advance_Dispatch_Trip_Section_Print_Map_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(advanceDispatchPage.is_TripNumber_Displayed_On_Trip_Section(), "Test Step - 16: Trip number is not displayed on trip section");
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Print_Map_Button_Displayed(), "Print Map Button is not displayed on trip section");

            advanceDispatchPage.click_Print_Map_Button();
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Print_Map_Window_Displayed(), "Print Map Window is not displayed on new window");

            advanceDispatchPage.click_Satellite_Button_On_Print_Map_Popup();

            delayWithGivenTime(1000);
            advanceDispatchPage.uncheck_Label_On_Satellite_View_Print_Map_Section();

            delayWithGivenTime(1000);
            advanceDispatchPage.click_Map_View_Button_On_Print_Map_Popup();
            delayWithGivenTime(1000);
            advanceDispatchPage.check_Terrain_On_Map_View_Print_Map_Section();

            delayWithGivenTime(2000);
            advanceDispatchPage.verify_Zoom_In_Functionality_On_Map_View_Print_Map_Section();
            delayWithGivenTime(2000);
            advanceDispatchPage.verify_Zoom_Out_Functionality_On_Map_View_Print_Map_Section();
            delayWithGivenTime(2000);
            advanceDispatchPage.dragAndDrop_Pegman_Icon_On_Map_View_Print_Map_Section();
            delayWithGivenTime(2000);
            advanceDispatchPage.click_fullscreen_icon_on_print_mapsection();
            delayWithGivenTime(2000);
            PressEscapeKey();
