...
public class Hana_T916_Advance_Dispatch_Pending_Deliveries_Section_Pending_Deliveries_Table_Sorting_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T916_Advance_Dispatch_Pending_Deliveries_Section_Pending_Deliveries_Table_Sorting_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//------------------------------------------------------------------------------------
            ...
            delayWithGivenTime(2000);
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(invoice_number), "Test Step - 7 - Invoice is not displaying in the pending Deliveries section");
            softassert.assertTrue(advanceDispatchPage.verify_pending_deliveries_invoice_isDisplayed(invoice_number2), "Test Step - 7 - Invoice is not displaying in the pending Deliveries section");

            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Invoices_Sorted_As_AscendingOrder_In_Pending_Deliveries_Section(), "Test Step - 8: Ascending order is not present");
            softassert.assertTrue(advanceDispatchPage.verify_ascending_order_icon_on_invoice_label_pending_deliveries_section(), "Test Step - 8: Ascending Order - Upward icon on Invoice label - pending deliveries section ");

            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_DescendingOrder_Invoices_In_Pending_Deliveries_Section(), "Test Step - 8: Descending order is not present");
            softassert.assertTrue(advanceDispatchPage.verify_descending_order_icon_on_invoice_label_pending_deliveries_section(), "Test Step - 8: Descending Order - downward icon on Invoice label - pending deliveries section ");

            delayWithGivenTime(2000);
            advanceDispatchPage.click_Invoice_Label_Header_On_Pending_Deliveries_Section();
            softassert.assertTrue(advanceDispatchPage.verify_ascending_order_icon_on_invoice_label_pending_deliveries_section_is_NotDisplayed(), "Test Step 8: ascending or descending icon is displayed on invoice label - pending deliveries section");
