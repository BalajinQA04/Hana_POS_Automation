...
public class Hana_T1002_Advance_Dispatch_Trip_Section_Optimize_Functionality_Test extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T1002";
    ...
    public void Validate_Hana_T1002_Advance_Dispatch_Trip_Section_Optimize_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(advanceDispatchPage.is_TripNumber_Displayed_On_Trip_Section(), "Test Step - 16: Trip number is not displayed on trip section");
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Optimize_Button_Displayed_On_TripSection(), "Test Step - 18: Optimize button is not displayed on trip section");
            delayWithGivenTime(2000);
            advanceDispatchPage.click_Optimize_Button_On_TripSection();
            delayWithGivenTime(1000);
            softassert.assertTrue(advanceDispatchPage.is_Confirmation_Popup_Displayed_After_Clicking_Optimize_Button(), "Test Step - 19: Confirmation popup is not displayed for optimize button");
            advanceDispatchPage.click_Yes_Button_In_Confirmation_Popup();
            delayWithGivenTime(1000);
            softassert.assertEquals(advanceDispatchPage.Validate_Success_Toaster_message_Appears(), "Dispatch Saved Successfully", "Test Step - 20: Optimize success toaster message is not displayed");
