...
public class Hana_T905_Advance_Dispatch_Pending_Deliveries_Section_View_Order_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T905_Advance_Dispatch_Pending_Deliveries_Section_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            advanceDispatchPage.click_Invoice_Number_Hyperlink_On_Pending_Deliveries_Section(invoice_number);
            delayWithGivenTime(2000);
