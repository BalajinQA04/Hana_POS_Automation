...
public class Hana_T838_Advance_Dispatch_Footer_Icon_Section_Priority_Order_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T838_Advance_Dispatch_Footer_Icon_Section_Priority_Order_Functionality(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            softassert.assertTrue(dashboardorder.verify_Priority_Order_Flag_Icon_On_All_Orders_Page(invoiceNumber), "Test Step - 10 - Priority order flag icon is not displayed on all orders page");

            //=========== Non - Priority Delivered Order ===========//
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboard.VerifyOrderEntryOptionIsDisplayed(), "Test Step - 2: Order entry option is not displayed");
            softassert.assertTrue(dashboard.Verify_Cashandcarry_OptionIsDisplayed(), "Test Step - 2: Cash and carry option is not displayed");
            ...
            // Test Step - 14
            softassert.assertTrue(advanceDispatch.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoiceNumber), "Test Step - 14 - Invoice number: " + invoiceNumber + " is not displaying in the pending Deliveries section");
            ...
            softassert.assertTrue(advanceDispatch.verify_Priority_Order_RedFlag_IsDisplayed(invoiceNumber), "Test Step - 15 - Priority Flag icon is not displayed for invoice number: " + invoiceNumber);
            ...
            softassert.assertTrue(advanceDispatch.verify_Priority_Order_RedFlag_Is_NotDisplayed(second_invoiceNumber), "Test Step - 16 - Non - Priority Flag icon is displayed for invoice number: " + second_invoiceNumber + " which is not configured the timed delivery feature");
