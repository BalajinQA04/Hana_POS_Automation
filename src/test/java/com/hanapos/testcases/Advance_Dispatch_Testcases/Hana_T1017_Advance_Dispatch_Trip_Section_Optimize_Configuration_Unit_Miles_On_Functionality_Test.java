...
public class Hana_T1017_Advance_Dispatch_Trip_Section_Optimize_Configuration_Unit_Miles_On_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1017_Advance_Dispatch_Trip_Section_Optimize_Configuration_Unit_Miles_On_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            // Test Step - 24
           // softassert.assertEquals(advanceDispatchPage.get_Total_Distance_Displayed_On_Print_Map_Page(), "3211.7 Kms", "Test Step - 24: Total distance is not displayed on print map page");
