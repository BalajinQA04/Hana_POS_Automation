...
public class Hana_T906_Advance_Dispatch_Pending_Deliveries_Section_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T906_Advance_Dispatch_Pending_Deliveries_Section_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            advanceDispatchPage.Verify_The_Address_In_Pending_Deliveries_Section(invoice_number);
