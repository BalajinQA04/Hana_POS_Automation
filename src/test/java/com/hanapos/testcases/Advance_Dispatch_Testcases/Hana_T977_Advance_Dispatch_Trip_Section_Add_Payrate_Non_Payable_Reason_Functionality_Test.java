...
public class Hana_T977_Advance_Dispatch_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T977_Advance_Dispatch_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            //Test Step 30
            delayWithGivenTime(2000);
            softassert.assertEquals(payrollreportpage.is_NonPayable_Reason_Displayed_On_Payroll_Report_Table_Grid(invoice_number), nonpayable_reason, "Test Step 30 - Non Payable Reason is not displaying as expected");
