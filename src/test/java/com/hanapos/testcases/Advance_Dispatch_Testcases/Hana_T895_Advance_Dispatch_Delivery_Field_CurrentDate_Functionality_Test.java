...
public class Hana_T895_Advance_Dispatch_Delivery_Field_CurrentDate_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T895_Advance_Dispatch_Delivery_Field_CurrentDate_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Delivery_Date_On_Advance_Dispatch(), automationshop_deliverydate, "Test Step - 7: Selected delivery date is not displayed on advance dispatch page");

            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Invoice_Number_Displayed_In_Pending_Deliveries_Section(invoice_number), "Test Step - 7 - Invoice is not displaying in the pending Deliveries section");
