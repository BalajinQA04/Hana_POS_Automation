...
public class Hana_T941_Advance_Dispatch_Summary_Section_Sorting_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T941_Advance_Dispatch_Summary_Section_Sorting_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//------------------------------------------------------------------------------------
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Summarized_By_Rows_Are_In_AlphabeticOrder(), "Test Step - 8: Ascending order is not present");
            softassert.assertTrue(advanceDispatchPage.is_Ascending_Upward_Arrow_Displayed(), "Test Step - 8: Ascending Order - Upward icon on Invoice label - pending deliveries section ");

            delayWithGivenTime(2000);
            softassert.assertTrue(advanceDispatchPage.is_Summarized_By_Rows_In_Alphabetic_Reverse_Order(), "Test Step - 8: Descending order is not present");
            softassert.assertTrue(advanceDispatchPage.is_Descending_downward_Arrow_Displayed(), "Test Step - 8: Descending Order - downward icon on Invoice label - pending deliveries section ");
