...
public class Hana_T962_Advance_Dispatch_Trip_Section_Edit_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T962_Advance_Dispatch_Trip_Section_Edit_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//======================================= Second Invoice Number =====================
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatchPage.get_selected_drivername(), "--Select Driver--", "Test Step - 18: Known Issue: --Select Driver-- Option is not displaying as default option in select driver dropdown - Trip section");
            delayWithGivenTime(2000);
