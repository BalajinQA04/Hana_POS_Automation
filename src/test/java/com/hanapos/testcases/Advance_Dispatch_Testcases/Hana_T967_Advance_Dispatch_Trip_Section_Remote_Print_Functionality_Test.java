...
public class Hana_T967_Advance_Dispatch_Trip_Section_Remote_Print_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T967_Advance_Dispatch_Trip_Section_Remote_Print_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
...
//======================================= Second Invoice Number =====================
            ...
            // Test Step - 19
            softassert.assertTrue(advanceDispatchPage.is_Remote_Print_Button_Displayed(), "Test Step - 19: Remote Print button is not displayed on trip section");

            // Test Step - 20
            advanceDispatchPage.click_Remote_Print_Button_Tripsection();
            softassert.assertTrue(phoneorder.verifySuccessToastMessageAppears(), "Test Step - 20 - Remote Print Completed Successfully - Success Toaster Message is not displayed");
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Remote Print Completed Successfully", "Test Step - 20 - Remote Print Completed Successfully - Success Toaster Message is not displayed");
        } catch (Exception e) {
