...
public class Hana_T865_Advance_Dispatch_Map_View_Current_Trip_Functionality_Test extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T865";
    ...
    public void Validate_Hana_T865_Advance_Dispatch_Map_View_Current_Trip_Functionality_Test(
            String username,
            String password,
            String shopname,
        ...
        try {
            ...
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(invoiceNumber), "Invoice Order in trip section");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(advanceDispatchPage.get_Selected_Map_View_on_Advance_Dispatch_Page(), mapview, "Test Step - 18: Selected map view is not displayed on advance dispatch page");
