...
public class Hana_T976_Advance_Dispatch_Trip_Section_Add_Pay_Rate_Functionality_Test extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T976";
    ...
    public void Validate_Hana_T976_Advance_Dispatch_Trip_Section_Add_Pay_Rate_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            // Test Step - 22
            advanceDispatchPage.enter_Driver_Payrate_On_Add_Payrate_Popup_TableGrid("20");
            delayWithGivenTime(1000);
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Driver_Payrate_On_Add_Payrate_TableGrid(), "20", "Test Step - 22 - Driver payrate is not matched on add payrate table grid");
            defaultContent();
            ...
            advanceDispatchPage.enter_Non_Payable_Reason_On_Add_Payrate_Popup_TableGrid("Make product damaged");
            delayWithGivenTime(1000);
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Driver_Payrate_On_Add_Payrate_TableGrid(), "20.00", "Test Step - 23 - Driver payrate is not matched on add payrate table grid");
            softassert.assertEquals(advanceDispatchPage.get_Displayed_Non_Payable_Reason_On_Add_Payrate_TableGrid(), "Make product damaged", "Test Step - 23 - Non Payable Reason is not matched on add payrate table grid");
            defaultContent();
