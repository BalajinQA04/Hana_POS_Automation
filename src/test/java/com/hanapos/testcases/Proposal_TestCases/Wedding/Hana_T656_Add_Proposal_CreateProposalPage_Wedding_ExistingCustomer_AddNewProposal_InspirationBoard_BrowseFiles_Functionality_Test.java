...
public class Hana_T656_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_InspirationBoard_BrowseFiles_Functionality_Test extends TestBaseClass {
    ...
    public void Hana_T656_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_InspirationBoard_BrowseFiles_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_T656_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_InspirationBoard_BrowseFiles_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertTrue(manageproposal.verify_inspirationTab_uploaded_seconddocument_displayed_on_grid(), "Test Step - 10: Uploaded first document is not displayed on documents and images tab");
