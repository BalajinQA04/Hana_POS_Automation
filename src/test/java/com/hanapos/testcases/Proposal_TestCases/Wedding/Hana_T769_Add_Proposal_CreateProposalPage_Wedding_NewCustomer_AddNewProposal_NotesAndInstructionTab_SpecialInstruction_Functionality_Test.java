...
public class Hana_T769_Add_Proposal_CreateProposalPage_Wedding_NewCustomer_AddNewProposal_NotesAndInstructionTab_SpecialInstruction_Functionality_Test extends TestBaseClass {
    ...
    public void Hana_T769_Add_Proposal_CreateProposalPage_Wedding_NewCustomer_AddNewProposal_NotesandInstruction_PossibilitiesofUpgrade_SpecialInstruction_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_T769_Add_Proposal_CreateProposalPage_Wedding_NewCustomer_AddNewProposal_NotesandInstruction_PossibilitiesofUpgrade_SpecialInstruction_Functionality_Test ****");
        ...
        try {
            ...
            // Test Step - 11
            softassert.assertTrue(manageproposal.is_SpecialInstructions_Header_Displayed(), "Test Step - 11 - Special Instructions header label is not displayed");

            // Test Step - 12
            softassert.assertTrue(manageproposal.is_eyeIcon_displayed(), "Test Step - 12 - Special Instructions Eye Icon is not displayed");
            softassert.assertEquals(manageproposal.ToolTip_SpecialInstructions_Header(),"Change special instruction visibility for the client","Test Step - 12 - Special Instructions eye icon tooltip is not displayed");
