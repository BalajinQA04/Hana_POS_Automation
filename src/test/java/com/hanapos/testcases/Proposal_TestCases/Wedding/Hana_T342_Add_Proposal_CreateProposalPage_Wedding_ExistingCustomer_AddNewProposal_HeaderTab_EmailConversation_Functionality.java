...
public class Hana_T342_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_EmailConversation_Functionality extends TestBaseClass {
    ...
    public void Hana_Hana_T342_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_EmailConversation_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_Hana_T342_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_EmailConversation_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertTrue(manageproposal.verify_email_conversation_link_on_headerTab_isDisplayed(), "Test Step - 9: Email Conversation link on header tab is not displayed");
            manageproposal.Click_email_conversation_link_on_headerTab();

            softassert.assertTrue(manageproposal.verify_compose_mail_button_on_emailconversation_popup_IsDisplayed(), "Test Step - 9: Email Conversation popup is not displayed");
            manageproposal.Click_compose_mail_button_on_emailconversation_popup();

            softassert.assertTrue(manageproposal.verify_compose_mail_box_isAppears(), "Test Step - 10: compose mail body section is not displayed");
            manageproposal.Click_on_Send_button_on_emailbox();

           // softassert.assertEquals(proposal.verifySuccessToastMessageText(), "Message send successfully.", "Test Step - 11: Email sent successfully success toaster message is not displayed");
