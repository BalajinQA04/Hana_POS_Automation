...
public class Hana_T579_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_MoreActions_CustomerView_Functionality_Test extends TestBaseClass {
    ...
    public void Hana_T579_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_MoreActions_CustomerView_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_Hana_T579_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_MoreActions_CustomerView_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertTrue(manageproposal.Validate_WeddingInfo_Header_on_floristView(), "Test Step - 13 - Florist View - Wedding Info Header is not displayed");
