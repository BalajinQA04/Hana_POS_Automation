...
public class Hana_T1649_HanaPOS_Proposal_Proposal_settings_Wedding_Verify_the_Dynamic_Label_ForDelivery_Fee_Include_Delivery_Fee_in_Tax_Calculation_Functionality extends TestBaseClass {
    ...
    public void validate_Hana_T1649_Proposal_settings_Wedding_Verify_the_delivery_fee_tax_calculation_for_label_Include_Delivery_Fee_in_Tax_Calculation_Functionality_Test() {
        ...
        try {
            ...
            settingsPage.click_Taxes_Submenu();

            softassert.assertTrue(settingsPage.is_Taxes_Section_Displayed(), "Taxes submenu is not displayed");
            settingsPage.click_Tax_Settings_Menu_On_Taxes_Section();

            delayWithGivenTime(1000);
            taxsettings_settingsPage = new TaxSettings_Configuration_Setting_Page();
            softassert.assertTrue(taxsettings_settingsPage.is_Tax_Settings_Configuration_Setting_Page_Displayed(), "Tax Settings page is not displayed");

            delayWithGivenTime(1000);
            taxsettings_settingsPage.click_On_Include_Delivery_Fee_In_Tax_Calculation_Toogle_Button();
            delayWithGivenTime(1000);
            taxsettings_settingsPage.click_On_Save_Settings_Button();
...
//            manageproposal.enter_Delivery_Fee_On_ItemsAndProducts("12.76");
//            delayWithGivenTime(1000);
//            softassert.assertEquals(manageproposal.get_Delivery_Fee_Displayed(), "12.76", "Test Step - 16 - Delivery fee is not displayed on product table grid");

            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Tax_Amount_Displayed(), "$" + manageproposal.get_Expected_TaxAmount(), "Test Step - 16 - Tax amount is not displayed properly on product table grid");
            softassert.assertEquals(manageproposal.get_Actual_GrandTotal(), manageproposal.get_Dollar_Based_Calculated_Expected_GrandTotal(), "Test Step - 16 - Grand total is not displayed properly on product table grid");
    ...
    public void validate_Hana_T1651_Proposal_settings_Wedding_Verify_the_delivery_fee_tax_calculation_for_label_Exclude_Delivery_Fee_in_Tax_Calculation_Functionality_Test() {
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        ...
        try {
            ...
            delayWithGivenTime(1000);
            taxsettings_settingsPage.click_OFF_Include_Delivery_Fee_In_Tax_Calculation_Toogle_Button();
            delayWithGivenTime(1000);
            taxsettings_settingsPage.click_On_Save_Settings_Button();
...
//            softassert.assertEquals(manageproposal.get_Delivery_Fee_Displayed(), "12.76", "Test Step - 16 - Delivery fee is not displayed on product table grid");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Tax_Amount_Displayed(), "$" + manageproposal.get_Expected_TaxAmount_Without_Delivery_Fee(), "Test Step - 16 - Tax amount without delivery fee is not displayed properly for wedding proposal on items and products tab");
            softassert.assertEquals(manageproposal.get_Actual_GrandTotal(), manageproposal.get_Dollar_Based_Calculated_Expected_GrandTotal(), "Test Step - 16 - Grand total is not displayed properly for wedding proposal on items and products tab");
    ...
    @Epic("Proposal Module - Wedding")
    @Test(priority = 3, enabled = true, groups = {"Regression", "Sanity"})
    ...
    @Epic("Proposal Module - Wedding")
    @Test(priority = 4, enabled = true, groups = {"Regression", "Sanity"})
    ...
    @Epic("Proposal Module - Wedding")
    @Test(priority = 5, enabled = true, groups = {"Regression", "Sanity"})
    public void Validate_Hana_T1661_HanaPOS_Proposal_settings_Wedding_Verify_the_Delivery_fee_in_dollar_Functionality_Test() {
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        ...
        try {
            ...
            proposal_settings.enter_Wedding_Setup_Fee("49.99");
            delayWithGivenTime(1000);
            softassert.assertEquals(proposal_settings.get_Wedding_Setup_Fee(), "49.99", "Wedding proposal settings setup fee label is not displayed");

            proposal_settings.enter_Wedding_Delivery_Fee("12.49");
            delayWithGivenTime(1000);
            softassert.assertEquals(proposal_settings.get_Wedding_Delivery_Fee(), "12.49", "Wedding proposal settings delivery fee label is not displayed");
            ...
            proposal.Click_AddProposalBtn();
            delayWithGivenTime(2000);
            softassert.assertTrue(proposal.Verify_CreateProposalHeader_Popup(), "Test Step - 6 - Create a Proposal popup is not displayed");
            ...
            softassert.assertEquals(manageproposal.get_Delivery_Fee_Displayed(), "12.49", "Test Step - 16 - Delivery fee is not displayed on row 1 product table grid");
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Actual_GrandTotal(), manageproposal.get_Dollar_Based_Calculated_Expected_GrandTotal(), "Test Step - 16 - Grand total is not displayed properly on product table grid");
    ...
    @Epic("Proposal Module - Wedding")
    @Test(priority = 6, enabled = true, groups = {"Regression", "Sanity"})
    public void Validate_Hana_T1663_HanaPOS_Proposal_settings_Wedding_Verify_the_Delivery_fee_in_percentage_Functionality_Test() {
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        ...
        try {
            ...
            proposal_settings.enter_Wedding_Delivery_Fee("10");
            delayWithGivenTime(1000);
            softassert.assertEquals(proposal_settings.get_Wedding_Delivery_Fee(), "10", "Wedding proposal settings delivery fee label is not displayed");
