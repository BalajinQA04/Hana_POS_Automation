...
public class Hana_T253_Add_Proposal_CreateProposalPage_Wedding_SearchFilter_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T253_Add_Proposal_CreateProposalPage_Wedding_SearchFilter_Functionality_Test() {

        CustomSoftAssert softassert = new CustomSoftAssert();
        logger.info("**** Starting  Validate_Hana_T253_Add_Proposal_CreateProposalPage_Wedding_SearchFilter_Functionality_Test ****");
