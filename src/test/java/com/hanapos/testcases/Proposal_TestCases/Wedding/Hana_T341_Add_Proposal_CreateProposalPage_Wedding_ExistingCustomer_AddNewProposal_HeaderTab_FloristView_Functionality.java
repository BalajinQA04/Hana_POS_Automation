...
public class Hana_T341_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_FloristView_Functionality extends TestBaseClass {
    ...
    public void Hana_T341_Add_Proposal_CreateProposalPage_Wedding_ExistingCustomer_AddNewProposal_HeaderTab_FloristView_Functionality_Test() {
        ...
        try {
            ...
            String groomFirstName = faker.name().firstName();
            String groomLastName = faker.name().lastName();
            String groomPhoneNumber = faker.numerify("###-###-####");
            String groomEmail = faker.internet().emailAddress();

            delayWithGivenTime(2000);
            manageproposal.Select_Bride_Groom_DropDown2("Bride");
            delayWithGivenTime(2000);
            manageproposal.Enter_Groom_FirstName(groomFirstName);
            manageproposal.Enter_Groom_LastName(groomLastName);
            manageproposal.Enter_Groom_PhoneNumber(groomPhoneNumber);
            manageproposal.Enter_Groom_Email(groomEmail);
            manageproposal.Enter_Groom_City("Lyon Township");
            manageproposal.Enter_Groom_State("MI");
            manageproposal.Enter_Groom_Address("Blossom Valley Trail");
            manageproposal.Enter_Groom_Zip("48165");

            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Entered_Groom_FirstName(), groomFirstName, "Test Step - 10 -Entered groom first name is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_LastName(), groomLastName, "Test Step - 10 -Entered groom last name is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_PhoneNumber(), groomPhoneNumber, "Test Step - 10 -Entered groom phone number is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_Email(), groomEmail, "Test Step - 10 -Entered groom email is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_City(), "Lyon Township", "Test Step - 10 -Entered groom city is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_State(), "MI", "Test Step - 10 -Entered groom state is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_Address(), "Blossom Valley Trail", "Test Step - 10 -Entered groom address is not displayed");
            softassert.assertEquals(manageproposal.get_Entered_Groom_Zip(), "48165", "Test Step - 10 -Entered groom zip code is not displayed");

            // Test Step - 11
            delayWithGivenTime(2000);
            String ceremonyLocation = generate_Ceremony_Location();
            manageproposal.Click_Weddings_eventDetails_Tab();
            manageproposal.Enter_CeremonyLocation(ceremonyLocation);
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Entered_CeremonyLocation(), ceremonyLocation, "Test Step - 24 -Entered ceremony location is not displayed");
            ...
            // Test Step - 12
            String receptionLocation = generate_Ceremony_Location();
            delayWithGivenTime(2000);
            manageproposal.Enter_ReceptionLocation(receptionLocation);
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Entered_ReceptionLocation(), receptionLocation, "Test Step - 24 -Entered reception location is not displayed");
            //	softassert.assertEquals(manageproposal.get_Entered_CeremonyDate(), "Wed, 01 Oct 2022","Test Step - 24 -Entered ceremony date is not displayed");
            //	softassert.assertEquals(manageproposal.get_Entered_CeremonyTime(), "11:00 AM","Test Step - 24 -Entered ceremony time is not displayed");
            ...
            // Test Step - 17
            manageproposal.Click_On_Florist_View_Link();
            softassert.assertEquals(manageproposal.get_titleofproposal_on_floristView_window(), "Abish David And " + groomFirstName + " " + groomLastName, "Test Step - 17: Title for the proposal florist view is not displayed");
            softassert.assertTrue(manageproposal.Validate_WeddingInfo_Header_on_floristView(), "Test Step - 17 - Florist View - Wedding Info Header is not displayed");
            softassert.assertTrue(manageproposal.Validate_coordinator_info_header_on_floristView_window(), "Test Step - 17 - Florist View - Coordinator Info Header is not displayed");
            getDriver().close();
            switchToWindowbyIndex(0);
            softassert.assertTrue(manageproposal.verify_edit_proposal_label_header_isDisplayed(), "Test Step - 17: Edit Proposal Label Header is not displayed");
