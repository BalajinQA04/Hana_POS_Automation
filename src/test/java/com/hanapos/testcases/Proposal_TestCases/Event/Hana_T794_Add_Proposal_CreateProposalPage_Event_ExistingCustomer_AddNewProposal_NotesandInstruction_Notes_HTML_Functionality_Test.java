...
public class Hana_T794_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_NotesandInstruction_Notes_HTML_Functionality_Test extends TestBaseClass {
    ...
    public void Hana_T794_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_NotesandInstruction_Notes_HTML_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_T794_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_NotesandInstruction_Notes_HTML_Functionality_Test ****");
        ...
        try {
            ...
            // Test Step - 11
            softassert.assertTrue(manageproposal.isNotesLabel_Element_Displayed(), "Test Step - 11: Notes label is not displayed on notes and instruction tab");

            // Test Step - 12
            manageproposal.Click_HTML_Button_On_NotesAndInstructionsTab();

            // Test Step - 13
            delayWithGivenTime(3000);
            softassert.assertTrue(manageproposal.is_htmlbutton_enabled(), "Test Step - 13 - HTML button is not enabled");
            softassert.assertTrue(manageproposal.Validate_ElementsOfNotes_and_InstructionsTab_isDisabled(), "Test Step - 13 - All other elements are enabled on notes and instruction tab");
