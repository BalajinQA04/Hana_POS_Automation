...
public class Hana_T1650_HanaPOS_Proposal_Proposal_settings_Event_Verify_the_delivery_fee_tax_calculation_for_label_Include_Delivery_Fee_in_Tax_Calculation_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1650_Proposal_settings_Event_Verify_the_delivery_fee_tax_calculation_for_label_Include_Delivery_Fee_in_Tax_Calculation_Functionality_Test() {
        ...
        try {
            ...
            proposal_settings.enter_Event_Delivery_Fee("14.99");
            delayWithGivenTime(1000);
            softassert.assertEquals(proposal_settings.get_Event_Delivery_Fee(), "14.99", "Event proposal settings delivery fee label is not displayed");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Tax_Amount_Displayed(), "$" + manageproposal.get_Expected_TaxAmount(), "Test Step - 16 - Tax amount is not displayed properly on Event Proposal - Item & Products tab");
    ...
    public void Validate_Hana_T1652_HanaPOS_Proposal_Proposal_settings_Event_Verify_the_delivery_fee_tax_calculation_for_label_Exclude_Delivery_Fee_in_Tax_Calculation_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Tax_Amount_Displayed(), "$" + manageproposal.get_Expected_TaxAmount_Without_Delivery_Fee(), "Test Step - 16 - Tax amount is not displayed properly on Event Proposal - Item & Products tab");
            softassert.assertEquals(manageproposal.get_Actual_GrandTotal(), manageproposal.get_Percentage_Based_Calculated_Expected_GrandTotal(), "Test Step - 16 - Grand total is not displayed properly on Event Proposal - Item & Products tab");
    ...
    public void Validate_Hana_T1658_HanaPOS_Proposal_Proposal_settings_Event_Verify_the_Setup_Fee_In_Dollar_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        ...
        try {
            ...
            softassert.assertEquals(manageproposal.get_SetupFee_Symbol_Displayed_On_ItemsAndProducts_Tab(), "$", "Test Step - 16 - Setup fee symbol is not displayed on row 1 product table grid");
            softassert.assertEquals(manageproposal.get_Setup_Fee_Displayed_On_ItemsAndProducts_Tab(), "54.99", "Test Step - 16 - Setup fee is not displayed on row 1 product table grid");
    ...
    public void Validate_Hana_T1660_HanaPOS_Proposal_Proposal_settings_Event_Verify_the_delivery_fee_tax_calculation_for_label_Exclude_Delivery_Fee_in_Tax_Calculation_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
