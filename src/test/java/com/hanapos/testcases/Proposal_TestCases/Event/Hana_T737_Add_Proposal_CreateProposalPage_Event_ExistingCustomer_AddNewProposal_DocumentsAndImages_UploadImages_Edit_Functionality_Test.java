...
public class Hana_T737_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_DocumentsAndImages_UploadImages_Edit_Functionality_Test extends TestBaseClass {
    ...
    public void Hana_T737_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_DocumentsAndImages_UploadImages_Edit_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_T737_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_DocumentsAndImages_UploadImages_Edit_Functionality_Test ****");
        ...
        try {
            ...
            // Test Step - 15
            delayWithGivenTime(3000);
            manageproposal.Click_EditIcon_on_Image1("Groom.jpg");
            delayWithGivenTime(1000);
            softassert.assertEquals(manageproposal.VerifySucessToasterMessageText(), "Image saved successfully..");

            // Test Step - 16
            manageproposal.Click_EditIcon_on_Image2("Wedding Stage.jpg");
            delayWithGivenTime(1000);
            softassert.assertEquals(manageproposal.VerifySucessToasterMessageText(), "Image saved successfully..");

            // Test Step - 17
            manageproposal.Click_EditIcon_on_Image3("Bride.jpg");
            delayWithGivenTime(1000);
            softassert.assertEquals(manageproposal.VerifySucessToasterMessageText(), "Image saved successfully..");
