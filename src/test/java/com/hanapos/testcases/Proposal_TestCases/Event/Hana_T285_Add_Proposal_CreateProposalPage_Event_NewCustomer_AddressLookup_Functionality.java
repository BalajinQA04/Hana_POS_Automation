...
public class Hana_T285_Add_Proposal_CreateProposalPage_Event_NewCustomer_AddressLookup_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T285_Add_Proposal_CreateProposalPage_Event_NewCustomer_AddressLookup_Functionality_Test() {
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger.info("**** Starting  Validate_Hana_T285_Add_Proposal_CreateProposalPage_Event_NewCustomer_AddressLookup_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertEquals(proposal.get_createproposalpopup_city_field(), "Driggs", "Test Step - 7: City of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_state_field(), "ID", "Test Step - 7: State of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_address_field(), "10 S Main St", "Test Step - 7: Address of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_zipcode_field(), "83422", "Test Step - 7: Zipcode of customer is not displayed in create proposal popup");
            ...
            softassert.assertEquals(proposal.get_createproposalpopup_selectpackage_dropdownfield(), "Blank", "Test Step - 7: Selected package is not displayed in create proposal popup");
            ...
            softassert.assertEquals(proposal.get_createproposalpopup_address_field(), "Broome St", "Test Step - 7: Address of customer is not displayed in create proposal popup");
