...
public class Hana_T272_Add_Proposal_CreateProposalPage_Event_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T272_Add_Proposal_CreateProposalPage_Event_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger.info("**** Starting  Validate_Hana_T272_Add_Proposal_CreateProposalPage_Event_Functionality_Test ****");
        ...
        try {
          ...
          //  manageproposal.UploadImageFile1("samplepdf.pdf"); // need to add log message user friendly
           ...
           // softassert.assertTrue(manageproposal.verify_uploaded_seconddocument_displayed_on_grid(), "Test Step - 10: Uploaded first document is not displayed on documents and images tab");
            ...
            //   softassert.assertTrue(proposal.Verify_ViewProposal_ActionMenu_Popup_IsDisplayed(), "TestStep- 20 - In View Proposal page, Action menu popup is not display after click on action menu icon");
