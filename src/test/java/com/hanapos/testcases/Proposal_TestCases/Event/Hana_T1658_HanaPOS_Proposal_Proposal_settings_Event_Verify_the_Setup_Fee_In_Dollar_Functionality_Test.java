...
public class Hana_T1658_HanaPOS_Proposal_Proposal_settings_Event_Verify_the_Setup_Fee_In_Dollar_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1658_HanaPOS_Proposal_Proposal_settings_Event_Verify_the_Setup_Fee_In_Dollar_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Actual_GrandTotal(), manageproposal.get_Expected_GrandTotal_For_Dollar_Setup_Fee(), "Test Step - 16 - Grand total is not displayed properly on Event Proposal - Item & Products tab");
