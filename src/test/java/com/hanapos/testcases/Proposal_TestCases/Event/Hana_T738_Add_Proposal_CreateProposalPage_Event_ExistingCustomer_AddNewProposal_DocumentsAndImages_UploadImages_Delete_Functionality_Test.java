...
public class Hana_T738_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_DocumentsAndImages_UploadImages_Delete_Functionality_Test extends TestBaseClass {
    ...
    public void Hana_T738_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_DocumentsAndImages_UploadImages_Delete_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_T738_Add_Proposal_CreateProposalPage_Event_ExistingCustomer_AddNewProposal_DocumentsAndImages_UploadImages_Delete_Functionality_Test ****");
        ...
        try {
            ...
            // Test Step - 15
            delayWithGivenTime(3000);
            manageproposal.Click_DeleteIcon_on_Image1();
            delayWithGivenTime(1000);
            softassert.assertEquals(manageproposal.VerifySucessToasterMessageText(), "Image removed successfully");

            // Test Step - 16
            delayWithGivenTime(3000);
            manageproposal.Click_DeleteIcon_on_Image2();
            delayWithGivenTime(1000);
            softassert.assertEquals(manageproposal.VerifySucessToasterMessageText(), "Image removed successfully");

            // Test Step - 17
            delayWithGivenTime(3000);
            manageproposal.Click_DeleteIcon_on_Image3();
            delayWithGivenTime(1000);
            softassert.assertEquals(manageproposal.VerifySucessToasterMessageText(), "Image removed successfully");
