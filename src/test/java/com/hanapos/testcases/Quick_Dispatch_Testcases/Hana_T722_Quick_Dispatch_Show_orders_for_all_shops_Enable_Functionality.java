...
public class Hana_T722_Quick_Dispatch_Show_orders_for_all_shops_Enable_Functionality extends TestBaseClass {
    ...
    public void pre_requisite_for_Sisterchicks_Shop_Invoice_Hana_T722(String dashboard_shopname, String salesperson,
...
//            Shop Hana order
            ...
            dashboardorder.EnterGlobalSearch(sisterchicks_shop_invoiceNumber);
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(sisterchicks_shop_invoiceNumber), "Test Step - 10 - Respective Invoice number : " + sisterchicks_shop_invoiceNumber + " is not displayed on all orders page");
    ...
    public void pre_requisite_for_Automation_Shop_Invoice_Hana_T722(
...
//            Shop Hana order
            ...
            dashboardorder.EnterGlobalSearch(automation_shop_invoiceNumber);
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(automation_shop_invoiceNumber), "Test Step - 10 - Respective Invoice number : " + automation_shop_invoiceNumber + " is not displayed on all orders page");
    ...
    private void Validate_Hana_T722_Show_orders_for_all_shops_Enable_functionality() {
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        CustomSoftAssert softassert = new CustomSoftAssert();
        lp = new LoginPage();
