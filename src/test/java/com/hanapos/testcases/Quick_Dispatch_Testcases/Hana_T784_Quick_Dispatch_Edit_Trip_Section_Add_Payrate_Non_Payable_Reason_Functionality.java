...
public class Hana_T784_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality extends TestBaseClass {
    ...
    @Test(enabled = true, invocationCount = 1, priority = 1, groups = {"Regression"}, dataProvider = "fetch_Excel_Data")
    public void Validate_Hana_T784_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality(
        ...
        logger.info("*** Starting  Hana-Validate_Hana_T784_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality  ***");
        ...
        try {
          ...
          //  dispatch.Select_Dispatch_Date();
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(payrollreportpage.is_NonPayable_Reason_Displayed_On_Payroll_Report_Table_Grid(invoice1), NonpayableText, "Test Step 30 - Non Payable Reason is not displaying as expected");
  ...
  /*  @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T784_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality(
        ...
        logger.info("*** Starting  Hana_T784_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality ***");
        logger.debug("capturing application debug logs....");
        try {
            // Test Step - 1
            lp = new LoginPage();
            ...
            delayWithGivenTime(2000);
            confirmationPage.Select_Confirmation_Date();
