...
public class Hana_T796_Quick_Dispatch_Saved_Trips_Edit_Functionality extends TestBaseClass {
    ...
    String invoice1 = null;
    String invoice2 = null;
    String invoice3 = null;
    ...
    public void Validate_Hana_T796_Quick_Dispatch_Saved_Trips_Edit_Functionality(
        ...
        try {
            ...
            softassert.assertTrue(orderconfirmationpage.VerifyOrderConfirmationPage(), "Test Step - 13 - Order confirmation page is not displayed");
            delayWithGivenTime(500);
            invoice3 = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoice3), "Test Step - 10 - Respective Invoice number : " + invoice3 + " is not displayed on all orders page");
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_trip_section(invoice2), "Test Step 5 - Invoice number is not displaying in the Trip section");
            ...
            dispatch.Click_DispatchSave_Button();
            delayWithGivenTime(3000);
            String Route_Number2 = dispatch.Get_Route_number();
            delayWithGivenTime(3000);

            // dispatch.Click_SavedTrips_based_on_route_number(Route_Number);
            dispatch.click_SavedTrip_Route_Number(Route_Number);
            delayWithGivenTime(2000);

            //dispatch.Click_Confirmation_yes_button();
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.Get_Route_number(), Route_Number, "Test Step 5 - Clicked trip is not displaying in the Trip Section");
            delayWithGivenTime(3000);

            // Test Step 6
            dispatch.click_Pending_Deliveries_Section_Invoice_Number(invoice3);
            delayWithGivenTime(2000);
            softassert.assertTrue(dispatch.is_Invoice_Number_Displayed_On_TripSection(invoice3), "Test Step 6 - Selected Invoice is not displaying in the Trip Section");

            //Test Step 7
            delayWithGivenTime(2000);
            //  dispatch.Click_SavedTrips_based_on_route_number(Route_Number2);
            dispatch.click_SavedTrip_Route_Number(Route_Number2);
            delayWithGivenTime(1000);
            softassert.assertTrue(dispatch.verify_confirmation_popup_is_displaying_or_not(), "Test Step 7 - Confirmation pop-up is not displaying");

            //Test Step 8
            delayWithGivenTime(1000);

            softassert.assertEquals(dispatch.Get_Confirmation_popup_header_text(), "Confirmation", "Test Step 8 - Confirmation pop-up header is not proper");
            softassert.assertEquals(dispatch.Get_confirmation_popup_warning_text(), "Dispatch Data Not Saved. Are you sure you want to reload the data based on the selected date ?", "Test Step 8 - Confirmation pop-up warning message is not proper");
            softassert.assertTrue(dispatch.verify_yes_button_is_displaying_or_not_in_confirmation_popup(), "Test Step 8 - Confirmation pop-up yes button is not displaying");
            softassert.assertTrue(dispatch.verify_no_button_is_displaying_or_not_in_confirmation_popup(), "Test Step 8 - No button is not displaying in the confirmation pop-up");

            //Test Step 9
            delayWithGivenTime(2000);
            dispatch.Click_confirmation_popup_no_button();
            softassert.assertTrue(dispatch.verify_invoice_isDisplayed_in_trip_section(invoice3), "Test Step - 9 - Trip section is reloaded");
            ...
            // softassert.assertFalse(dispatch.verify_confirmation_popup_is_displaying_or_not(), "Test Step 10 - Confirmation pop-up is displaying");
            softassert.assertEquals(dispatch.Get_Route_number(), Route_Number2, "Test Step 10 - Respective Route number is not loaded in the trip section");

            //Test Step 11
            dispatch.Click_The_Invoice_In_The_Pending_Deliveries_Section(invoice3);
            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_trip_section(invoice3), " Test Step 11 - Invoice is not displaying in the Trip Section");

            // Test Step 12
            dispatch.Click_DispatchSave_Button();
            delayWithGivenTime(3000);
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Dispatch Saved Successfully", "Test Step - 12 - Dispatch Saved Successfully toast success text message is not displayed");

            // Test Step 13
            dispatch.Click_CloseIcon_dispatchPopup();
            softassert.assertFalse(dispatch.Verify_DispatchPopup_IsDisplayed(), "Test Step - 13 - Dispatch popup is not closed");

            //Test Step 14
            dashboard.Hover_Dispatch_And_Click_QuickDispatch();
            softassert.assertTrue(dispatch.Verify_SavedTrip_based_on_route_number(Route_Number2), "Test Step 14 - Saved trip is not displaying");
            delayWithGivenTime(3500);

            // Test Step 15
            dispatch.Click_SavedTrips_based_on_route_number(Route_Number2);
            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_trip_section(invoice3), "Test Step 15 - Updated Trip is not displaying properly");
