...
public class Hana_T813_Quick_Dispatch_Select_Shop_Functionality extends TestBaseClass {
    ...
    String hana_invoiceNumber, invoiceNumber;
    ...
    public void Validate_Hana_T813_Quick_Dispatch_Select_Shop_Functionality(String dashboard_shopname, String salesperson,
                                                                            String customername, String recifname, String recilname,
                                                                            String reci_full_address1, String reciaddress1,
                                                                            String reciaddress2, String recizip, String recicity, String recistate, String recicountry, String reciphone, String recilocation, String occasion, String searchandselectitemcode, String paymenttype) {
        ...
        try {
            ...
            softassert.assertTrue(dashboard.VerifyHanaDashBoardPage(), "Hana dashboard page home logo is not displayed");
            ...
            dashboard.SelectShopNameDropDown("sisterchicks flowers and gifts");
            ...
            softassert.assertTrue(dispatch.Shop_is_Displayed_or_not("sisterchicks flowers and gifts"), "Test Step 4 - Current shop is not displaying");

            // Test Step 5
            dispatch.Select_Shops_From_Dropdown(prop.getProperty("shopname"));

            softassert.assertTrue(dispatch.Shop_is_Displayed_or_not(prop.getProperty("shopname")), " Test Step 5 - Updated shop is not displaying");
