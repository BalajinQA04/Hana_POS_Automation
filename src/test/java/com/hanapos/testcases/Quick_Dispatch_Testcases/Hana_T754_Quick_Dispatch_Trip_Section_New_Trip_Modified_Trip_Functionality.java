...
public class Hana_T754_Quick_Dispatch_Trip_Section_New_Trip_Modified_Trip_Functionality extends TestBaseClass {
    ...
    String invoice1, invoice2;
    public static final String dataSheetName = "Hana_T754";
    ...
    public void Pre_requiste_First_Order_for_Hana_T754_Quick_Dispatch_Trip_Section_New_Trip_Modified_Trip_Functionality(
        ...
        try {
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(16, 30);
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoice1), "Test Step - 14 - Invoice number: " + invoice1 + " is not displayed on dashboard order page");
        } catch (Exception e) {
    ...
    @Epic("Quick Dispatch Module")
    @Test(enabled = true, priority = 2, groups = {"Regression"}, dataProvider = "fetch_Excel_Data")
    public void Pre_Requiste_for_Second_Order_Hana_T754_Quick_Dispatch_Trip_Section_New_Trip_Modified_Trip_Functionality(
            String salesperson, String customername, String recifname, String recilname,
            String reci_full_address1, String reciaddress1, String reciaddress2, String recizip, String recicity,
            String recistate, String recicountry, String reciphone, String recilocation, String occasion,
            String searchandselectitemcode, String paymenttype, String drivername) {
    ...
    public void Validate_T754_Quick_Dispatch_Trip_Section_New_Trip_Modified_Trip_Functionality() {
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger_Util = new LoggerUtil();
        String testCaseName = getCurrentTestName();
        logger.info("**** Starting  Validate_T754_Quick_Dispatch_Trip_Section_New_Trip_Modified_Trip_Functionality  ****");
        ...
        try {
            ...
            dispatch.click_The_Invoice_Number_On_The_Pending_Deliveries_Section(invoice1);
            delayWithGivenTime(2000);
            ...
            // Test Step - 5
            softassert.assertEquals(Integer.parseInt(dispatch.Get_total_deliveries_count_from_trip_section()), inital_delivery_count + 1, "Test Step 5 - Save button is not displaying in the Trip Section");

            //Test Step - 6
            delayWithGivenTime(2000);
            dispatch.Select_Driver("LJB Liam Jack Benjamin");
            delayWithGivenTime(2000);
            softassert.assertEquals(dispatch.get_Selected_Driver(), "LJB Liam Jack Benjamin", "Test Step - 7 - Selected Driver is not displayed on the dropdown");

            // Test Step - 7
            phoneorder = new OrderEntry_Alais_PhoneOrderPage();
            dispatch.Click_DispatchSave_Button();
            delayWithGivenTime(3000);
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Dispatch Saved Successfully", "Test Step - 7 - Dispatch Saved Successfully toast success text message is not displayed");
            softassert.assertTrue(dispatch.verify_trip_no_is_generated_or_not(), "Test step 7 - Trip number is not generated");
            softassert.assertTrue(dispatch.verify_route_number_is_generated_or_not(), "Test step 7 - Route number is not displaying");
            softassert.assertTrue(dispatch.verify_trip_section_created_date_time_format_displaying_properly_or_not(), "Test Step 7 - Created Date Time format is not displaying properly");

            // Test Step 8
            dispatch.click_The_Invoice_Number_On_The_Pending_Deliveries_Section(invoice2);
            delayWithGivenTime(2000);
            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_trip_section(invoice2), "Test Step 8 - Invoice number " + invoice2 + " is not displaying in the Trip section");
            delayWithGivenTime(2000);

            dispatch.Click_New_Trip_button();
            delayWithGivenTime(3500);
            softassert.assertTrue(dispatch.verify_confirmation_popup_is_displaying_or_not(), "Test Step 8 - Confirmation pop-up is not displaying");

            // Test Step 9
            softassert.assertEquals(dispatch.Get_Confirmation_popup_header_text(), "Confirmation", "Test Step 9 - Confirmation header is not displaying properly");
            softassert.assertEquals(dispatch.Get_confirmation_popup_warning_text(), "Dispatch Data Not Saved. Are you sure you want to reload the data based on the selected date ?", "Test Step 9 - Confirmation pop-up warning message is not displaying properly");
            softassert.assertTrue(dispatch.verify_no_button_is_displaying_or_not_in_confirmation_popup(), "Test Step 9 - No button is not displaying");
            softassert.assertTrue(dispatch.verify_yes_button_is_displaying_or_not_in_confirmation_popup(), "Test Step 9 - Yes button is not displaying");
            delayWithGivenTime(3000);

            // Test Step - 10
            dispatch.Click_confirmation_popup_no_button();

            //Test Step - 11
            dispatch.Click_New_Trip_button();
            delayWithGivenTime(2000);
            softassert.assertTrue(dispatch.verify_confirmation_popup_is_displaying_or_not(), "Test Step 11 - Confirmation pop-up is not displaying");
            ...
            //  softassert.assertFalse(dispatch.verify_confirmation_popup_is_displaying_or_not(), "Test Step 12 - Confirmation pop-up is not displaying");
            //  softassert.assertFalse(dispatch.validate_invoice_list_is_displaying_or_not_in_Trip_section(), "Test Step 12 - Trip section is not refreshed");
