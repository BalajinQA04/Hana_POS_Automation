...
public class Hana_T761_Quick_Dispatch_Trip_Section_Remote_Print_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T761_Quick_Dispatch_Trip_Section_Remote_Print_Functionality(
        ...
        try {
            ...
            // Test Step 5
            softassert.assertTrue(dispatch.Verify_RemotePrintBtn_IsDisplayed(), "Test Step 5 - Route planner button is not displaying");

            // Test Step 6
            dispatch.Click_remote_print_button();
            softassert.assertTrue(phoneorder.verifySuccessToastMessageAppears(), "Test Step 6 - Success message is not displaying");
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Remote Print Completed Successfully", "Test Step 6 - Toaster message is displaying properly");
