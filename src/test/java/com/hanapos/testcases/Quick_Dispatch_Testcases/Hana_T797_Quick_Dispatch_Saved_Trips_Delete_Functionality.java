...
public class Hana_T797_Quick_Dispatch_Saved_Trips_Delete_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T797_Quick_Dispatch_Saved_Trips_Delete_Functionality(
        ...
        logger.info("*** Starting  Hana-Validate_Hana_T797_Quick_Dispatch_Saved_Trips_Delete_Functionality  ***");
        ...
        try {
            ...
            Route_Number = dispatch.Get_Route_number();
            ...
            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_trip_section(invoice2), "Test Step 4 - Invoice number is not displaying in the Trip section");
            ...
            dispatch.Click_DispatchSave_Button();
            delayWithGivenTime(3000);
            Route_Number2 = dispatch.Get_Route_number();
            delayWithGivenTime(3000);

            // Test Step 4
            //dispatch.Verify_SavedTrip_based_on_route_number()
            softassert.assertTrue(dispatch.Verify_Saved_Trip_Section_IsDisplayed(), "Test Step 4 - Saved Trip Section is not displaying");
            delayWithGivenTime(3000);

            // Test Step 5
            dispatch.click_Delete_Link_in_Saved_Trip_Section(Route_Number);
            delayWithGivenTime(1000);
            //  softassert.assertTrue(dispatch.Verify_Confirmation_popup_IsDisplayed(), "Test Step 5 - Confirmation Pop-up is not displaying");

            // Test Step 6
            softassert.assertEquals(dispatch.Get_Confirmation_popup_header_text(), "Confirmation", "Test Step 6 - Confirmation pop-up header is not proper");
            softassert.assertEquals(dispatch.Get_confirmation_popup_warning_text(), "Are You Sure You Want To Delete Record?", "Test Step 6 - Confirmation pop-up warning message is not proper");
            softassert.assertTrue(dispatch.verify_yes_button_is_displaying_or_not_in_confirmation_popup(), "Test Step 6 - Confirmation pop-up yes button is not displaying");
            softassert.assertTrue(dispatch.verify_no_button_is_displaying_or_not_in_confirmation_popup(), "Test Step 6 - No button is not displaying in the confirmation pop-up");
            delayWithGivenTime(3000);

            // Test Step 7
            dispatch.Click_confirmation_popup_no_button();
            delayWithGivenTime(2000);
            softassert.assertTrue(dispatch.Verify_SavedTrip_based_on_route_number(Route_Number), "Test Step - 7 - Route is not displaying in the Saved Trip Section");
            delayWithGivenTime(3000);

            // Test Step 8
            // dispatch.Delete_SavedTrip_based_on_route_number(Route_Number);
            dispatch.click_Delete_Link_in_Saved_Trip_Section(Route_Number);
            delayWithGivenTime(3000);
            dispatch.Click_Confirmation_yes_button();
            delayWithGivenTime(4000);
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Trip Deleted Successfully", "Test Step - 8 - Trip Deleted Successfully toast success text message is not displayed");

            softassert.assertTrue(dispatch.Verify_The_Invoice_Number_Displayed_On_Pending_Deliveries(invoice1), "Test Step 8 - Invoice 1: " + invoice1 + " is not displying in the Pending Deliveries section");
//            delayWithGivenTime(2000);
            dispatch.click_Delete_Link_in_Saved_Trip_Section(Route_Number2);
            delayWithGivenTime(3000);

            dispatch.Click_Confirmation_yes_button();
            delayWithGivenTime(4000);
            softassert.assertEquals(phoneorder.verifySuccessToastMessageText(), "Trip Deleted Successfully", "Test Step - 8 - Trip Deleted Successfully toast success text message is not displayed");
            softassert.assertTrue(dispatch.Verify_The_Invoice_Number_Displayed_On_Pending_Deliveries(invoice2), "Test Step 8 - Invoice 2:" + invoice2 + " is not displying in the Pending Deliveries section");
