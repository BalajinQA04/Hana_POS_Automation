...
public class Hana_T777_Quick_Dispatch_Edit_Trip_Section_Route_Planner_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T777_Quick_Dispatch_Edit_Trip_Section_Route_Planner_Functionality(
        ...
        logger.info("**** Starting  Hana-Validate_Hana_T777_Quick_Dispatch_Edit_Trip_Section_Route_Planner_Functionality  ****");
        ...
        try {
            ...
            delayWithGivenTime(2000);
            po_number = faker.number().digits(6);
            //  phoneorder.Enter_PO_Number_Details_Payment_Section(po_number);
            delayWithGivenTime(2000);
            ...
            // Test Step 5
            softassert.assertTrue(dispatch.Verify_RoutePlannerBtn_IsDisplayed(), "Test Step 5 - Route Planner button is not displaying");

            // Test Step 6
            dispatch.Click_route_planner_button();
            delayWithGivenTime(4000);
            advanceDispatchPage = new Advance_DispatchPage();
            softassert.assertTrue(advanceDispatchPage.verify_Advance_Dispatch_Page_IsDisplayed(), "Test Step 6 - Advance Dispatch Page is not displaying");
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.validate_the_invoice_is_displaying_in_the_trip_section(invoice1));
  ...
  /*  @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T777_Quick_Dispatch_Edit_Trip_Section_Route_Planner_Functionality(
        ...
        try {
            ...
            softassert.assertTrue(advanceDispatchPage.verify_Advance_Dispatch_Page_IsDisplayed(), "Test Step 6 - Advance Dispatch Page is not displaying");
            delayWithGivenTime(3000);
            softassert.assertTrue(advanceDispatchPage.verify_whether_invoice_is_displaying_in_the_advance_dispatch_trip_section(invoice1));
