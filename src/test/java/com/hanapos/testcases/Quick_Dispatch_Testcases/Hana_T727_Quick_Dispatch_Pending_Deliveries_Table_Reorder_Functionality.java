...
public class Hana_T727_Quick_Dispatch_Pending_Deliveries_Table_Reorder_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T727_Quick_Dispatch_Pending_Deliveries_Table_Reorder_Functionality(
        ...
        try {
            ...
            softassert.assertEquals(dispatch.verify_column_reordered_or_not_for_column_sno(), "Invoice", "Test Step 4 - I - Column swap one is not swaped");
            delayWithGivenTime(3000);
            dispatch.revert_verify_column_reordered_or_not_for_column_sno_function();
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.verify_column_reordered_or_not_for_column_invoice(), "Invoice", "Test Step 4 - II - Column swap two is not swaped");
            delayWithGivenTime(3000);
            dispatch.revert_verify_column_reordered_or_not_for_column_invoice_function();
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.verify_column_reordered_or_not_for_column_name(), "Name", "Test Step 4 - III - Column swap three is not swaped");
            delayWithGivenTime(3000);
            dispatch.revert_verify_column_reordered_or_not_for_column_name_function();
