...
public class Hana_T786_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Payable_Unchecked_Functionality extends TestBaseClass {
    ...
    @Test(enabled = true, invocationCount = 1, priority = 1, groups = {"Regression", "Sanity"}, dataProvider = "fetch_Excel_Data")
    public void Validate_Hana_T786_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Payable_Unchecked_Functionality(
        ...
        try {
            ...
            //Test Step 14
            softassert.assertTrue(payrollreportpage.is_InvoiceNumber_Displayed_On_Payroll_Report_Table_Grid(invoice1), "Test Step 15 - Invoice Number : " + invoice1 + " is not displaying on payroll report table grid");
