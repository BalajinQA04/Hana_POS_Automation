...
public class Hana_T772_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Checked_Functionality extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T772";
    ...
    public void Validate_Hana_T772_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Checked_Functionality(
        ...
        logger.info("**** Starting  Hana-Validate_Hana_T772_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Checked_Functionality  ****");
...
//            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_the_AddPayrate_popup(invoice1), "Test Step 5 - Invoice number is not displaying in the Add Payrate pop-up");
            ...
            dispatch.Click_close_icon_add_payrate_pop_up();
            softassert.assertFalse(dispatch.verify_add_payrate_popup_IsDisplayed(), "Test Step 11 - Add Payrate pop-up is not displaying");
            ...
            //Test Step 16
            delayWithGivenTime(2000);
            //softassert.assertTrue(payrollreportpage.Verify_Payable_Checkbox_IsChecked(invoice1), "Test Step 16 - Checkbox is not checked");
            delayWithGivenTime(2000);
            softassert.assertTrue(payrollreportpage.is_Payable_Checkbox_Checked_On_Payroll_Report_Table_Grid(invoice1), "Test Step 30 - Non Payable Reason checkbox is not checked as expected");

            //Test Step 17
            //  softassert.assertTrue(payrollreportpage.Verify_Driver_Payrate_IsDisplayed(invoice1, "10"), "Test Step 17 - Entered Drivers Payrate is not displaying");
            softassert.assertEquals(payrollreportpage.get_PayRate_From_PayrollReport(invoice1), "10", "Test Step 17 - Entered Drivers Payrate is not displaying");
        } catch (Exception e) {
            logger_Util = new LoggerUtil();
