...
public class Hana_T760_Quick_Dispatch_Trip_Section_Route_Planner_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T760_Quick_Dispatch_Trip_Section_Route_Planner_Functionality(
        ...
        try {
            ...
            softassert.assertEquals(advanceDispatchPage.Verify_Advance_DispatchPopup_IsDisplayed(), "Hana | Advance Dispatch", "Test Step - 6 - Advance Dispatch popup is not displayed");
            softassert.assertTrue(advanceDispatchPage.verify_whether_invoice_is_displaying_in_the_advance_dispatch_trip_section(invoice1), "Test Step - 6 - Trip section is not loaded and invoice is not displaying");
