...
public class Hana_T759_Quick_Dispatch_Trip_Section_New_Trip_UnModified_Trip_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T759_Quick_Dispatch_Trip_Section_New_Trip_UnModified_Trip_Functionality(
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertFalse(dispatch.verify_confirmation_popup_is_displaying_or_not(), "Test Step 8 - Confirmation pop-up is displaying");
            delayWithGivenTime(1000);

            //dispatch.Click_confirmation_popup_yes_button();

            // softassert.fail("Test Step 8 - Failed due to Know issue waiting for the clarification in the functionality");

            // Test Step 9
            softassert.assertFalse(dispatch.is_Invoice_Number_Displayed_In_Dispatch_Table_Grid_Row1_After_Confirm_NewTrip(), "Test Step 12 - Trip section is Invoice number is displaying in the Dispatch table grid row 1");
        } catch (Exception e) {
            logger_Util = new LoggerUtil();
   ...
   /* @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T759_Quick_Dispatch_Trip_Section_New_Trip_UnModified_Trip_Functionality(
        ...
        try {
            ...
            softassert.fail("Test Step 8 - Failed due to Know issue waiting for the clarification in the functionality");
            // Test Step 9
            softassert.assertTrue(dispatch.validate_invoice_list_is_displaying_or_not_in_Trip_section(), "Test Step 12 - Trip section is refreshed");
