...
public class Hana_T788_Quick_Dispatch_Saved_Trips_Saved_Trips_table_Reorder_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T788_Quick_Dispatch_Saved_Trips_Saved_Trips_table_Reorder_Functionality(
        ...
        try {
            ...
            softassert.assertTrue(dispatch.Verify_Saved_Trip_Section_IsDisplayed(), "Test Step - 4 - Saved Trip Section is not displayed");
            delayWithGivenTime(3000);

            softassert.assertEquals(dispatch.reorder_sno_column_and_verify(), "S.No.", "Test Step 4 - I - Column swap one is not swaped");

            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.reorder_driverInitial_column_and_verify(), "Driver Initial", "Test Step 4 - II - Column swap two is not swaped");
            //delayWithGivenTime(3000);
            //dispatch.revert_verfiy_summary_table_column_summarized_by_reorder_or_not();
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.reorder_driverName_column_and_verify(), "Driver Name", "Test Step 4 - III - Column swap three is not swaped");
            delayWithGivenTime(3000);
            //dispatch.revert_verfiy_summary_table_column_count_reorder_or_not();
            softassert.assertEquals(dispatch.reorder_PhoneNo_column_and_verify(), "Phone No", "Test Step 4 - IV - Column swap three is not swaped");
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.reorder_RouteNo_column_and_verify(), "Route No", "Test Step 4 - V - Column swap three is not swaped");
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.reorder_CreatedDate_column_and_verify(), "Created Date", "Test Step 4 - VI - Column swap three is not swaped");
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.reorder_Delete_column_and_verify(), "Created Date", "Test Step 4 - VII - Column swap three is not swaped");
            delayWithGivenTime(3000);
