...
public class Hana_T770_Quick_Dispatch_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality extends TestBaseClass {
    ...
    String NonpayableText = "Automation Reason";
    public static final String dataSheetName = "Hana_T767";
    ...
    public void Validate_Hana_T770_Quick_Dispatch_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality(
        ...
        logger.info("**** Starting  Hana-Validate_Hana_T770_Quick_Dispatch_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality  ****");
        ...
        try {
            ...
            delayWithGivenTime(3000);
            softassert.assertTrue(dispatch.verify_add_payrate_popup_IsDisplayed(), "Test Step 5 - Add Payrate pop-up is not displaying");

            //Test Step 6
            delayWithGivenTime(3000);
            softassert.assertEquals(dispatch.get_Add_Payrate_Invoice_Number_On_Add_Payrate_Popup(), invoice1, "Test Step 6 - Invoice number is not displaying in the Add Payrate pop-up");

            // Test Step 7
            delayWithGivenTime(2000);
            dispatch.enter_Non_Payable_Reason(NonpayableText);
            delayWithGivenTime(2000);
            ...
            dispatch.Click_AddPayrate_Button();
            delayWithGivenTime(1000);
            softassert.assertTrue(dispatch.verify_add_payrate_popup_IsDisplayed(), "Test Step 9 - Add Payrate pop-up is not displaying");

            delayWithGivenTime(2000);
            // softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_the_AddPayrate_popup(invoice1), "Test Step 6 - Invoice number is not displaying in the Add Payrate pop-up");
            softassert.assertEquals(dispatch.get_Add_Payrate_Invoice_Number_On_Add_Payrate_Popup(), invoice1, "Test Step 6 - Invoice number is not displaying in the Add Payrate pop-up");

            //  dispatch.Enter_value_in_Non_Payable_Reason_textbox(NonpayableText, invoice1);
            delayWithGivenTime(2000);
            dispatch.enter_Non_Payable_Reason(NonpayableText);
            ...
            delayWithGivenTime(2000);
            dispatch.Switch_TO_Add_Payrate_Iframe();
            delayWithGivenTime(1000);
            softassert.assertTrue(dispatch.verify_add_payrate_success_message_IsDisplayed(), "Test Step 10 - Success message is not displaying");
            delayWithGivenTime(1000);
            getDriver().switchTo().defaultContent();
            ...
            delayWithGivenTime(1000);
            dispatch.Click_close_icon_add_payrate_pop_up();
            softassert.assertFalse(dispatch.verify_add_payrate_popup_IsDisplayed(), "Test Step 11 - Add Payrate pop-up is displaying");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoice1), "Test Step - 10 - Respective Invoice number : " + invoice1 + " is not displayed on all orders page");
            softassert.assertEquals(dashboardorder.get_status_on_orderpage(), "Dispatched\nDriver: Liam Jack Benjamin", "Test Step - 12 - Order status displayed on dashboard order page is not matched");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(confirmationPage.get_entered_RecipientInvoice_ConfirmationPage(), invoice1, "Test Step - 12 - Recipient Invoice is not matched");
            delayWithGivenTime(2000);
            ...
            softassert.assertTrue(payrollreportpage.verify_payroll_report_page_ISDisplayed(), "Test Step 13 - Payroll Report page is not displaying");

            //Test Step 14
            payrollreportpage.Enter_Delivery_From_Date(CurrentDate());
            payrollreportpage.Enter_Delivery_To_Date(CurrentDate());
            ...
            //Test Step 16
            delayWithGivenTime(2000);
            System.out.println(payrollreportpage.is_NonPayable_Reason_Displayed_On_Payroll_Report_Table_Grid(invoice1));
            softassert.assertEquals(payrollreportpage.is_NonPayable_Reason_Displayed_On_Payroll_Report_Table_Grid(invoice1), NonpayableText, "Test Step 16 - Non Payable Reason is not displaying as expected");
  ...
  /*  @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T770_Quick_Dispatch_Trip_Section_Add_Payrate_Non_Payable_Reason_Functionality(
        ...
        try {
            ...
            getDriver().switchTo().defaultContent();
            //Test Step 8
            dispatch.Click_Close_button_add_payrate_popup();
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.get_status_on_orderpage(), "Dispatched", "Test Step - 12 - Order status displayed on dashboard order page is not matched");
            confirmationPage = new ConfirmationPage();
            dashboard.MouseAndClick_Confirmation_sub_menu();
            ...
            payrollreportpage.Enter_Delivery_To_Date(CurrentDate());
            payrollreportpage.Click_Search_button();
            softassert.assertTrue(payrollreportpage.verify_whether_the_delivery_review_row_IsDisplayed(), "Test Step 14 - Delivery Review rows is not displaying");
            delayWithGivenTime(2000);
            //Test Step 15
            softassert.assertTrue(payrollreportpage.verify_Invoice_is_displaying(invoice1), "Test Step 15 - Invoice is not displaying");

            //Test Step 16
            softassert.assertTrue(payrollreportpage.verify_Entered_non_Payable_Reason_IsDisplaying(invoice1, NonpayableText), "Test Step 16 - Non Payable Reason is not displaying as expected");
