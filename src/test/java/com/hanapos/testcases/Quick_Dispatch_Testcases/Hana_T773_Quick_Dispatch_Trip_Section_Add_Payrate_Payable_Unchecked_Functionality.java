...
public class Hana_T773_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Unchecked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T773_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Unchecked_Functionality(
...
//            softassert.assertTrue(dispatch.verify_invoice_is_displaying_in_the_AddPayrate_popup(invoice1), "Test Step 5 - Invoice number is not displaying in the Add Payrate pop-up");
            ...
            softassert.assertFalse(dispatch.Verify_Payable_Checkbox_IsChecked(invoice1), "Test Step 6 - Payable checkbox is checked");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoice1), "Test Step - 10 - Respective Invoice number : " + invoice1 + " is not displayed on all orders page");
            softassert.assertEquals(dashboardorder.get_status_on_orderpage(), "Dispatched\nDriver: Liam Jack Benjamin", "Test Step - 11 - Order status displayed on dashboard order page is not matched");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(confirmationPage.get_entered_RecipientInvoice_ConfirmationPage(), invoice1, "Test Step - 11 - Recipient Invoice is not matched");
            ...
            softassert.assertTrue(payrollreportpage.verify_payroll_report_page_ISDisplayed(), "Test Step 12 - Payroll Report page is not displaying");
            ...
            //Test Step 15
            // softassert.assertFalse(payrollreportpage.Verify_Payable_Checkbox_IsChecked(invoice1), "Test Step 16 - Checkbox is checked");
            delayWithGivenTime(2000);
            softassert.assertFalse(payrollreportpage.is_Payable_Checkbox_Checked_On_Payroll_Report_Table_Grid(invoice1), "Test Step 15 - Non Payable Reason checkbox is not checked as expected");
  ...
  /*  @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T773_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Unchecked_Functionality(
        ...
        logger.info("**** Starting  Hana-Validate_Hana_T773_Quick_Dispatch_Trip_Section_Add_Payrate_Payable_Unchecked_Functionality  ****");
