...
public class Hana_T783_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T783_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Functionality(
        ...
        logger.info("*** Starting  Hana-Validate_Hana_T783_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Functionality  ***");
 ...
 /*   @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T783_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Functionality(
        ...
        logger.info("*** Starting  Hana_T783_Quick_Dispatch_Edit_Trip_Section_Add_Payrate_Functionality ***");
        logger.debug("capturing application debug logs....");
        try {
            // Test Step - 1
            lp = new LoginPage();
