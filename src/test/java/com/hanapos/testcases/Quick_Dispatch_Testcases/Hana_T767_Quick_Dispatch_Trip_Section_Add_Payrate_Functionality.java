...
public class Hana_T767_Quick_Dispatch_Trip_Section_Add_Payrate_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T767_Quick_Dispatch_Trip_Section_Add_Payrate_Functionality(
        ...
        try {
           ...
           // getDriver().switchTo().frame(2);
            delayWithGivenTime(2000);
            softassert.assertEquals(dispatch.get_Add_Payrate_Invoice_Number_On_Add_Payrate_Popup(invoice1), invoice1,"Test Step 6 - Invoice number is not displaying in the Add Payrate pop-up");

            // Test Step 7
           // dispatch.Enter_value_in_Drivers_Payrate_textbox("10", invoice1);
            dispatch.enter_Driver_Payrate("10");
...
//            advanceDispatchPage.Click_Add_Payrate_Button_In_Advance_Dispatch();
//            delayWithGivenTime(2000);
//            softassert.assertTrue(advanceDispatchPage.verify_add_payrate_popup_IsDisplayed(), "Test Step 9 - Add Payrate pop-up is not displaying");
//            delayWithGivenTime(1500);
//           // SwitchToFrame("ifrmAddPayrateAdvanceDispatch", "Add Payrate pop-up in Advance Dispatch");

//
//            //Test Step 10
//            softassert.assertEquals(dispatch.Get_value_in_Drivers_Payrate_textbox(), "10.00", "Test Step 10 - Updated value is not matching with the actual value");
//
//            advanceDispatchPage.Switch_to_Default();
//
//            advanceDispatchPage.Click_Close_button_add_payrate_popup();
        } catch (Exception e) {
            logger_Util = new LoggerUtil();
  ...
  /*  @Epic("Quick Dispatch Module")
    ...
    public void Validate_Hana_T767_Quick_Dispatch_Trip_Section_Add_Payrate_Functionality(
        ...
        try {
            ...
            dispatch.Click_add_payrate_update_button();
            delayWithGivenTime(2000);
            //softassert.assertTrue(dispatch.verify_add_payrate_success_message_IsDisplayed(),"Test Step 7 - Success message is not displaying");
