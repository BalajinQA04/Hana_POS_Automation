...
public class Hana_T724_Quick_Dispatch_Pending_Deliveries_Timed_Order_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T724_Quick_Dispatch_Pending_Deliveries_Timed_Order_Functionality(
            ...
            String recistate, String recicountry, String reciphone, String recilocation, String occasion, String searchandselectitemcode,
            String paymenttype) {
        ...
        try {
            ...
            softassert.assertTrue(dispatch.verify_clock_icon_is_displaying_or_not(invoiceNumber), "Test step 5 - Clock icon is not displaying");
