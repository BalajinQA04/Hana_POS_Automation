package com.hanapos.testcases.Recurring_Orders_Testcases;
...
public class Hana_T1604_Delivery_Recurring_Order_Page_Functionality_Test extends TestBaseClass {
    ...
    @Epic("Recurring Orders Module")
    @Test(enabled = true, groups = {"Regression", "Sanity"})
    public void Validate_Hana_T1604_Delivery_Recurring_Order_Page_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(1000);
            phoneorder.select_Recurring_Frequency_Dropdown("Weekly");
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.get_Selected_Recurring_Frequency(), "Weekly", "Test Step - 14 - Selected recurring frequency is not displayed");

            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.get_Selected_Next_Delivery_Date(), NextDate(7), "Test Step - 14 - Selected next delivery date is not displayed");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_Recurring_Info_On_OrderDetails_Section(), "Weekly - " + NextDate(7), "Test Step - 14 - Selected recurring frequency is not displayed on order details section");
...
//            softassert.assertEquals(recurringOrdersPage.get_recipientname_on_recurring_orders_table_grid(), recipientfullname, "Test Step - 18 - Recipient Full Name on Recurring orders table grid is not displayed");
            ...
            softassert.assertEquals(recurringOrdersPage.get_Displayed_Frequency_on_Recurring_Orders_Table_Grid(recipientfullname),
                    "Weekly\n" +
                            "Every 7 Day", "Test Step - 18 - Frequency on Recurring orders table grid is not displayed");
            delayWithGivenTime(500);
            softassert.assertEquals(recurringOrdersPage.get_Displayed_Delivery_Type_on_Recurring_Orders_Table_Grid(recipientfullname), "Delivery", "Test Step - 18 - Delivery type on Recurring orders table grid is not displayed");
            delayWithGivenTime(500);
            softassert.assertEquals(recurringOrdersPage.get_Displayed_Next_Delivery_Date_on_Recurring_Orders_Table_Grid(recipientfullname), NextDate(7), "Test Step - 18 - Next delivery date on Recurring orders table grid is not displayed");
            delayWithGivenTime(500);
