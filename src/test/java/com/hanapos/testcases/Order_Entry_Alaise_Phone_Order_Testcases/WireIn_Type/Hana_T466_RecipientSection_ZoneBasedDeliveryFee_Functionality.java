...
public class Hana_T466_RecipientSection_ZoneBasedDeliveryFee_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T466_RecipientSection_ZoneBasedDeliveryFee_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T466_RecipientSection_ZoneBasedDeliveryFee_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.getReciPhone(), "956-655-0756", "Test Step - 9 - Entered Recipient phone number is not displayed on recipient section");
            softassert.assertEquals(phoneorder.getRecipientPhone2OnPhoneOrderPage(), "878-787-7878", "Test Step - 9 - Alternate Recipient phone number is not displayed on recipient section");

            // Test Step - 10
            phoneorder.SelectReciLocation(prop.getProperty("recipient_location1"));
            softassert.assertEquals(phoneorder.getSelectedLocation_OnRecipientSection(), "Church", "Test Step - 10 - Selected Location is not displayed on phone order page recipient section");
            phoneorder.Select_Zone_OnRecipientSection(prop.getProperty("zone"));
            softassert.assertEquals(phoneorder.getSelectedZone_OnRecipientSection(), "Automation Zone", "Test Step - 11 - Selected Zone is not displayed on phone order page recipient section");
            ...
            dashboard.Click_settingsSubmenu();
            ThreadWait(2000);
            softassert.assertTrue(settingsPage.Verify_Configuration_SettingsPage(), "Test Step - 11 - Configuration Settings page is not displayed");

            settingsPage.Click_OrderEntryLeftMenu();
            settingsPage.Click_OrderEntrySettings_Menu();
            delayWithGivenTime(2000);
            settingsPage.Select_DeliveryFeeType_on_OrderEntrySettings("Distance"); //Distance
            settingsPage.Click_SaveButton_On_OrderEntrySettings();
