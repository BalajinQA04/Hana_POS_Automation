...
public class Hana_T501_ProductSection_CreateRecipe_SaveAs_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T501_ProductSection_CreateRecipe_SaveAs_Functionality_Test(String salesperson, String FirstName, String LastName, String Shopcode, String ShopName, String WireIn_Method, String Order_Number, String PhoneNumber,
                                                                                         String Email, String custaddress1, String Comments, String custzip, String custphone, String recifname, String recilname, String reciaddress1, String reciaddress2, String recizip, String recicity, String recicountry, String reciphone, String recilocation, String occasion, String searchandselectitemcode, String paymenttype, String cashregistry) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T501_ProductSection_CreateRecipe_SaveAs_Functionality_Test ****");
        ...
        try {
            ...
            phoneorder.select_ItemGallery_Create_Recipe_Popup(prop.getProperty("SearchItemGallery"));
            delayWithGivenTime(1000);
            ...
            // Test Step - 15
            phoneorder.Enter_Recipe_OnsaveAsPopup(prop.getProperty("RecipeUpdateName"));
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.get_Entered_Recipe_OnsaveAsPopup(), prop.getProperty("RecipeUpdateName"), "Test Step - 15 - Entered Recipe name on save as recipe popup is not displayed");
