...
public class Hana_T513_ProductSection_CreateRecipe_Save_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T513_ProductSection_CreateRecipe_Save_Functionality_Test(String RecipieName, String Quantity) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T513_ProductSection_CreateRecipe_Save_Functionality_Test ****");
