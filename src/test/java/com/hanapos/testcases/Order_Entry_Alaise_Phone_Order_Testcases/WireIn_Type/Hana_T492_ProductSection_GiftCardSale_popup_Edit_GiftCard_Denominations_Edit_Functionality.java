...
public class Hana_T492_ProductSection_GiftCardSale_popup_Edit_GiftCard_Denominations_Edit_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T492_ProductSection_GiftCardSale_popup_Edit_GiftCard_Denominations_Edit_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T492_ProductSection_GiftCardSale_popup_Edit_GiftCard_Denominations_Edit_Functionality_Test ****");
