...
public class Hana_T467_RecipientSection_Confidential_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T467_RecipientSection_Confidential_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T467_RecipientSection_Confidential_Functionality_Test ****");
...
*/
            ...
            softassert.assertEquals(phoneorder.getSelected_DeliveryOnTimeOptions_OnDropdown_RecipientSection(), "Exactly At", "Test Step - 10 - Selected Delivery On Time is not displayed on phone order page recipient section");
            phoneorder.Enter_DeliveryTime_OnRecipientSection(18, 30);
            softassert.assertEquals(phoneorder.get_deliveryTime_on_recipientSection(), "06:30 PM", "Test Step - 10 - Selected Delivery Time is not displayed on phone order page recipient section");
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(dashboardorder.Validate_WireInOrder_FSN_InvoiceNumber("FSN Order", "Wire In", "FSN"), "Test Step - 15 - Phone order invoice in house payment is not displayed");

            // Test Step - 16
            dashboardorder.Click_WireInOrder_FSN_InvoiceNumber("FSN Order", "Wire In", "FSN");

            // Test Step - 17
            softassert.assertTrue(dashboardorder.Verify_wirein_ConfidentialReqMessage_Appears(), "Test Step - 17 - Customer requested confidentiality message is not displayed on delivery popup");
