...
public class Hana_T471_RecipientSection_SendRemainderChecked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T471_RecipientSection_SendRemainder_Checked_Functionality_Test(String salesperson, String FirstName, String LastName, String Shopcode, String ShopName, String WireIn_Method, String Order_Number, String PhoneNumber,
        ...
        logger.info("**** Starting  Validate_Hana_T471_RecipientSection_SendRemainder_Checked_Functionality_Test ****");
...
*/
            ...
            // Test Step - 9
            softassert.assertTrue(phoneorder.Verify_SendRemainder_OnOrderDetailsIsAppears(), "Test Step - 9 - Send remainder checkbox is displayed on Order details section");
   ...
   /*         phoneorder.ClickDefaultValuesIcon();
            ...
            delayWithGivenTime(3000);
            remainders.Enter_CustomerName_RemaindersPage(prop.getProperty("cust_firstName"));
