...
public class Hana_T510_ProductSection_CreateRecipe_LabourCost_Clear_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T510_ProductSection_CreateRecipe_LabourCost_Clear_Functionality_Test(String RecipieName, String ItemGallery, String ItemName) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T510_ProductSection_CreateRecipe_LabourCost_Clear_Functionality_Test ****");
