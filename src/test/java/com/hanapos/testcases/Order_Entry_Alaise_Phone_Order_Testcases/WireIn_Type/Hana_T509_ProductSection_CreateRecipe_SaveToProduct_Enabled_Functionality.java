...
public class Hana_T509_ProductSection_CreateRecipe_SaveToProduct_Enabled_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T509_ProductSection_CreateRecipe_SaveToProduct_Enabled_Functionality_Test(String RecipieName, String ItemGallery, String ItemName) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T509_ProductSection_CreateRecipe_SaveToProduct_Enabled_Functionality_Test ****");
        ...
        try {
            ...
            // Test Step - 22
            softassert.assertTrue(phoneorder.Verify_SaveToProduct_ToogleButton_On_CreateRecipePopup(), "Test Step - 22 - Save to product toggle button is not turned on create recipe popup");
