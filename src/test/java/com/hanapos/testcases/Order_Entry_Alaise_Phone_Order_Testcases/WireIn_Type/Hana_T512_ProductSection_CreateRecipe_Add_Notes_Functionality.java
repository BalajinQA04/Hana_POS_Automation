...
public class Hana_T512_ProductSection_CreateRecipe_Add_Notes_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T512_ProductSection_CreateRecipe_Add_Notes_Functionality_Test(String RecipieName, String PrivateNotes, String PublicNotes) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T512_ProductSection_CreateRecipe_Add_Notes_Functionality_Test ****");
