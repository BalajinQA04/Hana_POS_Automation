...
public class Hana_T247_OrderEntryPage_Pickup_Payment_Section_CreditCard_Use_ExistingCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T247_OrderEntryPage_Pickup_Payment_Section_CreditCard_Use_ExistingCard_Functionality_Test(
        ...
        try {
            ...
            // Test Step - 18
            phoneorder.ClickAndSelect_CreditCardNumber_TextBoxField();
...
*/
            ...
            // Test Step - 26
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_CC"), "Test Step - 26 - Payment type "+prop.getProperty("MOP_As_CC")+" is not displayed on order confirmation page");
