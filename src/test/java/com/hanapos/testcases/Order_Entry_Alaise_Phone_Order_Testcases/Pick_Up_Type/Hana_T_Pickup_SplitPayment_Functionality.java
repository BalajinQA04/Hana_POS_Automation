...
public class Hana_T_Pickup_SplitPayment_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T_Pickup_SplitPayment_Functionality_Test
        ...
        try {
            ...
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "Confirm Pickup\n" +
                    "\n" +
                    "Pending", "Test Step - 36 - Order status as New is not displayed as delivered for order");
