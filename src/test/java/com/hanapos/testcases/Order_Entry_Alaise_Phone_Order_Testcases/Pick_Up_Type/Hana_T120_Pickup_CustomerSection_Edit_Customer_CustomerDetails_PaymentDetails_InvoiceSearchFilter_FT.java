...
public class Hana_T120_Pickup_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_InvoiceSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T120_Pickup_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_InvoiceSearchFilter_FunctionalityTest(String search_invoice_3digits, String search_invalid_invoiceno) {
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("payment_type_invoice"), "Test Step - 10 - Selected invoice house account payment type is not displayed");
            ...
            //===============Above the test steps Pre - requistes completed ======================================
            ...
            softassert.assertTrue(phoneorder.Verify_TableGridOnPaymentDetailsTab_IsAppear(), "Test Step - 9 - payment details tab table grid is not displayed on customer details popup");

            // Test Step - 9
            invoice_number = phoneorder.get_InvoiceNumber_UnpaidInvoiceTable_OnUnpaidInvoiceTab();
            delayWithGivenTime(1000);
            phoneorder.EnterInvoiceNo_Paymentdetailstab(invoice_number);
            softassert.assertEquals(phoneorder.get_InvoiceNo_Paymentdetailstab(), invoice_number, "Test Step - 9 - Entered Invoice number in Invoice search textbox is not displayed");

            // Test Step - 10
            RobotPressEnter();
            softassert.assertTrue(phoneorder.Verify_InvoiceNo_Paymentdetailstab(invoice_number), "Test Step - 10 - Filtered Invoice is not displayed on the payment details tab at customer details popup");

            // Test Step - 11
            ThreadWait(1000);
            phoneorder.EnterInvoiceNo_Paymentdetailstab(search_invoice_3digits);
            //softassert.assertEquals(phoneorder.get_InvoiceNo_Paymentdetailstab(), search_invoice_3digits, "Test Step - 11 -  Entered Invoice number in Invoice search textbox is not displayed");
            ...
            softassert.assertEquals(phoneorder.get_InvoiceNo_Paymentdetailstab(), search_invalid_invoiceno, "Test Step - 13 -  Entered Invoice number in Invoice search textbox is not displayed");
            ...
            softassert.assertEquals(phoneorder.get_InvoiceNo_Paymentdetailstab(), "", "Test Step - 15 -  Invoice Number is not cleared after clicks on clear button on the payment details tab at customer details popup");
