...
public class Hana_T130_Pickup_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T130_Pickup_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_Functionality_Test() {
        ...
        try {
            ...
            // Test Step - 9
            ThreadWait(1000);
            phoneorder.Enter_TotalAmount_OrderDetailsTab_CustomerDetailsPopup("269.10");
            ThreadWait(1000);
            softassert.assertEquals(phoneorder.get_TotalAmount_Orderdetailstab(), "269.10", "Test Step - 9 - Total amount search box entered data is not displayed in order details tab at customer details popup");

            // Test Step - 10
            RobotPressEnter();
            ThreadWait(1000);
            softassert.assertTrue(phoneorder.Verify_TotalAmount_Orderdetailstab("269"), "Test Step - 10 - Filtered total amount is not displayed on the order details tab at customer details popup");

            // Test Step - 11
            ThreadWait(3000);
            phoneorder.Enter_TotalAmount_OrderDetailsTab_CustomerDetailsPopup("269");
            softassert.assertEquals(phoneorder.get_TotalAmount_Orderdetailstab(), "269", "Test Step - 11 - Total amount search box entered data is not displayed in order details tab at customer details popup");

            // Test Step - 12
            ThreadWait(1000);
            RobotPressEnter();
            ThreadWait(1000);
            softassert.assertTrue(phoneorder.Verify_TotalAmount_Orderdetailstab("269"), "Test Step - 12 - Filtered total amount with 3 digits is not displayed on the order details tab at customer details popup");

            // Test Step - 13
            ThreadWait(3000);
            phoneorder.Enter_TotalAmount_OrderDetailsTab_CustomerDetailsPopup("123456");
            ThreadWait(1000);
            softassert.assertEquals(phoneorder.get_TotalAmount_Orderdetailstab(), "123456", "Test Step - 13 - Total amount search box entered data is not displayed in order details tab at customer details popup");
