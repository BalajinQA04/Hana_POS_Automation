...
public class Hana_T203_OrderEntryPage_Pickup_ProductSection_CreateRecipe_Component_Delete_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T203_OrderEntryPage_Pickup_ProductSection_CreateRecipe_Component_Delete_Functionality_Test(String RecipieName, String ItemGallery, String ItemName) {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_recipename_OnRecipenameTextbox(), RecipieName, "Test Step - 14 - Entered Recipe name " + RecipieName + " is not displayed on create recipe popup");
            ...
            // Test Step - 18
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.is_DeleteIcon_Displayed(), "Test Step - 18 - Delete icon is not displayed on added item table in create recipe popup");

            // Test Step - 19
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.Verify_Tooltip_OnLastRowDeleteIcon_IsDisplayed(), "Delete", "Test Step - 19 - Tooltip on delete icon is not displayed");

            // Test Step - 20
            phoneorder.click_Last_DeleteIcon_OnCreateRecipePopup();
            delayWithGivenTime(2000);
           // softassert.assertTrue(phoneorder.Verify_Row3_ProductIsDelete(prop.getProperty("Component_itemgallery")), "Test Step - 20 - Recipe item row 3 is not deleted on added item gallery table");
