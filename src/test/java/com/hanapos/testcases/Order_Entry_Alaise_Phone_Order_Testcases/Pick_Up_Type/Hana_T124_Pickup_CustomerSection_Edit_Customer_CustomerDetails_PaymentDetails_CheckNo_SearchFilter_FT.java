...
public class Hana_T124_Pickup_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_CheckNo_SearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T124_Pickup_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_CheckNo_SearchFilter_Functionality_Test(String valid_checkno, String three_digit_checkno, String invalid_checkno) {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_CheckNoSearchBox_Paymentdetailstab(), valid_checkno, "Test Step - 9 - In Check number searchbox entered data is not displayed on the payment details tab at customer details popup");
            ...
            softassert.assertEquals(phoneorder.get_CheckNoSearchBox_Paymentdetailstab(), three_digit_checkno, "Test Step - 11 - In Check number searchbox entered data is not displayed on the payment details tab at customer details popup");

            // Test Step - 12
            softassert.assertTrue(phoneorder.Verify_CheckNo_Paymentdetailstab(three_digit_checkno), "Test Step - 12 - Entered Check number is not displayed on the payment details tab at customer details popup");

            // Test Step - 13
            phoneorder.Enter_CheckNoSearchBox_OnPaymentDetailsTab(invalid_checkno);
            softassert.assertEquals(phoneorder.get_CheckNoSearchBox_Paymentdetailstab(), invalid_checkno, "Test Step - 13 - In Check number searchbox entered data is not displayed on the payment details tab at customer details popup");
