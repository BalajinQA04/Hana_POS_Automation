...
public class Hana_T110_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Tax_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T110_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Tax_Search_Filter_Test() {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_EnteredTaxSearchtext_UnpaidInvoiceTab(), taxamount, "Test Step - 10 - Entered tax on search text box is not getting cleared ");
            ...
            // Test Step - 12
            phoneorder.Enter_Tax_OnInvoiceSearchBox_UnpaidInvoiceTab(taxamount);
            softassert.assertEquals(phoneorder.get_EnteredTaxSearchtext_UnpaidInvoiceTab(), taxamount, "Test Step - 12 - Entered tax on search text box is not getting cleared ");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_EnteredTaxSearchtext_UnpaidInvoiceTab(), "123456", "Test Step - 14 - Entered tax on search text box is not getting cleared ");
