...
public class Hana_T156_OrderEntryPage_Pickup_RecipientSection_ZoneBasedDeliveryFee_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T156_OrderEntryPage_Pickup_RecipientSection_ZoneBasedDeliveryFee_Functionality_Test() {
        ...
        try {
            ...
            softassert.assertTrue(settingsPage.Verify_Configuration_SettingsPage(), "Test Step - 2 - Configuration Settings page is not displayed");
            ...
            softassert.assertEquals(settingsPage.get_SelectedDeliveryFeeType_on_OrderEntrySettings(), "Zone", "Test Step - 2 - Delivery fee type is not selected as Zone");
            ...
            softassert.assertEquals(phoneorder.getSelectedZone_OnRecipientSection(), prop.getProperty("zone"), "Test Step - 10 - Selected recipient zone is not displayed on recipient zone field");
