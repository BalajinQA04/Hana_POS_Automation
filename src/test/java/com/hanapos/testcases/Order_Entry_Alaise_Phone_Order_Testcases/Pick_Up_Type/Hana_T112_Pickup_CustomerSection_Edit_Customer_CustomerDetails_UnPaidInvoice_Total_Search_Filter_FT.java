...
public class Hana_T112_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Total_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T112_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Total_Search_Filter_Test() {
        ...
        try {
            ...
            String invoiceNumber = orderconfirmationpage.get_invoiceNumber_on_OrderConfirmation_Page();
            ...
            // Test Step - 10
            phoneorder.Enter_Total_OnInvoiceSearchBox_UnpaidInvoiceTab(total_amount);
            softassert.assertEquals(phoneorder.get_EnteredTotalSearchtext_UnpaidInvoiceTab(), total_amount, "Test Step - 10 - Entered total on search text box is not getting cleared ");

            // Test Step - 11
            RobotPressEnter();
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.Verify_TotalValue_OnDisplayedInvoices(total_amount), "Test Step - 11 - Total value is not displayed in unpaid invoice grid table");
            delayWithGivenTime(1000);

            // Test Step - 12
            phoneorder.Enter_Total_OnInvoiceSearchBox_UnpaidInvoiceTab("29");
            softassert.assertEquals(phoneorder.get_EnteredTotalSearchtext_UnpaidInvoiceTab(), "29", "Test Step - 12 - Entered total on search text box is not getting cleared ");
            ...
            softassert.assertEquals(phoneorder.get_EnteredTotalSearchtext_UnpaidInvoiceTab(), "123456", "Test Step - 14 - Entered total on search text box is not getting cleared ");
