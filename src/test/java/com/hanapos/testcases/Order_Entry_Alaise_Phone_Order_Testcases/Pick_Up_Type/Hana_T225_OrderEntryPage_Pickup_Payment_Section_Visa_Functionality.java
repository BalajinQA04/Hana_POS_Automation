    ...
    public void Validate_Hana_T225_OrderEntryPage_Pickup_Payment_Section_Visa_Functionality_Test(
        ...
        try {
           ...
           // softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("recipient_city1"), "Test Step - 7 - Entered city is not displayed on phone order page recipient section");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("MOP_As_Visa"), "Test Step - 10 - Selected payment type " + prop.getProperty("MOP_As_Visa") + " is not displayed");
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_Visa"), "Test Step - 13 - Payment type" + prop.getProperty("MOP_As_Visa") + " is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_Visa")), "Test Step - 15 - In orders summary page - " + prop.getProperty("MOP_As_Visa") + " payment type invoice number is not displayed for placed order");

            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_Visa")), prop.getProperty("MOP_As_Visa"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_Visa") + " is not displayed");
