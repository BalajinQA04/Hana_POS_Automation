    ...
    public void Validate_Hana_T216__OrderEntryPage_Pickup_Payment_Section_AnyPayment_Functionality_Test(
        ...
        try {
          ...
          //  softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("recipient_city1"), "Test Step - 7 - Entered city is not displayed on phone order page recipient section");
            ...
            delayWithGivenTime(1000);
            phoneorder.click_GrandTotalAmount();
            softassert.assertEquals(phoneorder.get_Entered_CashPaymentType_Amount(), phoneorder.getGrandTotalAmount(), "Test Step - 10 - Entered cash payment amount is not allowed on the payment section cash type pay amount field");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_Selected_CashRegistry(), prop.getProperty("payment_cash_registry"), "Test Step - 10 - Selected cash payment registered is not displayed");
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("payment_type"), "Test Step - 11 - Payment type is not displayed on order confirmation page");
