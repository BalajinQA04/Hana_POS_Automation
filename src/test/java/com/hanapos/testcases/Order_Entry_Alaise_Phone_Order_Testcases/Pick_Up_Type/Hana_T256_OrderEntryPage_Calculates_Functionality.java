...
public class Hana_T256_OrderEntryPage_Calculates_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T256_OrderEntryPage_Calculates_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T256_OrderEntryPage_Calculates_Functionality_Test  ****");
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.getReciAddress1(), prop.getProperty("cust_address1"), "Test Step - 8 - Entered address 1 value is not displayed recipient section on phone order page");

            // Test Step - 9
            phoneorder.Click_Calculate_Miles_Icon();
            softassert.assertEquals(phoneorder.Verify_ToastMsgText(), "Address Not Found By Google\n" +
                    "\n" +
                    "0.6 KM", "Test Step - 9: Toaster message with calculated miles is not displayed");


            // Test Step - 10
            phoneorder.EnterReciAddress1("98900");
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.getReciAddress1(), "98900", "Test Step - 10 - Entered address 1 value is not displayed recipient section on phone order page");
            ...
            softassert.assertEquals(phoneorder.Verify_ToastMsgText(), "Address Not Found By Google\n" +
                    "\n" +
                    "0.6 KM", "Test Step - 11: Toaster message with calculated miles is not displayed");
