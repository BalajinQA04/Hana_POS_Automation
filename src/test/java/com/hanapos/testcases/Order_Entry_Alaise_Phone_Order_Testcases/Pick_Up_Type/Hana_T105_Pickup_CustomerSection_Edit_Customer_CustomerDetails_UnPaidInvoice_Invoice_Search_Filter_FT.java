...
public class Hana_T105_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Invoice_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T105_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Invoice_Search_Filter_Test(String search_invoice_3digits, String search_invalid_invoiceno) {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_EnteredInvoiceSearchext_UnpaidInvoiceTab(), invoiceNumber, "Test Step - 10 - Entered Invoice number is not displayed on invoice search textbox at unpaid invoice tab in customer details popup");
            ...
            softassert.assertEquals(phoneorder.get_EnteredInvoiceSearchext_UnpaidInvoiceTab(), search_invoice_3digits, "Test Step - 13 - Entered Invoice number is not displayed on invoice search textbox at unpaid invoice tab in customer details popup");

            // Test Step - 13
            phoneorder.PressEnterKey();
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.Verify_AutoSuggestion_InvoiceNumber_UnpaidInvoiceTable_OnUnpaidInvoiceTab(search_invoice_3digits));

            // Test Step - 14
            delayWithGivenTime(1000);
            phoneorder.Enter_InvoiceSearchext_UnpaidInvoiceTab(search_invalid_invoiceno);
            softassert.assertEquals(phoneorder.get_EnteredInvoiceSearchext_UnpaidInvoiceTab(), search_invalid_invoiceno, "Test Step - 10 - Entered Invalid Invoice number is not displayed on invoice search textbox at unpaid invoice tab in customer details popup");
