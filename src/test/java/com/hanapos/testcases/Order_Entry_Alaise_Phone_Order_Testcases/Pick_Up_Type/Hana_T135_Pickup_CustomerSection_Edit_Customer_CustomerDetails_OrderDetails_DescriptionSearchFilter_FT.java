...
public class Hana_T135_Pickup_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_DescriptionSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T135_Pickup_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_DescriptionSearchFilter_Functionality_Test() {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_Description_Orderdetailstab(), prop.getProperty("product_description1"), "Test Step - 9 - Address search box entered data is not displayed in order details tab at customer details popup");
            ...
            softassert.assertEquals(phoneorder.get_Description_Orderdetailstab(), "Bal", "Test Step - 11 - Address search box entered data is not displayed in order details tab at customer details popup");
            ...
            ThreadWait(1000);
            softassert.assertEquals(phoneorder.get_Description_Orderdetailstab(), "xxx description", "Test Step - 13 - Address search box entered data is not cleared in order details tab at customer details popup");
