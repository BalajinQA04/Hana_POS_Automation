...
public class Hana_T108_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_ProductTotal_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T108_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_ProductTotal_Search_Filter_Test(String valid_prodtotal_amount, String twodigit_prodtotal_amount, String invalid_prodtotal_amount) {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_ProductTotal_UnpaidInvoiceTable_OnUnpaidInvoiceTab(), valid_prodtotal_amount, "Test Step - 10 - Product total value is not displayed in unpaid invoice grid table");
            ...
            softassert.assertEquals(phoneorder.get_ProductTotal_UnpaidInvoiceTable_OnUnpaidInvoiceTab(), twodigit_prodtotal_amount, "Test Step - 12 - Product total value is not displayed in unpaid invoice grid table");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_ProductTotal_UnpaidInvoiceTable_OnUnpaidInvoiceTab(), invalid_prodtotal_amount, "Test Step - 14 - Product total value is not displayed in unpaid invoice grid table");
            RobotPressEnter();
            delayWithGivenTime(1000);
