...
public class Hana_T098_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UpdateProfile_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T098_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UpdateProfile_Functionality_Test(String salesperson, String customername, String companyname, String firstname, String lastname, String emailid, String address1, String zipcode, String country, String city, String phonenumber,
        ...
        try {
            ...
            phoneorder.Select_SalesPersonOn_PhoneOrderEntryPage(salesperson);
            delayWithGivenTime(2000);
            phoneorder.SearchAndSelectCustomerOnCust_Section("Harley Reichert");  // Harley Reichert
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getFirstnameOnPhoneOrderPage(), "Harley", "Test Step - 6 - First name is not displayed on phone order page");
            softassert.assertEquals(phoneorder.getLastnameOnPhoneOrderPage(), "Reichert", "Test Step - 6 - Last name is not displayed on phone order page");
            softassert.assertEquals(phoneorder.getCompanyNameOnPhoneOrderPage(), "Harley Reichert LLC", "Test Step - 6 - Company name is not displayed on phone order page");
            ...
            phoneorder.Click_CustEditIcon();
            delayWithGivenTime(2000);
            phoneorder.Enter_CompanyName_OnCustDetailsPopup("Harley Reichert LLC");
            phoneorder.Enter_FirstName_OnCustDetailsPopup("Harley");
            phoneorder.Enter_LastName_OnCustDetailsPopup("Reichert");
            ...
            phoneorder.SearchAndSelectCustomerOnCust_Section("Harley Reichert");  // Harley Reichert
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getFirstnameOnPhoneOrderPage(), "Harley", "Test Step - 6 - First name is not displayed properly on phone order page - after update customer details");
            softassert.assertEquals(phoneorder.getLastnameOnPhoneOrderPage(), "Reichert", "Test Step - 6 - Last name is not displayed on phone order page - after update customer details");
            softassert.assertEquals(phoneorder.getCompanyNameOnPhoneOrderPage(), "Harley Reichert LLC", "Test Step - 6 - Company name is not displayed on phone order page - after update customer details");
            softassert.assertEquals(phoneorder.getEmailIdOnPhoneOrderPage(), "hanaposqateam@gmail.com", "Test Step - 6 - email id is not displayed on phone order page - after update customer details");
