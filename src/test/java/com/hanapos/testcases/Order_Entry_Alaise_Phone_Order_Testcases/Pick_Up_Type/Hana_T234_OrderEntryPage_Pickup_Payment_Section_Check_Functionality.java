...
//            softassert.assertEquals(phoneorder.get_Entered_CheckRountingNumber_On_TextBox(), prop.getProperty("Check_Rounting_Number"), "Test Step - 17 - Entered Rounting number is not displayed on Bank name textbox field at check payment type phone order page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_Check")), "Test Step - 22 - In orders summary page - " + prop.getProperty("MOP_As_Check") + " payment type invoice number is not displayed for placed order");

            //Test Step - 23
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_Check")), prop.getProperty("MOP_As_Check"), "Test Step - 23 - Mode of payment as " + prop.getProperty("MOP_As_Check") + " is not displayed");
