...
public class Hana_T106_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_PaidAmount_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T106_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_PaidAmount_Search_Filter_Test(String valid_paid_amount, String twodigit_paid_amount, String invalid_paid_amount) {
        ...
        try {
            ...
            phoneorder.EnterReciAddress2(prop.getProperty("Reci_Address1_1"));
            ...
            if (phoneorder.get_ExtPrice1OnProdDetails() == prop.getProperty("product_ext_price")) {
            ...
            } else if (phoneorder.get_ExtPrice1OnProdDetails() == "309.00") {
                softassert.assertEquals(phoneorder.get_ExtPrice1OnProdDetails(), "309.00", "Test Step - 9 - Item ext price is not displayed on phone order page product details section");
            }
            ...
            RobotPressEnter();
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_PaidAmount_UnpaidInvoiceTable_OnUnpaidInvoiceTab(), prop.getProperty("unpaid_Invoice_payment_amount"),
