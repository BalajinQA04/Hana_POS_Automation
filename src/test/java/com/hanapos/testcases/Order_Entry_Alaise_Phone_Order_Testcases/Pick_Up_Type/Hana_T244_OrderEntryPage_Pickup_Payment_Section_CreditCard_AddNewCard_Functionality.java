...
public class Hana_T244_OrderEntryPage_Pickup_Payment_Section_CreditCard_AddNewCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T244_OrderEntryPage_Pickup_Payment_Section_CreditCard_AddNewCard_Functionality_Test(
        ...
        try {
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_CC"), "Test Step - 25 - Payment type is not displayed on order confirmation page");
            ...
            softassert.assertTrue(customerpage.VerifyCustomerDetailsPopup(), "Test Step - 31 - Customer details pop up is not displayed");
            ...
            softassert.assertEquals(customerpage.Verify_CreditCard_ExpiredDate_OnCustomerDetailsPopup(), "1030", "Test Step - 33 - Credit card tab credit card expired date is not displayed");
