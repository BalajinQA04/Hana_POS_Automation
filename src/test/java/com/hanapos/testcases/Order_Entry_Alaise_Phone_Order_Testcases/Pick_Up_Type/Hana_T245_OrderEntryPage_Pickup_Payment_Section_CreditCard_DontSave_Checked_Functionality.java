...
public class Hana_T245_OrderEntryPage_Pickup_Payment_Section_CreditCard_DontSave_Checked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T245_OrderEntryPage_Pickup_Payment_Section_CreditCard_DontSave_Checked_Functionality_Test(
        ...
        try {
            ...
            lp.EnterPassword(prop.getProperty("username"));
...
//            softassert.assertEquals(phoneorder.getDeliveryDateOnReciSection(), CurrentDate(), "Test Step - 7 - Delivery date is not displayed on phone order page recipient section");
            ...
            // Test Step - 13
            softassert.assertEquals(phoneorder.get_autopopulated_creditcard_paymenttype_FirstName(), prop.getProperty("cust_firstName"), "Test Step - 13 - First name textbox field Payment type as credit card section  is not autopopulated");

            // Test Step - 14
            softassert.assertEquals(phoneorder.get_autopopulated_creditcard_paymenttype_LastName(), prop.getProperty("cust_lastName"), "Test Step - 14 - Last name textbox field Payment type as credit card section  is not autopopulated");

            // Test Step - 14
            softassert.assertEquals(phoneorder.get_autopopulated_creditcard_paymenttype_Zipcode(), prop.getProperty("cust_zipcode"), "Test Step - 15 - Zipcode textbox field Payment type as credit card section  is not autopopulated");

            // Test Step - 15
            softassert.assertEquals(phoneorder.get_autopopulated_creditcard_paymenttype_City(), prop.getProperty("cust_city"), "Test Step - 16 - City textbox field Payment type as credit card section  is not autopopulated");

            // Test Step - 16
            softassert.assertEquals(phoneorder.get_autopopulated_creditcard_paymenttype_State(), prop.getProperty("cust_state"), "Test Step - 17 - State textbox field Payment type as credit card section  is not autopopulated");

            // Test Step - 17
            softassert.assertEquals(phoneorder.get_Selected_creditcard_paymenttype_Country(), prop.getProperty("recipient_country1"), "Test Step - 18 - Country textbox field Payment type as credit card section  is not autopopulated");

            // Test Step - 18
            phoneorder.Enter_CreditCardNumber_CCPaymentSection_On_PhoneOrderPage(prop.getProperty("creditcardnum"));
            softassert.assertEquals(phoneorder.get_entered_CreditcardNumber_CCPaymentSection_On_PhoneOrderPage(), prop.getProperty("creditcardnum"), "Test Step - 19 - Entered credit card number is not displayed on credit card payment section");

            // Test Step - 19
            phoneorder.Enter_ExpiredDate_CCPaymentSection_On_PhoneOrderPage(prop.getProperty("ccexpiredate"));
            softassert.assertEquals(phoneorder.get_entered_ExpiredDate_CCPaymentSection_On_PhoneOrderPage(), prop.getProperty("ccexpiredate"), "Test Step - 20 - Entered credit card expire date is not displayed on credit card payment section");

            // Test Step - 20
            phoneorder.Enter_CCV_CCPaymentSection_On_PhoneOrderPage(prop.getProperty("cccvv"));
            softassert.assertEquals(phoneorder.get_entered_CVV_CCPaymentSection_On_PhoneOrderPage(), prop.getProperty("cccvv"), "Test Step - 21 - Entered credit card CVV code is not displayed on credit card payment section");
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_CC"), "Test Step - 26 - Payment type is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_CC")), "Test Step - 29 - In orders summary page - " + prop.getProperty("MOP_As_CC") + " payment type invoice number is not displayed for placed order");

            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_CC")), prop.getProperty("MOP_As_CC"), "Test Step - 29 - Mode of payment as " + prop.getProperty("MOP_As_CC") + " is not displayed");
            ...
            // Test Step - 31
            delayWithGivenTime(1000);
            customerpage.Search_and_SelectCustomerName(prop.getProperty("cust_firstName"), "Abish David");
            customerpage.SearchAndSelectCustomerAddress(prop.getProperty("cust_address1"));
            customerpage.SearchAndSelectCustomerPhone(prop.getProperty("cust_phoneNumber"));
            delayWithGivenTime(2000);
            ...
            softassert.assertEquals(customerpage.Verify_CreditCard_ExpiredDate_OnCustomerDetailsPopup(), prop.getProperty("ccexpiredate"), "Test Step - 34 - Credit card tab credit card expired date is not displayed");
