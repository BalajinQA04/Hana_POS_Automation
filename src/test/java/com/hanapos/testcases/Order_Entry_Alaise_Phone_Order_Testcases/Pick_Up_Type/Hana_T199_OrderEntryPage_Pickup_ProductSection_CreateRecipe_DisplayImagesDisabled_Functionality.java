...
public class Hana_T199_OrderEntryPage_Pickup_ProductSection_CreateRecipe_DisplayImagesDisabled_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T199_OrderEntryPage_Pickup_ProductSection_CreateRecipe_DisplayImagesDisabled_Functionality_Test
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.verify_Recipe_Item_IsDisplayed_On_TableGrid(prop.getProperty("Component_itemgallery")), prop.getProperty("Component_itemgallery"), "Test Step - 17 - Added Recipe item " + prop.getProperty("Component_itemgallery") + " is not displayed on item gallery table grid");
