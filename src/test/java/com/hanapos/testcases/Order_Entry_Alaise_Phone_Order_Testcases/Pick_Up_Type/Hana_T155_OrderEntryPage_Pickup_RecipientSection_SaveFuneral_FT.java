...
public class Hana_T155_OrderEntryPage_Pickup_RecipientSection_SaveFuneral_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T155_OrderEntryPage_Pickup_RecipientSection_SaveFuneral_Functionality_Test() {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.getReciPhone(), "956-655-0756", "Test Step - 8 - Recipient phone number is not matched with customer phonenumber 1 field on phone order page recipient section");
            softassert.assertEquals(phoneorder.getRecipientPhone2OnPhoneOrderPage(), "956-655-0756", "Test Step - 8 - Recipient alt phone number is not matched with customer phonenumber2 on phone order page recipient section");
