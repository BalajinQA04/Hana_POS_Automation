...
public class Hana_T202_OrderEntryPage_Pickup_ProductSection_CreateRecipe_LabourCostClear_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T202_OrderEntryPage_Pickup_ProductSection_CreateRecipe_LabourCostClear_Functionality_Test(String RecipieName, String ItemGallery, String ItemName) {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.getReciAddress1(), prop.getProperty("recipient_address1"), "Test Step - 8 - Entered address 1 is not displayed on phone order page recipient section");
            ...
            softassert.assertEquals(phoneorder.getReciZipcode(), prop.getProperty("recipient_zipcode1"), "Test Step - 8 - Entered zipcode is not displayed on phone order page recipient section");
            softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("recipient_city1"), "Test Step - 8 - Entered city is not displayed on phone order page recipient section");
            ...
            // Test Step - 17
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.Verify_RecipeItemRow3_OnTableIsDisplayed(), prop.getProperty("Component_itemgallery"), "Test Step - 17 - Recipe item " + prop.getProperty("Component_itemgallery") + " row 1 is not displayed on item gallery table");
