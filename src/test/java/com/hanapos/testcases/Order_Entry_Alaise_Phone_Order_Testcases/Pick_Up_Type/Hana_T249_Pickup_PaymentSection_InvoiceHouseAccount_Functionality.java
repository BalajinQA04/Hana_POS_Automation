    ...
    public void Validate_Hana_T249_Pickup_PaymentSection_InvoiceHouseAccount_Functionality(
        ...
        try {
          ...
          //  softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("recipient_city1"), "Test Step - 7 - Entered city is not displayed on phone order page recipient section");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("MOP_As_InvoiceHouseAccount"), "Test Step - 10 - Selected payment type " + prop.getProperty("MOP_As_InvoiceHouseAccount") + " is not displayed");
