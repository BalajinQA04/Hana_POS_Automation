    ...
    public void Validate_Hana_T238_OrderEntryPage_Pickup_Payment_Section_Donation_Functionality_Test(
        ...
        try {
          ...
          //  softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("recipient_city1"), "Test Step - 7 - Entered city is not displayed on phone order page recipient section");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("MOP_As_Donation"), "Test Step - 10 - Selected payment type " + prop.getProperty("MOP_As_Donation") + "is not displayed on phone order page payment section | \n");

            // Test Step - 11
            phoneorder.Enter_EINNumber_Textbox_On_PaymentSection(prop.getProperty("Donation_EIN_Number"));
            softassert.assertEquals(phoneorder.get_EINNumber_Textbox_On_PaymentSection(), prop.getProperty("Donation_EIN_Number"), "Test Step - 11 - Entered EIN number " + prop.getProperty("Donation_EIN_Number") + " is not displayed on phone order page payment section");
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_Donation"), "Test Step - 14 - Payment type " + prop.getProperty("MOP_As_Donation") + " is not displayed on order confirmation page | \n ");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_Donation")), "Test Step - 16 - In orders summary page - " + prop.getProperty("MOP_As_Donation") + " payment type invoice number is not displayed for placed order");

            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_Donation")), prop.getProperty("MOP_As_Donation"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_Donation") + " is not displayed");
