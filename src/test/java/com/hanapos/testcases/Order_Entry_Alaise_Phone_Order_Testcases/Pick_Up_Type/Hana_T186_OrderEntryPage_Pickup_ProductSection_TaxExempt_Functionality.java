...
public class Hana_T186_OrderEntryPage_Pickup_ProductSection_TaxExempt_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T186_OrderEntryPage_Pickup_ProductSection_TaxExempt_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("payment_type_invoice"), "Test Step - 18 - Selected payment type is not displayed on phone order page payment section");
