...
public class Hana_T104_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T104_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Test(String paymentmethod, String cashregistry) {
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.get_selected_paymentmethod_on_unpaid_InvoiceTab(),paymentmethod,"Test Step - 15: Selected payment method from dropdown field value is not displayed on unpaid invoice tab in invoice payment details section at customer details popup on phone order page");
            softassert.assertEquals(phoneorder.get_selected_cashregistry_on_unpaid_InvoiceTab(),cashregistry,"Test Step - 15: Selected cash registry from dropdown field value is not displayed on unpaid invoice tab in invoice payment details section at customer details popup on phone order page");
