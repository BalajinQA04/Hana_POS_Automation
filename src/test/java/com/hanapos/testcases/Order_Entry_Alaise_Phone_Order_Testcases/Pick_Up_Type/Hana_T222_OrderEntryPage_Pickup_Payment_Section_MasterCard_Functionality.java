...
public class Hana_T222_OrderEntryPage_Pickup_Payment_Section_MasterCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T222_OrderEntryPage_Pickup_Payment_Section_MasterCard_Functionality_Test(
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("MOP_As_MasterCard"), "Test Step - 10 - Selected payment type " + prop.getProperty("MOP_As_MasterCard") + " is not displayed");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_MasterCard")), "Test Step - 15 - In orders summary page - " + prop.getProperty("MOP_As_MasterCard") + " payment type invoice number is not displayed for placed order");

            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Pickup"), prop.getProperty("MOP_As_MasterCard")), prop.getProperty("MOP_As_MasterCard"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_MasterCard") + " is not displayed");
