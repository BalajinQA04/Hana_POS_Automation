...
public class Hana_T113_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_OrderDate_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T113_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_OrderDate_Search_Filter_Test() {
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.get_EnteredOrderDateSearchtext_UnpaidInvoiceTab(), CurrentDate(), "Test Step - 10 - Entered order date on search text box is not getting cleared ");
            ...
            // Test Step - 12
            phoneorder.Enter_OrderDate_OnInvoiceSearchBox_UnpaidInvoiceTab(CurrentDate());
            softassert.assertEquals(phoneorder.get_EnteredOrderDateSearchtext_UnpaidInvoiceTab(), CurrentDate(), "Test Step - 12 - Entered order date on search text box is not getting cleared ");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_EnteredOrderDateSearchtext_UnpaidInvoiceTab(), "17/17/0000", "Test Step - 14 - Entered order date on search text box is not getting cleared ");
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_EnteredOrderDateSearchtext_UnpaidInvoiceTab(), NextDate(), "Test Step - 15 - Entered order date on search text box is not getting cleared ");
