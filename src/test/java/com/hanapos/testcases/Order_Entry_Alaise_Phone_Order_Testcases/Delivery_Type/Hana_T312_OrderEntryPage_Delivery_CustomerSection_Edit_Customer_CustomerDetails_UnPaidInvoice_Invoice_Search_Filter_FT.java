...
public class Hana_T312_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Invoice_Search_Filter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T312_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Invoice_Search_Filter_Functionality_Test(String search_invoice_3digits, String search_invalid_invoiceno) {
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_EnteredInvoiceSearchext_UnpaidInvoiceTab(), invoiceNumber, "Test Step - 11 - Entered Invoice number is not displayed on invoice search textbox at unpaid invoice tab in customer details popup");
            ...
            softassert.assertEquals(phoneorder.get_EnteredInvoiceSearchext_UnpaidInvoiceTab(), search_invoice_3digits, "Test Step - 12 - Entered Invoice number is not displayed on invoice search textbox at unpaid invoice tab in customer details popup");

            // Test Step - 13
            phoneorder.PressEnterKey();
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.Verify_AutoSuggestion_InvoiceNumber_UnpaidInvoiceTable_OnUnpaidInvoiceTab("206"));

            // Test Step - 14
            delayWithGivenTime(1000);
            phoneorder.Enter_InvoiceSearchext_UnpaidInvoiceTab("123456");
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_EnteredInvoiceSearchext_UnpaidInvoiceTab(), "123456", "Test Step - 14 - Entered Invoice number is not displayed on invoice search textbox at unpaid invoice tab in customer details popup");
