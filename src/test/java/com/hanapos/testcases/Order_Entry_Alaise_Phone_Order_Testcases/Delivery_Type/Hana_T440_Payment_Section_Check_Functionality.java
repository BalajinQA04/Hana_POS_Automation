...
public class Hana_T440_Payment_Section_Check_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T440_Payment_Section_Check_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T440_Payment_Section_Check_Functionality_Test  ****");
...
*/
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getReciAddress1(), "7251 Hwy N", "Test Step - 4 - Recipient address 1 is not matched with customer address 1 field on phone order page recipient section");
            ...
            // Test Step - 10
            phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection(prop.getProperty("MOP_As_Check"));
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), prop.getProperty("MOP_As_Check"), "Test Step - 10 - Selected payment type " + prop.getProperty("MOP_As_Check") + " is not displayed");
            ...
            // Test Step - 12
            phoneorder.Enter_BankName_On_TextBox(prop.getProperty("Bank_Name"));
            softassert.assertEquals(phoneorder.get_Entered_BankName_On_TextBox(), prop.getProperty("Bank_Name"), "Test Step - 12 - Entered bank name is not displayed on Bank name textbox field at check payment type phone order page");

            // Test Step - 13
            phoneorder.Enter_NameOnCheck_On_TextBox(prop.getProperty("NameOfCheck"));
            softassert.assertEquals(phoneorder.get_Entered_NameOnCheck_On_TextBox(), prop.getProperty("NameOfCheck"), "Test Step - 13 - Entered name on check is not displayed on Bank name textbox field at check payment type phone order page");

            // Test Step - 14
            phoneorder.Enter_CheckNumber_On_TextBox(prop.getProperty("Check_Number"));
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_Entered_CheckNumber_On_TextBox(), prop.getProperty("Check_Number"), "Test Step - 14 - Entered check Number is not displayed on Bank name textbox field at check payment type phone order page");

            // Test Step - 15
            phoneorder.Select_CheckCashRegistry_Dropdown(prop.getProperty("payment_cash_registry"));
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.get_Selected_CheckCashRegistry_Dropdown(), prop.getProperty("payment_cash_registry"), "Test Step - 15 - Selected check cash registry is not displayed on Bank name textbox field at check payment type phone order page");
...
// Comment at August 2025 - 14th -- fields are missing
//            phoneorder.Enter_CheckAccountNumber_On_TextBox(prop.getProperty("Bank_Account_Number"));
//            softassert.assertEquals(phoneorder.get_Entered_CheckAccountNumber_On_TextBox(), prop.getProperty("Bank_Account_Number"), "Test Step - 16 - Entered check account number is not displayed on Bank name textbox field at check payment type phone order page");
//
//            // Test Step - 17
//            phoneorder.Enter_CheckRountingNumber_On_TextBox(prop.getProperty("Check_Rounting_Number"));
//            softassert.assertEquals(phoneorder.get_Entered_CheckRountingNumber_On_TextBox(), prop.getProperty("Check_Rounting_Number"), "Test Step - 17 - Entered Rounting number is not displayed on Bank name textbox field at check payment type phone order page");
            phoneorder.ClickPlaceOrderButton();
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_Check"), "Test Step - 20 - Payment type " + prop.getProperty("MOP_As_Check") + " is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_Check")), "Test Step - 22 - In orders summary page - " + prop.getProperty("MOP_As_Check") + " payment type invoice number is not displayed for placed order");

            //Test Step - 23
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_Check")), prop.getProperty("MOP_As_Check"), "Test Step - 23 - Mode of payment as " + prop.getProperty("MOP_As_Check") + " is not displayed");
