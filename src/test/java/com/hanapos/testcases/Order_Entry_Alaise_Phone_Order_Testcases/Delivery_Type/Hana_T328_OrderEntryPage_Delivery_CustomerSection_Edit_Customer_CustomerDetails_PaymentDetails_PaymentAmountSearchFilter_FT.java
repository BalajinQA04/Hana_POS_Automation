...
public class Hana_T328_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_PaymentAmountSearchFilter_FT extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T328";
    ...
    public void Validate_Hana_T328_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_PaymentAmountSearchFilter_Functionality_Test(
            ...
            String searchandselectitemcode, String paymenttype, String cashregistry
    ) {
        ...
        try {
            ...
            // Test Step - 12
            payamount = phoneorder.getGrandTotalAmount();
            // Remove the dollar sign, convert to double, then format
            double amountValue = Double.parseDouble(payamount.replace("$", ""));
            pay_amount = removeTrailingZeros(amountValue);
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoiceNumber), "Test Step - 14 - In orders summary page cash payment type invoice number is not displayed for placed order");
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber), "Cash", "Test Step - 14 - Mode of payment as " + paymenttype + " is not displayed");
...
//=================================== Pre requiste ====================================================
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_PayAmount_Paymentdetailstab(), "$"+pay_amount, "Test Step - 9 - Pay Amount is not displayed on the payment details tab at customer details popup");

            // Test Step - 10
            softassert.assertTrue(phoneorder.Verify_PayAmount_Paymentdetailstab("$" + pay_amount), "Test Step - 10 - Filtered Pay Amount is not displayed on the payment details tab at customer details popup");
