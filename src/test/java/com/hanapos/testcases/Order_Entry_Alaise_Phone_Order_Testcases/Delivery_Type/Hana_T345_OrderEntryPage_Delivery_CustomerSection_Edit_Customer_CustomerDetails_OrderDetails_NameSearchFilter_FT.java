...
public class Hana_T345_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_NameSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T345_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_NameSearchFilter_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Hana_T345_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_NameSearchFilter_FT  ****");
...
*/
            ...
            softassert.assertEquals(phoneorder.get_Name_Orderdetailstab(), prop.getProperty("cust_firstName"), "Test Step - 9: Entered name is not displayed");
            ...
            phoneorder.Enter_Name_OrderDetailsTab_CustomerDetailsPopup(prop.getProperty("short_reci_fname"));
            //softassert.assertEquals(phoneorder.get_Name_Orderdetailstab(), prop.getProperty("short_reci_fname"), "Test Step - 11: Entered name is not displayed");
            ...
            softassert.assertEquals(phoneorder.get_Name_Orderdetailstab(), prop.getProperty("custName") + "1", "Test Step - 13: Entered name is not displayed");
