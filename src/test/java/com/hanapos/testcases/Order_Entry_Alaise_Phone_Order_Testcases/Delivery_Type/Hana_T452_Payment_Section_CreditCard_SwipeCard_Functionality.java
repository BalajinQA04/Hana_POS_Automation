...
public class Hana_T452_Payment_Section_CreditCard_SwipeCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T452_Payment_Section_CreditCard_SwipeCard_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T452_Payment_Section_CreditCard_SwipeCard_Functionality_Test  ****");
...
*/
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_CC")), "Test Step - 28 - In orders summary page credit card payment type invoice number is not displayed for placed order");
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_CC")), prop.getProperty("MOP_As_CC"), "Test Step - 28 - Mode of payment as credit card type is not displayed");
