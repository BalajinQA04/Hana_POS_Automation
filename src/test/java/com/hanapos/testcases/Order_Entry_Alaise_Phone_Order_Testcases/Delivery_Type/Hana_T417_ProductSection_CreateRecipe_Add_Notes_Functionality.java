...
public class Hana_T417_ProductSection_CreateRecipe_Add_Notes_Functionality extends TestBaseClass {
    private LoginPage lp;
    private HanaDashBoardPage dashboard;
    private OrderEntry_Alais_PhoneOrderPage phoneorder;
    public static final String dataSheetName = "Hana_T204";
    ...
    public void Validate_Hana_T417_ProductSection_CreateRecipe_Add_Notes_Functionality_Test(String RecipieName, String PrivateNotes, String PublicNotes) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T417_ProductSection_CreateRecipe_Add_Notes_Functionality_Test ****");
...
*/
            ...
            phoneorder.Enter_PrivateNotes_CreateRecipe_Popup(PrivateNotes);
            ...
            phoneorder.Enter_PublicNotes_CreateRecipe_Popup(PublicNotes);
          ...
          //  softassert.assertTrue(phoneorder.verifySuccessToastMessageAppears(), "Test Step - 18 - Recipe saved... - Toast message is not displayed");
