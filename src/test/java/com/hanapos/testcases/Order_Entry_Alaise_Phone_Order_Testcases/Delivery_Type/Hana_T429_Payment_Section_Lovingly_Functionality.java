...
public class Hana_T429_Payment_Section_Lovingly_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T429_OrderEntryPage_Delivery_Payment_Section_Lovingly_Functionality_Test(
...
*/
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_Lovingly"), "Test Step - 13 - Payment type is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_Lovingly")), "Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");

            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_Lovingly")), prop.getProperty("MOP_As_Lovingly"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_Lovingly") + " is not displayed");
