...
public class Hana_T432_Payment_Section_Paid_Outside_Hana_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T432_Payment_Section_Paid_Outside_Hana_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T432_Payment_Section_Paid_Outside_Hana_Functionality_Test  ****");
...
*/
            ...
            reci_full_address1 = "125 Carter Ln, Robertsville, MO 63072";
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getReciAddress1(), "125 Carter Ln", "Test Step - 4 - Recipient address 1 is not matched with customer address 1 field on phone order page recipient section");
            ...
            // Test Step - 10
            phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection(prop.getProperty("MOP_As_POH"));
            delayWithGivenTime(1000);
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_POH"), "Test Step - 13 - Payment type is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_POH")), "Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");

            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_POH")), prop.getProperty("MOP_As_POH"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_POH") + " is not displayed");
