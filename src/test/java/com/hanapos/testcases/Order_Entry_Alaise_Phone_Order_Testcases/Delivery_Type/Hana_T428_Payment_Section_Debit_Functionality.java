...
public class Hana_T428_Payment_Section_Debit_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T428_Payment_Section_Debit_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T428_Payment_Section_Debit_Functionality_Test  ****");
...
*/
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getReciAddress1(), "902 State Park Dr", "Test Step - 4 - Recipient address 1 is not matched with customer address 1 field on phone order page recipient section");
            ...
            // Test Step - 10
            phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection(prop.getProperty("MOP_As_Debit"));
            delayWithGivenTime(1000);
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_Debit"), "Test Step - 13 - Payment type is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoiceNumber), "Test Step - 15 - In orders summary page  invoice number is not displayed for placed order");

            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber), prop.getProperty("MOP_As_Debit"), "Test Step - 15 - Mode of payment as " + paymenttype + " is not displayed");
