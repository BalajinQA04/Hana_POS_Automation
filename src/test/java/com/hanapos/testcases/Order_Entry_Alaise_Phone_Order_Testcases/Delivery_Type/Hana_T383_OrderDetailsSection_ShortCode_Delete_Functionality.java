...
public class Hana_T383_OrderDetailsSection_ShortCode_Delete_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T383_OrderDetailsSection_ShortCode_Delete_Functionality_Test(String code, String value) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T383_OrderDetailsSection_ShortCode_Delete_Functionality_Test ****");
...
*/
            ...
            if (phoneorder.Verify_AddedShortCode_IsDisplayed_OnViewShortCodesPopup() == false) {
                delayWithGivenTime(2000);
