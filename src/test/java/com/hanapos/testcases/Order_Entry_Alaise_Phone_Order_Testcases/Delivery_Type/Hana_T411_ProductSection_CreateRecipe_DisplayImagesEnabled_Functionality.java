...
public class Hana_T411_ProductSection_CreateRecipe_DisplayImagesEnabled_Functionality extends TestBaseClass {
    ...
    @Test(priority = 1, groups = {"Regression", "Sanity"}, dataProvider = "fetch_Excel_Data")
    public void Validate_Hana_T411_ProductSection_CreateRecipe_DisplayImagesEnabled_Functionality_Test
        ...
        logger.info("**** Starting  Validate_Hana_T411_ProductSection_CreateRecipe_DisplayImagesEnabled_Functionality_Test ****");
...
//            softassert.assertTrue(proposal.Verify_ItemNameIsDisplayed_on_CustProposalView(), "Test Step - 20 - Item name is not displayed on customer proposal view");
    ...
    @Epic("Phone Order Module - Delivery Type")
    @Test(priority = 2, groups = {"Regression", "Sanity"}, dataProvider = "fetch_Excel_Data")
