...
public class Hana_T360_OrderEntryPage_Delivery_RecipientSection_ExistingCustomerDetails_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T360_OrderEntryPage_Delivery_RecipientSection_ExistingCustomerDetails_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T360_OrderEntryPage_Delivery_RecipientSection_ExistingCustomerDetails_Functionality_Test  ****");
...
*/
            ...
            // Test Step - 9
            softassert.assertEquals(phoneorder.getReciPhone(), prop.getProperty("default_phone_number1"), "Test Step - 9 - Displayed phone number is not matched on phone order page recipient section");
            ...
            // Test Step - 14
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getReciPhone(),  prop.getProperty("default_phone_number1"), "Test Step - 14 - Recipient phone number is not displayed on phone order page recipient section");
