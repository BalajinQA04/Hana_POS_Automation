...
public class Hana_T377_OrderDetailsSection_PrintTicket_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T377_OrderDetailsSection_PrintTicket_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T377_OrderDetailsSection_PrintTicket_Functionality_Test ****");
