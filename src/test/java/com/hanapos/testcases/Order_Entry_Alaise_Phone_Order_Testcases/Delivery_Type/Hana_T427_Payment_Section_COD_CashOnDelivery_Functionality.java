...
public class Hana_T427_Payment_Section_COD_CashOnDelivery_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T427_Payment_Section_COD_CashOnDelivery_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T427_Payment_Section_COD_CashOnDelivery_Functionality_Test  ****");
...
*/
            ...
            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber), prop.getProperty("MOP_As_COD"), "Test Step - 15 - Mode of payment as " + paymenttype + " is not displayed");
