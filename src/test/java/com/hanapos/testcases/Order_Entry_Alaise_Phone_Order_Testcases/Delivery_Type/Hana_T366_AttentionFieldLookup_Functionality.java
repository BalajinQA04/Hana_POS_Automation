...
public class Hana_T366_AttentionFieldLookup_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T366_AttentionFieldLookup_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T366_AttentionFieldLookup_Functionality_Test ****");
