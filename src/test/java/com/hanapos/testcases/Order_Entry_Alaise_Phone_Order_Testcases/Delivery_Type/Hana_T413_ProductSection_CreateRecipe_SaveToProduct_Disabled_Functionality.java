...
public class Hana_T413_ProductSection_CreateRecipe_SaveToProduct_Disabled_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T413_ProductSection_CreateRecipe_SaveToProduct_Disabled_Functionality_Test
            (String RecipieName, String ItemGallery, String ItemName) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T413_ProductSection_CreateRecipe_SaveToProduct_Disabled_Functionality_Test ****");
...
*/
            ...
            // Test Step - 15
            phoneorder.Select_ItemGallery_onCreateRecipe(prop.getProperty("ItemGallery"));// prop.getProperty("ItemGallery") , //    prop.getProperty("ItemGallery")
            delayWithGivenTime(2000);
            ...
            // Test Step - 17
            softassert.assertEquals(phoneorder.Verify_RecipeItemRow3_OnTableIsDisplayed(), prop.getProperty("Component_itemgallery"), "Test Step - 17 - Recipe item row 3 " + prop.getProperty("Component_itemgallery") + " is not displayed on item gallery table");
            ...
            phoneorder.Click_ProductDetails_Row1_Recipe();
            delayWithGivenTime(2000);
            softassert.assertTrue(phoneorder.Verify_CreateRecipe_Popup(), "Test Step - 20 - Create Recipe popup is not displayed after clicking recipe icon again");
