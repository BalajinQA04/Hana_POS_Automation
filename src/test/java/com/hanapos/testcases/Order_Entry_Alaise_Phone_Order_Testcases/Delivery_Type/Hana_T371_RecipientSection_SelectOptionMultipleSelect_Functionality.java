...
public class Hana_T371_RecipientSection_SelectOptionMultipleSelect_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T371_RecipientSection_SelectOptionMultipleSelect_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T371_RecipientSection_SelectOptionMultipleSelect_Functionality_Test ****");
...
*/
            ...
            softassert.assertEquals(settingsPage.getDisplayedDeliveryTime(), "06:30 PM", "Test Step - 23 - Delivery Time Compared with recipient section saved information is not matched with configuration order entry menu funeral log submenu");
            ...
            softassert.assertEquals(settingsPage.getDisplayedDeliveryAddress2(), "", "Test Step - 23 - Delivery Address 2 Compared with recipient section saved information is not matched with configuration order entry menu funeral log submenu");
