...
public class Hana_T445_Payment_Section_CreditCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T445_Payment_Section_CreditCard_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T445_Payment_Section_CreditCard_Functionality_Test  ****");
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.getReciAddress1(), "1917 1st St", "Test Step - 4 - Recipient address 1 is not matched with customer address 1 field on phone order page recipient section");
            ...
            softassert.assertEquals(orderconfirmationpage.get_CC_Number_OrderConfirmationPage(), "1111", "Test Step - 22 - Entered credit card number on phoneorder order page CC number is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_CC")), "Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");

            //Test Step - 24
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_CC")), prop.getProperty("MOP_As_CC"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_CC") + " is not displayed");
