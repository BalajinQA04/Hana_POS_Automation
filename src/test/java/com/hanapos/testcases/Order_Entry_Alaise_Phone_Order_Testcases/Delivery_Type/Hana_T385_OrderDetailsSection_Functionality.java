...
public class Hana_T385_OrderDetailsSection_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T385_OrderDetailsSection_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T385_OrderDetailsSection_Functionality_Test ****");
...
*/
            ...
            // Test Step - 17
            softassert.assertEquals(dashboardorder.get_OccasionType_OnInvPopup(), prop.getProperty("occasion"), "Displayed occasion type on delivery invoice popup is not matched with expected occasion type");

            // Test Step - 18
            softassert.assertEquals(dashboardorder.get_CardMessage_OnInvPopup(), prop.getProperty("card_message"), "Test Step - 18 - Card message on delivery invoice popup is not matched with expected card message");
