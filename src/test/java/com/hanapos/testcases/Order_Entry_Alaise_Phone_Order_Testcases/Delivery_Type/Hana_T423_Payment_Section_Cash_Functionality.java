...
public class Hana_T423_Payment_Section_Cash_Functionality extends TestBaseClass {
    private LoginPage lp;
    private HanaDashBoardPage dashboard;
    private OrderEntry_Alais_PhoneOrderPage phoneorder;
    private Order_Confirmation_Page orderconfirmationpage;
    private DashboardOrderPage dashboardorder;
    public static final String dataSheetName = "Hana_T423";
    ...
    public void Validate_Hana_T423_Payment_Section_Cash_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T423_Payment_Section_Cash_Functionality_Test  ****");
