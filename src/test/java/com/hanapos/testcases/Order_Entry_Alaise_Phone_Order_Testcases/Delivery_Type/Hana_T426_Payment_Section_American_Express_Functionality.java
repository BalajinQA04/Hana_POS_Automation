...
public class Hana_T426_Payment_Section_American_Express_Functionality extends TestBaseClass {
    ...
    public static final String dataSheetName = "Hana_T426";
    ...
    public void Validate_Hana_T426_Payment_Section_American_Express_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T426_Payment_Section_American_Express_Functionality_Test  ****");
...
//            softassert.assertEquals(phoneorder.getRecipientState(), recistate, "Test Step - 4 - Recipient phone number is not matched with customer phonenumber 1 field on phone order page recipient section");
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(13, 50);
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(), paymenttype, "Test Step - 10 - Selected payment type is not displayed");
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), paymenttype, "Test Step - 13 - Payment type is not displayed on order confirmation page");
            ...
            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber), paymenttype, "Test Step - 19 - Mode of payment as " + paymenttype + " is not displayed");
