...
public class Hana_T337_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T337_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_Functionality_Test() {
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Hana_T337_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_FT  ****");
        ...
        try {
            ...
            // Test Step - 9
            delayWithGivenTime(2000);
            phoneorder.Enter_TotalAmount_OrderDetailsTab_CustomerDetailsPopup(total_amount);
            delayWithGivenTime(1000);
            softassert.assertEquals(phoneorder.get_TotalAmount_Orderdetailstab(), total_amount, "Test Step - 9 - Entered total amount is not displayed on the order details tab at customer details popup");

            // Test Step - 10
            RobotPressEnter();
            delayWithGivenTime(2000);
            softassert.assertTrue(phoneorder.Verify_TotalAmount_Orderdetailstab(total_amount), "Test Step - 10 - Filtered total amount is not displayed on the order details tab at customer details popup");
            ...
            RobotPressEnter();
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.Verify_TotalAmount_Orderdetailstab(total_amount), "Test Step - 12 - Filtered total amount with 3 digits is not displayed on the order details tab at customer details popup");
