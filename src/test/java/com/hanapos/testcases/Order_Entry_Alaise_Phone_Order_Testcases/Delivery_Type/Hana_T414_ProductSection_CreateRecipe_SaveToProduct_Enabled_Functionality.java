...
public class Hana_T414_ProductSection_CreateRecipe_SaveToProduct_Enabled_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T414_ProductSection_CreateRecipe_SaveToProduct_Enabled_Functionality_Test(String RecipieName, String ItemGallery, String ItemName) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T414_ProductSection_CreateRecipe_SaveToProduct_Enabled_Functionality_Test ****");
