...
public class Hana_T431_Payment_Section_MasterCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T431_Payment_Section_MasterCard_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T431_Payment_Section_MasterCard_Functionality_Test  ****");
...
*/
            ...
            reci_full_address1 = "1841 W Linda Ln, Robertsville, MO 63072";
            ...
            // Test Step - 10
            phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection(prop.getProperty("MOP_As_MasterCard"));
            delayWithGivenTime(1000);
            ...
            softassert.assertEquals(orderconfirmationpage.get_PaymentType(), prop.getProperty("MOP_As_MasterCard"), "Test Step - 13 - Payment type " + prop.getProperty("MOP_As_MasterCard") + " is not displayed on order confirmation page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_MasterCard")), "Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");

            //Test Step - 16
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_MasterCard")), prop.getProperty("MOP_As_MasterCard"), "Test Step - 16 - Mode of payment as " + prop.getProperty("MOP_As_MasterCard") + " is not displayed");
