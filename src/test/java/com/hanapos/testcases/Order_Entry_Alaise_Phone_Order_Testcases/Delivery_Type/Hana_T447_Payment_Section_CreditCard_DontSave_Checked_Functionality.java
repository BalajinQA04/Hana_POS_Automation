...
public class Hana_T447_Payment_Section_CreditCard_DontSave_Checked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T447_Payment_Section_CreditCard_DontSave_Checked_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T447_Payment_Section_CreditCard_DontSave_Checked_Functionality_Test  ****");
...
*/
            ...
            softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("cust_city"), "Test Step - 7 - Entered city is not displayed on phone order page recipient section");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_CC")), "Test Step - 29 - In orders summary page cash payment type invoice number is not displayed for placed order");
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment(prop.getProperty("Order_Type_PhoneOrder"), prop.getProperty("Delivery_Type_Delivery"), prop.getProperty("MOP_As_CC")), prop.getProperty("MOP_As_CC"), "Test Step - 29 - Mode of payment as " + prop.getProperty("MOP_As_CC") + " is not displayed");
