...
public class Hana_T678_WireOut_Payment_Section_Split_Payment_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T678_WireOut_Payment_Section_Split_Payment_Functionality_Test
        ...
        logger.info("**** Starting  Validate_Hana_T678_WireOut_Payment_Section_Split_Payment_Functionality_Test  ****");
...
*/
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.validate_InvoiceNumber_on_AllOrdersPage(invoiceNumber), "Test Step - 35 - Respective Invoice number : " + invoiceNumber + " is not displayed on all orders page");

            //Test Step - 36
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.validate_Status_On_AllOrdersPage(invoiceNumber), "WiredOut", "Test Step - 36 - Order status is not displayed as delivered for cash and carry order");

            // Test Step - 37
            dashboardorder.click_Status_Cell_On_AllOrdersPage(invoiceNumber);
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.get_OrderStatus_DeliveryPopup(), "WiredOut", "Test Step - 36 - Delivered as order status is not displayed on invoice");
