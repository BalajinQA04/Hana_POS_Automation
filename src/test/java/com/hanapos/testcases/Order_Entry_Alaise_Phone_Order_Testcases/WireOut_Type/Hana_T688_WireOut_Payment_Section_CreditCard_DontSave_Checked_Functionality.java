...
public class Hana_T688_WireOut_Payment_Section_CreditCard_DontSave_Checked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T688_WireOut_Payment_Section_CreditCard_DontSave_Checked_Functionality_Test(
        ...
        logger.info("**** Starting  Hana_T688_WireOut_Payment_Section_CreditCard_DontSave_Checked_Functionality  ****");
        ...
        try {
            ...
            //    delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Credit Card"), "Test Step - 29 - In orders summary page credit card payment type invoice number is not displayed for placed order");
            //    delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Credit Card"), "Credit Card", "Test Step - 28 - Mode of payment as credit card type is not displayed");
