...
public class Hana_T671_WireOut_Payment_Section_Marigold_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T671_WireOut_Payment_Section_Marigold_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T671_WireOut_Payment_Section_Marigold_Functionality_Test  ****");
        ...
        try {
            ...
            // delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Marigold"), "Test Step - 15 - In orders summary page Marigold payment type invoice number is not displayed for placed order");

            //Test Step - 16
            //delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Marigold"), "Marigold", "Test Step - 16 - Mode of payment as Marigold type is not displayed");
