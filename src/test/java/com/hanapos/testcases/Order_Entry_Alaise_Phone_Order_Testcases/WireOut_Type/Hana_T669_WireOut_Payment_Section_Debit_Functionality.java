...
public class Hana_T669_WireOut_Payment_Section_Debit_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T669_WireOut_Payment_Section_Debit_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T669_WireOut_Payment_Section_Debit_Functionality_Test  ****");
        ...
        try {
            ...
            //  delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Debit"), "Test Step - 18 - In orders summary page Debit payment type invoice number is not displayed for placed order");

            //Test Step - 16
            //   delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Debit"), "Debit", "Test Step - 19 - Mode of payment as Debit type is not displayed");
