...
public class Hana_T523_CustomerSection_SearchExistingCustomer_Functionality extends TestBaseClass {
    private LoginPage lp;
    private HanaDashBoardPage dashboard;
    private OrderEntry_Alais_PhoneOrderPage phoneorder;

    public static final String dataSheetName = "Hana_T523";
    ...
    public void Validate_Hana_T523_CustomerSection_SearchExistingCustomer_Functionality_Test(String salesperson, String customername, String searchandselectcust, String invalidsearchandselect, String searchandselectwith3char) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T523_CustomerSection_SearchExistingCustomer_Functionality_Test  ****");
