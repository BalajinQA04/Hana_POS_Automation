...
public class Hana_T553_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_ExportToExcel_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T553_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_ExportToExcel_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Validate_Hana_T553_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_ExportToExcel_Functionality_Test  ****");
        ...
        try {
            ...
            softassert.assertTrue(phoneorder.VerifyFileIsDownloaded(downloadPath, "PaymentDetails.xlsx"), "Test Step - 11 - File is not downloaded on payment details tab at customer phone order page");
        } catch (Exception e) {
