...
public class Hana_T600_WireOut_OrderDetailsSection_PrintTicket_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T600_WireOut_OrderDetailsSection_PrintTicket_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T600_WireOut_OrderDetailsSection_PrintTicket_Functionality_Test ****");
        ...
        try {
            ...
            logger.info("User selected the shopname on dashboard page as {}", prop.getProperty("shopname"));
            ...
            // Test Step - 8
            softassert.assertFalse(phoneorder.Verify_PrintTicketCheckBoxIsSelected(), "Test Step - 8 - Print ticket checkbox is checked as default on Order details section");
