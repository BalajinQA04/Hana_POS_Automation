...
public class Hana_T619_WireOut_ProductSection_GiftCardSale_popup_Edit_GiftCard_Denominations_Edit_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T619_WireOut_ProductSection_GiftCardSale_popup_Edit_GiftCard_Denominations_Edit_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T619_WireOut_ProductSection_GiftCardSale_popup_Edit_GiftCard_Denominations_Edit_Functionality_Test ****");
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(phoneorder.get_HighlightedColor_On_WireOut_PhoneOrderPage(), "#2f9bc8", "Test Step - 4 - Wire out Delivery type is not highlighted in blue color");
