...
public class Hana_T593_WireOut_RecipientSection_SelectOptionMultipleSelect_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T593_WireOut_RecipientSection_SelectOptionMultipleSelect_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T593_WireOut_RecipientSection_SelectOptionMultipleSelect_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.getEnteredViewShortCode().equalsIgnoreCase("Happy Birthday! Hope you have an amazing day!"), true, "Test Step - 12 -Entered Short code is not displayed on phone order page order details section");
            delayWithGivenTime(2000);
