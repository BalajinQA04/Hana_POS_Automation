...
public class Hana_T668_WireOut_Payment_Section_COD_CashOnDelivery_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T668_WireOut_Payment_Section_COD_CashOnDelivery_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T668_WireOut_Payment_Section_COD_CashOnDelivery_Functionality_Test  ****");
        ...
        try {
            ...
            //  delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "COD - Cash On Delivery"), "Test Step - 18 - In orders summary page Cash On Delivery payment type invoice number is not displayed for placed order");

            //Test Step - 16
            //  delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "COD - Cash On Delivery"), "COD - Cash On Delivery", "Test Step - 19 - Mode of payment as Cash On Delivery type is not displayed");
