...
public class Hana_T696_WireOut_Payment_Section_CreditCard_SwipeCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T696_WireOut_Payment_Section_CreditCard_SwipeCard_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T696_WireOut_Payment_Section_CreditCard_SwipeCard_Functionality_Test  ****");
...
//            softassert.assertEquals(phoneorder.getDeliveryDateOnReciSection(), CurrentDate(), "Test Step - 7 - Delivery date is not displayed on phone order page recipient section");
            ...
            //    delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Credit Card"), "Test Step - 28 - In orders summary page credit card payment type invoice number is not displayed for placed order");
            //    delayWithGivenTime(1000);
