...
public class Hana_T599_WireOut_OrderDetailsSection_SendRemainderEmail_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T599_WireOut_OrderDetailsSection_SendRemainderEmail_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T599_WireOut_OrderDetailsSection_SendRemainderEmail_Functionality_Test ****");
