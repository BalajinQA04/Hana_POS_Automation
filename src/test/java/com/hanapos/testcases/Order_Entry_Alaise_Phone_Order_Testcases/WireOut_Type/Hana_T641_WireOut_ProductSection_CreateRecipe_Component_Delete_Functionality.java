...
public class Hana_T641_WireOut_ProductSection_CreateRecipe_Component_Delete_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T641_WireOut_ProductSection_CreateRecipe_Component_Delete_Functionality_Test(String RecipieName, String ItemGallery, String ItemName) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T641_WireOut_ProductSection_CreateRecipe_Component_Delete_Functionality_Test ****");
        ...
        try {
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(4, 30);
            ...
            delayWithGivenTime(2000);
         //   softassert.assertTrue(phoneorder.Verify_Row3_ProductIsDelete("Lily - Gloriosa Blue"), "Test Step - 20 - Recipe item row 3 is not deleted on added item gallery table");
