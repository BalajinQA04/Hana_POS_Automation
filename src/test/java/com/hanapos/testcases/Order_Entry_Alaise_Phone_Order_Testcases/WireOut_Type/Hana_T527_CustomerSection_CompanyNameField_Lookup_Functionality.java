...
public class Hana_T527_CustomerSection_CompanyNameField_Lookup_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T527_CustomerSection_CompanyNameField_Lookup_Functionality_Test(String salesperson, String custcompanyname, String searchandselectcompanyname, String searchandselectShortcompanyname) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T527_CustomerSection_CompanyNameField_Lookup_Functionality_Test  ****");
        ...
        try {
            ...
            phoneorder.EnterCustomerCompanyName(prop.getProperty("invalid_company_name"));
            delayWithGivenTime(1000);
            ...
            // Test Step - 8
            phoneorder.SearchAndSelect_CompanynameOnCustSection(prop.getProperty("short_company_name"), searchandselectcompanyname);
            delayWithGivenTime(2000);
