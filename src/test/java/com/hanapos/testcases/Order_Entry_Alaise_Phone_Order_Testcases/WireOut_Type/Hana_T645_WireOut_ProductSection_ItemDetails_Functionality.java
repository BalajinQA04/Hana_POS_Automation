...
public class Hana_T645_WireOut_ProductSection_ItemDetails_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T645_WireOut_ProductSection_ItemDetails_Functionality_Test(String Item_Gallery, String Item_Name, String Retail_Price_Row3, String Quantity, String Private_Notes, String Public_Notes) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();
        logger.info("**** Starting  Validate_Hana_T645_WireOut_ProductSection_ItemDetails_Functionality_Test ****");
        ...
        try {
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(2, 00);
            ...
            // Test Step - 12
            delayWithGivenTime(2000);
            softassert.assertTrue(phoneorder.Verify_I_Icon_IsDisplayed_on_ProductDetails_Section(), "Test Step - 12 - I icon is not displayed on row 1 product");

//            // Test Step - 13
//            phoneorder.Click_I_Icon_on_ProductDetails_Section();
//            softassert.assertTrue(phoneorder.verify_itemdetails_popup_isDisplayed(), "Test Step - 13: Item details popup is not displayed when user click the i icon on respective added product");
//
//            // Test Step - 14
//            softassert.assertEquals(phoneorder.get_recipe_name_on_ItemDetails_popup(), "Test QA", "Test Step - 14 - Recipe name is not displayed on item details popup");
//
//            // Test Step - 15
//            softassert.assertEquals(phoneorder.get_recipe_totalcost_on_ItemDetails_popup(), "$12.42", "Test Step - 15 - Recipe total cost is not displayed on item details popup");
//
//            // Test Step - 16
//            softassert.assertEquals(phoneorder.get_recipe_totalLabour_on_ItemDetails_popup(), "$24.84", "Test Step - 16 - Recipe total labour is not displayed on item details popup");
//
//            // Test Step - 17
//            softassert.assertEquals(phoneorder.get_recipe_totalAmount_on_ItemDetails_popup(), "$248.40", "Test Step - 17 - Recipe total amount is not displayed on item details popup");
//
//            // Test Step - 18
//            softassert.assertEquals(phoneorder.get_displayed_componentname_row1_on_ItemDetails_popup(), "Delphinium Pink - Hot", "Test Step - 18 - Recipe total amount is not displayed on item details popup");
//            softassert.assertEquals(phoneorder.get_displayed_componentname_row2_on_ItemDetails_popup(), "Chrysanthemum Spray/Pompon - Cushion Red", "Test Step - 18 - Recipe total amount is not displayed on item details popup");
//
//            // Test Step - 19
//            delayWithGivenTime(2000);
            //       phoneorder.Click_ItemDetails_CloseIcon();
