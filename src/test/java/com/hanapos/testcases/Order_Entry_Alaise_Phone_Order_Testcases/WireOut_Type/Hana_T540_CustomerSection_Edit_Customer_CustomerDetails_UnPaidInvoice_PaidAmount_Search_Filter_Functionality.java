...
public class Hana_T540_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_PaidAmount_Search_Filter_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T540_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_PaidAmount_Search_Filter_Functionality_Test(String valid_paid_amount, String twodigit_paid_amount, String invalid_paid_amount) {
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T540_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_PaidAmount_Search_Filter_Functionality_Test  ****");
