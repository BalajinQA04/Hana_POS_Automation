...
public class Hana_T670_WireOut_Payment_Section_Lovingly_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T670_WireOut_Payment_Section_Lovingly_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T670_WireOut_Payment_Section_Lovingly_Functionality_Test  ****");
        ...
        try {
            ...
            //   delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Lovingly"), "Test Step - 18 - In orders summary page Lovingly payment type invoice number is not displayed for placed order");

            //Test Step - 16
            // delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Lovingly"), "Lovingly", "Test Step - 16 - Mode of payment as Lovingly type is not displayed");
