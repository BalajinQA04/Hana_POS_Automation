...
public class Hana_T683_WireOut_Payment_Section_Donation_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T683_WireOut_Payment_Section_Donation_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T683_WireOut_Payment_Section_Donation_Functionality_Test  ****");
        ...
        try {
            ...
            //   delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Donation"), "Test Step - 22 - In orders summary page Donation payment type invoice number is not displayed for placed order");
            //  delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Donation"), "Donation", "Test Step - 22 - Mode of payment as Donation type is not displayed");
