...
public class Hana_T690_WireOut_Payment_Section_CreditCard_DontSave_UnChecked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T690_WireOut_Payment_Section_CreditCard_DontSave_UnChecked_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T690_WireOut_Payment_Section_CreditCard_DontSave_UnChecked_Functionality_Test  ****");
        ...
        try {
            ...
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Credit Card"), "Credit Card", "Test Step - 29 - Mode of payment as credit card type is not displayed");
