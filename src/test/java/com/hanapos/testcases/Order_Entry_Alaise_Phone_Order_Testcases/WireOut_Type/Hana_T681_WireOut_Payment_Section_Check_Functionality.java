...
public class Hana_T681_WireOut_Payment_Section_Check_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T681_WireOut_Payment_Section_Check_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T681_WireOut_Payment_Section_Check_Functionality_Test  ****");
        ...
        try {
            ...
            // Test Step - 14
            phoneorder.Enter_CheckNumber_On_TextBox("184467889900");
            softassert.assertEquals(phoneorder.get_Entered_CheckNumber_On_TextBox(), "184467889900", "Test Step - 14 - Entered check Number is not displayed on Bank name textbox field at check payment type phone order page");
...
//            softassert.assertEquals(phoneorder.get_Entered_CheckRountingNumber_On_TextBox(), "16782", "Test Step - 17 - Entered Rounting number is not displayed on Bank name textbox field at check payment type phone order page");
            ...
            delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Check"), "Test Step - 22 - In orders summary page check payment type invoice number is not displayed for placed order");
            delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Check"), "Check", "Test Step - 22 - Mode of payment as Check type is not displayed");
