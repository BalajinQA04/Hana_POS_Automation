...
public class Hana_T630_WireOut_ProductSection_CreateRecipe_ItemGallery_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T630_WireOut_ProductSection_CreateRecipe_ItemGallery_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Hana_T630_WireOut_ProductSection_CreateRecipe_ItemGallery_Functionality_Test ****");
        ...
        try {
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(9, 30);
