...
public class Hana_T673_WireOut_Payment_Section_Paid_Outside_Hana_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T673_WireOut_Payment_Section_Paid_Outside_Hana_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T673_WireOut_Payment_Section_Paid_Outside_Hana_Functionality_Test  ****");
        ...
        try {
            ...
            //  delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Paid Outside Hana"), "Test Step - 15 - In orders summary page Paid Outside Hana payment type invoice number is not displayed for placed order");

            //Test Step - 16
            // delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Paid Outside Hana"), "Paid Outside Hana", "Test Step - 16 - Mode of payment as Paid Outside Hana type is not displayed");
