...
public class Hana_T650_WireOut_Payment_Section_Anyone_Payment_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T650_WireOut_Payment_Section_Anyone_Payment_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T650_WireOut_Payment_Section_Anyone_Payment_Functionality_Test  ****");
        ...
        try {
            ...
            //Test Step - 19
            //  delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Cash"), "Cash", "Test Step - 19 - Mode of payment as cash type is not displayed");
