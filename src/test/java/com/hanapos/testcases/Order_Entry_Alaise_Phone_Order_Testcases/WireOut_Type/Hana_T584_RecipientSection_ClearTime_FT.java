...
public class Hana_T584_RecipientSection_ClearTime_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T584_RecipientSection_ClearTime_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T584_RecipientSection_ClearTime_Functionality_Test ****");
        ...
        try {
            ...
            softassert.assertTrue(phoneorder.Verify_RecipientSectionAppears(), "Test Step - 5: Recipient section is not displayed on Phone order page");
            ...
            } else if (phoneorder.getReciPhone().equals("832-487-2387")) {
                softassert.assertEquals(phoneorder.getReciPhone(), "832-487-2387", "Test Step - 8 - Recipient phone number is not auto populated on recipient section");
            }
