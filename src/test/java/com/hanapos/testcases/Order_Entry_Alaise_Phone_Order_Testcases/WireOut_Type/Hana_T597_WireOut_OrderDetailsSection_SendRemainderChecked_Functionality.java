...
public class Hana_T597_WireOut_OrderDetailsSection_SendRemainderChecked_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T597_WireOut_OrderDetailsSection_SendRemainderChecked_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T597_WireOut_OrderDetailsSection_SendRemainderChecked_Functionality_Test ****");
        ...
        try {
         ...
         /*   softassert.assertEquals(remainders.get_CustomerName_EditReminderPopup(), "Abish David", "known Issue - Test Step - 18 - Customer name is not displayed on Edit reminder popup");
