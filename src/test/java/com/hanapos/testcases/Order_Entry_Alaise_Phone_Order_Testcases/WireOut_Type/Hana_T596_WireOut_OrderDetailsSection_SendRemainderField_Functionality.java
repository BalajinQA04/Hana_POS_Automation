...
public class Hana_T596_WireOut_OrderDetailsSection_SendRemainderField_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T596_WireOut_OrderDetailsSection_SendRemainderField_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T596_WireOut_OrderDetailsSection_SendRemainderField_Functionality_Test ****");
