...
public class Hana_T565_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_StatusSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T565_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_StatusSearchFilter_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Hana_T565_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_StatusSearchFilter_FT  ****");
        ...
        try {
            ...
            // Test Step - 9
            delayWithGivenTime(1000);
            phoneorder.Enter_Status_OrderDetailsTab_CustomerDetailsPopup("WiredOut");
            softassert.assertEquals(phoneorder.get_Status_Orderdetailstab(), "WiredOut", "Test Step - 9: Entered status as new is not displayed");

            // Test Step - 10
            RobotPressEnter();
            delayWithGivenTime(1500);
            softassert.assertTrue(phoneorder.Verify_Status_Orderdetailstab("WiredOut"), "Test Step - 10 - Filtered status is not displayed on the order details tab at customer details popup");

            // Test Step - 11
            delayWithGivenTime(2000);
            phoneorder.Enter_Status_OrderDetailsTab_CustomerDetailsPopup("New");
            softassert.assertEquals(phoneorder.get_Status_Orderdetailstab(), "New", "Test Step - 9: Entered status as del is not displayed");

            // Test Step - 12
            RobotPressEnter();
            delayWithGivenTime(2000);
            softassert.assertTrue(phoneorder.Verify_Status_Orderdetailstab("New"), "Known Issue Test Step - 12 - Filtered status with 3 characters is not displayed on the order details tab at customer details popup");

            // Test Step - 13
            delayWithGivenTime(1000);
            phoneorder.Enter_Status_OrderDetailsTab_CustomerDetailsPopup("In-Progress");
            delayWithGivenTime(1000);
            RobotPressEnter();
