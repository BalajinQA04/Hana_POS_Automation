...
public class Hana_T532_CustomerSection_Edit_Customer_CustomerDetails_ProfileUpdate_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T532_CustomerSection_Edit_Customer_CustomerDetails_ProfileUpdate_Functionality_Test(
            String salesperson,
            String customername,
            String companyname,
            String firstname,
        ...
        logger.info("**** Starting  Validate_Hana_T532_CustomerSection_Edit_Customer_CustomerDetails_ProfileUpdate_Functionality_Test  ****");
        ...
        try {
            ...
            softassert.assertEquals(phoneorder.getCompanyNameOnPhoneOrderPage(), "Marketta O'Hara LLC", "Test Step - 6 - Company name is not displayed on phone order page");
            ...
            phoneorder.Click_CustEditIcon();
            delayWithGivenTime(2000);
            phoneorder.Enter_CompanyName_OnCustDetailsPopup("Marketta O'Hara LLC");
            phoneorder.Enter_FirstName_OnCustDetailsPopup("Marketta");
            phoneorder.Enter_LastName_OnCustDetailsPopup("O'Hara");
            ...
            softassert.assertEquals(phoneorder.getCompanyNameOnPhoneOrderPage(), "Marketta O'Hara LLC", "Test Step - 6 - Company name is not displayed on phone order page - after update customer details");
