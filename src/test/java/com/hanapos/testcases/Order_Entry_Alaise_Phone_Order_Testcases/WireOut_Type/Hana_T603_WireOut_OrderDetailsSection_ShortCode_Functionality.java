...
public class Hana_T603_WireOut_OrderDetailsSection_ShortCode_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T603_WireOut_OrderDetailsSection_ShortCode_Functionality_Test(String code, String value) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T603_WireOut_OrderDetailsSection_ShortCode_Functionality_Test ****");
