...
public class Hana_T675_WireOut_Payment_Section_WriteOff_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T675_WireOut_Payment_Section_WriteOff_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T675_WireOut_Payment_Section_WriteOff_Functionality_Test  ****");
        ...
        try {
            ...
            //    delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Write Off"), "Test Step - 15 - In orders summary page Write Off payment type invoice number is not displayed for placed order");

            //Test Step - 16
            //    delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Write Off"), "Write Off", "Test Step - 16 - Mode of payment as Write Off type is not displayed");
