...
public class Hana_T541_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_BalanceAmt_Search_Filter_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T541_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_BalanceAmt_Search_Filter_Functionality_Test(String valid_balance_amount, String twodigit_balance_amount, String invalid_balance_amount) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Validate_Hana_T541_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_BalanceAmt_Search_Filter_Functionality_Test  ****");
        ...
        try {
            ...
            // Test Step - 9
            phoneorder.SearchandSelectItemcodeOnPhoneOrderPage(prop.getProperty("itmcode"), "Red Rose Wedding Reception Flower");
            delayWithGivenTime(2000);
