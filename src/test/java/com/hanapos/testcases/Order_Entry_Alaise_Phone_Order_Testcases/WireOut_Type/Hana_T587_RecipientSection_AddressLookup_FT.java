...
public class Hana_T587_RecipientSection_AddressLookup_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T587_RecipientSection_AddressLookup_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T587_RecipientSection_AddressLookup_Functionality_Test ****");
