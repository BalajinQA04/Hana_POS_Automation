...
public class Hana_T529_CustomerSection_AltPhoneNumberField_Lookup_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T529_CustomerSection_AltPhoneNumberField_Lookup_Functionality_Test(String salesperson, String custphone, String searchandselectaltphone) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T529_CustomerSection_AltPhoneNumberField_Lookup_Functionality_Test  ****");
