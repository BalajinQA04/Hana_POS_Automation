...
public class Hana_T528_CustomerSection_PhoneNumberField_Lookup_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T528_CustomerSection_PhoneNumberField_Lookup_Functionality_Test(String salesperson, String custphone, String searchandselectphone) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T528_CustomerSection_PhoneNumberField_Lookup_Functionality_Test  ****");
