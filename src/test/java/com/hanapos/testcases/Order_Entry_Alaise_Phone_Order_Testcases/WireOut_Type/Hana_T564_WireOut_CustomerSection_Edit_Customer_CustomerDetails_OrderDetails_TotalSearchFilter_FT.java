...
public class Hana_T564_WireOut_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T564_WireOut_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Validate_Hana_T564_WireOut_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_TotalSearchFilter_Functionality_Test  ****");
        ...
        try {
            ...
            // Test Step - 9
            String totalAmount = phoneorder.get_TotalAmount_Order_Details_Tab();
            delayWithGivenTime(1000);
            phoneorder.Enter_TotalAmount_OrderDetailsTab_CustomerDetailsPopup(totalAmount);

            // Test Step - 10
            RobotPressEnter();
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.Verify_TotalAmount_Orderdetailstab(totalAmount), "Test Step - 10 - Filtered total amount is not displayed on the order details tab at customer details popup");
            ...
            RobotPressEnter();
            delayWithGivenTime(1000);
            softassert.assertTrue(phoneorder.Verify_TotalAmount_Orderdetailstab(totalAmount), "Test Step - 12 - Filtered total amount with 3 digits is not displayed on the order details tab at customer details popup");
