...
public class Hana_T704_WireOut_PaymentSection_SelectFlorist_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T704_WireOut_PaymentSection_SelectFlorist_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T704_WireOut_PaymentSection_SelectFlorist_Functionality_Test  ****");
        ...
        try {
            ...
            phoneorder.EnterReciZipcode(prop.getProperty("wireout_fsn_zipcode"));
            ...
            softassert.assertEquals(phoneorder.getReciZipcode(), prop.getProperty("wireout_fsn_zipcode"), "Test Step - 7 - Entered zipcode is not displayed on phone order page recipient section");
            softassert.assertEquals(phoneorder.getReciCity(), prop.getProperty("wireout_city"), "Test Step - 7 - Entered city is not displayed on phone order page recipient section");
            ...
            //    delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Cash"), "Test Step - 18 - Cash payment type ** Wire Out ** invoice number is not displayed on Order Summary Page");

            //   delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Cash"), "Cash", "Test Step - 19 - Wire Out ==> Mode of payment as cash type is not displayed");
