...
public class Hana_T672_WireOut_Payment_Section_MasterCard_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T672_WireOut_Payment_Section_MasterCard_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T672_WireOut_Payment_Section_MasterCard_Functionality_Test  ****");
        ...
        try {
            ...
            softassert.assertEquals(dashboardorder.validate_MOP_On_AllOrdersPage(invoiceNumber), "Master Card", "Test Step - 16 - Mode of payment as Master card type is not displayed");
