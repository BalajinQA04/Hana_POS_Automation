...
public class Hana_T628_WireOut_ProductSection_CreateRecipe_SaveAs_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T628_WireOut_ProductSection_CreateRecipe_SaveAs_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T628_WireOut_ProductSection_CreateRecipe_SaveAs_Functionality_Test ****");
        ...
        try {
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(10, 30);
