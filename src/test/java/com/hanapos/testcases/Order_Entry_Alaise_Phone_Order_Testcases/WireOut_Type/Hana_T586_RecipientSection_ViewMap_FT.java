...
public class Hana_T586_RecipientSection_ViewMap_FT extends TestBaseClass {
    ...
    public void Validate_Hana_T586_RecipientSection_ViewMap_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T586_RecipientSection_ViewMap_Functionality_Test ****");
        ...
        try {
            ...
            // Test Step - 17
            if (phoneorder.Verify_PlusIcon_OnMapDirection_Popup_At_ReciAddress1_IsDisplayed()) {
            ...
            // Test Step - 18
            if (phoneorder.Verify_MinusIcon_OnMapDirection_Popup_At_ReciAddress1_IsDisplayed()) {
