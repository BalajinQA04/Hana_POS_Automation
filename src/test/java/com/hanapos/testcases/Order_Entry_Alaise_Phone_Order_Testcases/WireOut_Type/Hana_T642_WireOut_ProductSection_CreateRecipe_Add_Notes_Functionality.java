...
public class Hana_T642_WireOut_ProductSection_CreateRecipe_Add_Notes_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T642_WireOut_ProductSection_CreateRecipe_Add_Notes_Functionality_Test(String RecipieName, String PrivateNotes, String PublicNotes) {
        ...
        try {
            ...
            phoneorder.EnterDeliveryDateOnReciSection(CurrentDate());
            phoneorder.Enter_DeliveryTime_OnRecipientSection(2, 30);
