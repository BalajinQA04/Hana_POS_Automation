...
public class Hana_T526_CustomerSection_LastNameFieldLookup_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T526_CustomerSection_LastNameFieldLookup_Functionality_Test(String salesperson, String custlname, String searchandselectlname) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T526_CustomerSection_LastNameFieldLookup_Functionality_Test  ****");
        ...
        try {
            ...
            softassert.assertTrue(phoneorder.Verify_CustLastNameSection_AutosuggestionAppears(), "Test Step - 7 - Customer section last name autosuggestion is not displayed on phone order page");
