...
public class Hana_T538_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T538_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Functionality_Test(String paymentmethod, String cashregistry) {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T538_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Functionality_Test  ****");
