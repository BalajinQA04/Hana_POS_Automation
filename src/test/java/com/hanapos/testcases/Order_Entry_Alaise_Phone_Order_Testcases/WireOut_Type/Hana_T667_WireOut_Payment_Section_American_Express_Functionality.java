...
public class Hana_T667_WireOut_Payment_Section_American_Express_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T667_WireOut_Payment_Section_American_Express_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T667_WireOut_Payment_Section_American_Express_Functionality_Test  ****");
        ...
        try {
            ...
            // delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "American Express"), "Test Step - 18 - In orders summary page American Express payment type invoice number is not displayed for placed order");

            //Test Step - 16
            // delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "American Express"), "American Express", "Test Step - 19 - Mode of payment as American Express type is not displayed");
