...
public class Hana_T608_WireOut_OrderDetailsSection_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T608_WireOut_OrderDetailsSection_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting  Validate_Hana_T608_WireOut_OrderDetailsSection_Functionality_Test ****");
