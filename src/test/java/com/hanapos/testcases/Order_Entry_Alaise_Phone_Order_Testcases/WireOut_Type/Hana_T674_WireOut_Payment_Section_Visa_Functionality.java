...
public class Hana_T674_WireOut_Payment_Section_Visa_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T674_WireOut_Payment_Section_Visa_Functionality_Test(
        ...
        logger.info("**** Starting  Validate_Hana_T674_WireOut_Payment_Section_Visa_Functionality_Test  ****");
        ...
        try {
            ...
            //  delayWithGivenTime(1000);
            softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Delivery_InvoiceNumber("Phone Order", "Wire Out", "Visa"), "Test Step - 15 - In orders summary page Visa payment type invoice number is not displayed for placed order");

            //Test Step - 16
            //  delayWithGivenTime(1000);
            softassert.assertEquals(dashboardorder.Validate_PhoneOrder_ModeOfPayment("Phone Order", "Wire Out", "Visa"), "Visa", "Test Step - 16 - Mode of payment as Visa type is not displayed");
