...
public class Hana_T549_WireOut_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Sorting_Functionality extends TestBaseClass {
    ...
    public void Validate_Hana_T549_WireOut_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Sorting_Functionality_Test() {
        // SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
        CustomSoftAssert softassert = new CustomSoftAssert();

        logger.info("**** Starting Validate_Hana_T549_WireOut_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Sorting_Functionality_Test  ****");
        ...
        try {
            ...
            softassert.assertTrue(phoneorder.verify_DeliveryDateHeader_Sorted_Descending(), "Test Step - 38 - Deivery dates are not sorting as descending order on deliev label at Unpaid invoice tab on Customer details popup");
