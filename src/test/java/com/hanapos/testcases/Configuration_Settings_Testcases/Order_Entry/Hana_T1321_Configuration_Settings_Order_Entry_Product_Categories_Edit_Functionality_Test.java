...
public class Hana_T1321_Configuration_Settings_Order_Entry_Product_Categories_Edit_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1321_Configuration_Settings_Order_Entry_Product_Categories_Edit_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            settingsPage.click_First_Edit_Icon_On_ProductCategories_Table();
            delayWithGivenTime(2000);
            softassert.assertTrue(settingsPage.is_Update_Record_ProductCategories_Popup_Displayed(), "Test Step - 10 - Update Record product categories popup is not displayed");

            updatecategory = faker.commerce().department();
            updatecode = faker.code().ean8();
            updatedescription = faker.lorem().sentence();

            settingsPage.enter_ProductCategories_Name_On_AddNewRecord_Popup(updatecategory);
            delayWithGivenTime(2000);
            softassert.assertEquals(settingsPage.get_ProductCategories_Name_On_AddNewRecord_Popup(), updatecategory, "Test Step - 6: Entered Product categories name is not displayed on add new record popup");

            settingsPage.enter_ProductCategories_Code_On_AddNewRecord_Popup(updatecode);
            delayWithGivenTime(2000);
            softassert.assertEquals(settingsPage.get_ProductCategories_Code_On_AddNewRecord_Popup(), updatecode, "Test Step - 7: Entered Product categories code is not displayed on add new record popup as " + settingsPage.get_ProductCategories_Code_On_AddNewRecord_Popup());

            settingsPage.enter_ProductCategories_Description_On_AddNewRecord_Popup(updatedescription);
            delayWithGivenTime(2000);
            softassert.assertEquals(settingsPage.get_ProductCategories_Description_On_AddNewRecord_Popup(), updatedescription, "Test Step - 8: Entered Product categories description is not displayed on add new record popup");
...
//==========================Wedding Proposal=============================================================
            ...
            delayWithGivenTime(2000);
            manageproposal.Select_CategoryDropdown_On_ItemsAndProducts(updatecategory);
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Selected_Category_On_ItemsAndProducts(), updatecategory, "Test Step - 9: Selected category is not displayed on manage proposal page");
            delayWithGivenTime(2000);
