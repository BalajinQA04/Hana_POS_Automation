...
public class Hana_T1325_Configuration_Settings_Order_Entry_Product_Categories_Delete_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1325_Configuration_Settings_Order_Entry_Product_Categories_Delete_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            // Test Step - 10
            settingsPage.click_Delete_Icon_On_ProductCategories_Table();
            delayWithGivenTime(2000);
            softassert.assertTrue(settingsPage.is_Delete_Confirmation_Popup_Displayed(), "Test Step - 10: Delete confirmation popup is not displayed");

            // Test Step - 11
            settingsPage.click_Yes_Button_On_DeleteConfirmation_Popup();
            delayWithGivenTime(2000);
//==========================Wedding Proposal=============================================================
            ...
            delayWithGivenTime(2000);
            softassert.assertFalse(manageproposal.verify_Product_Category_Option_IsDisplayed(category), "Test Step - 9: Selected category is displayed on wedding - manage proposal page");
            delayWithGivenTime(2000);
//============================== Event ==================================================
            ...
            manageproposal.Click_ItemsAndProducts_Tab();
            delayWithGivenTime(2000);
            softassert.assertFalse(manageproposal.verify_Product_Category_Option_IsDisplayed(category), "Test Step - 9: Selected category is displayed on event - manage proposal page");
            delayWithGivenTime(2000);
        } catch (Exception e) {
