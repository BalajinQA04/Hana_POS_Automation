...
public class Hana_T1340_Configuration_Settings_Order_Entry_Product_Categories_IsEvent_Toogle_Disabled_Functionality_Test extends TestBaseClass {
...
//            delayWithGivenTime(2000);
//
//            softassert.assertTrue(manageproposal.verify_Product_Category_Option_IsNotDisplayed(category),  "Test Step - 10: Selected category is not displayed on manage proposal page");
//            delayWithGivenTime(2000);
//
//        } catch (Exception e) {
