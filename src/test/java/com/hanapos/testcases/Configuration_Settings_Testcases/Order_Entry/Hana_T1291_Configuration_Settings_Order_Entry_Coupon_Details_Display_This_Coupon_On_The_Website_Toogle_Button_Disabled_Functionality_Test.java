...
public class Hana_T1291_Configuration_Settings_Order_Entry_Coupon_Details_Display_This_Coupon_On_The_Website_Toogle_Button_Disabled_Functionality_Test extends TestBaseClass {
...
//            // Test Step - 5
//            delayWithGivenTime(1000);
//            settingsPage.select_ShopName_On_CouponDetails(prop.getProperty("bestshopname"));
//            delayWithGivenTime(1000);
//            softassert.assertEquals(settingsPage.get_Selected_ShopName_On_CouponDetails(), prop.getProperty("bestshopname"), "Test Step - 5: Selected shopname is not matching with expected shopname as " + prop.getProperty("bestshopname"));
//
//            // Test Step - 6
...
//            delayWithGivenTime(3000);
//            softassert.assertEquals(ecommerce_homePage.get_HomePage(), prop.getProperty("ecommerce_checkoutpage_url"), "Test Step - 12: Ecommerce home page url is not matching with expected url");
//            delayWithGivenTime(3000);
//
...
//            settingsPage.click_Delete_Icon_On_CouponDetails_TableGrid(coupon_name);
//            delayWithGivenTime(2000);
