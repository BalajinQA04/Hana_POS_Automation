...
public class Hana_T1338_Configuration_Settings_Order_Entry_Product_Categories_IsEvent_Toogle_Enabled_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1338_Configuration_Settings_Order_Entry_Product_Categories_IsEvent_Toogle_Enabled_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            category = faker.commerce().department() + "_" + faker.bothify("########").toUpperCase();;
            code = faker.code().ean8();
            description = "This " + faker.commerce().productName() + " is perfect for daily use.";
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(proposal.Verify_CreateProposalHeader_Popup(), "Test Step - 7 - Create a Proposal popup is not displayed");
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(proposal.isCreateProposalPopupClosed(), "Test Step - 8: Create proposal popup is not closed on view proposal page");
            ...
            delayWithGivenTime(1000);
            proposal.SearchandSelect_Customer_OnProposal(prop.getProperty("cust_firstName"));
            softassert.assertEquals(proposal.Verify_CustomerNameIsDisplayed_On_SearchTextBox(), prop.getProperty("custfullname"), "Test Step - 9: Searched customer full name is not displayed on create proposal popup");
            delayWithGivenTime(2000);
            softassert.assertEquals(proposal.get_createproposalpopup_firstname_field(), prop.getProperty("cust_firstName"), "Test Step - 9: First name of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_lasttname_field(), prop.getProperty("cust_lastName"), "Test Step - 9: Last name of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_companyname_field(), prop.getProperty("cust_companyName"), "Test Step - 9: COmpany Name of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_email_field(), prop.getProperty("cust_email"), "Test Step - 9: Email Id of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_city_field(), prop.getProperty("cust_city"), "Test Step - 9: City of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_state_field(), prop.getProperty("cust_state"), "Test Step - 9: State of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_address_field(), prop.getProperty("cust_address1"), "Test Step - 9: Address of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_zipcode_field(), prop.getProperty("cust_zipcode"), "Test Step - 9: Zipcode of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_phonenumber_field(), prop.getProperty("cust_phoneNumber"), "Test Step - 9: Phone number of customer is not displayed in create proposal popup");
            softassert.assertEquals(proposal.get_createproposalpopup_altphonenumber_field(), prop.getProperty("cust_Alt_phoneNumber"), "Test Step - 9: Alternative Phone number of customer is not displayed in create proposal popup");
            delayWithGivenTime(2000);
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Selected_Category_On_ItemsAndProducts(), category, "Test Step - 10: Selected category is not displayed on manage proposal page");
            delayWithGivenTime(2000);
    ...
    public void Validate_Hana_T1340_Configuration_Settings_Order_Entry_Product_Categories_IsEvent_Toogle_Disabled_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            settingsPage.turnOff_IsEvent_Toogle_Button_On_AddNewRecord_Popup();
            delayWithGivenTime(2000);
            softassert.assertTrue(settingsPage.verify_IsEvent_Toogle_Button_On_TurnOff_State_AddNewRecord_Popup(), "Test Step - 9: IsEvent toggle button is not displayed as disabled state on add new record popup after turning off");
            ...
            softassert.assertFalse(manageproposal.verify_Product_Category_Option_IsNotDisplayed(category), "Test Step - 10: Selected category is not displayed on manage proposal page");
            delayWithGivenTime(2000);
