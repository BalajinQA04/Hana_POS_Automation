...
public class Hana_T1348_Configuration_Settings_Order_Entry_Product_Categories_IsWedding_Toogle_Enabled_Functionality_Test extends TestBaseClass {
    ...
    public void Validate_Hana_T1348_Configuration_Settings_Order_Entry_Product_Categories_IsWedding_Toogle_Enabled_Functionality_Test(
            String username,
            String password,
            String shopname,
            String salesperson,
        ...
        try {
            ...
            delayWithGivenTime(2000);
            softassert.assertTrue(settingsPage.verify_IsWedding_Toogle_Button_On_TurnOn_State_AddNewRecord_Popup(), "Test Step - 6: IsWedding toggle button is not displayed on add new record popup");
            ...
            delayWithGivenTime(2000);
            softassert.assertEquals(manageproposal.get_Selected_Category_On_ItemsAndProducts(), category, "Test Step - 10: Selected category is not displayed on wedding - manage proposal page");
            delayWithGivenTime(2000);
