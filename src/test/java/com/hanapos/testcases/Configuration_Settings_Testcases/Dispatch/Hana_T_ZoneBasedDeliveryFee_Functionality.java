package com.hanapos.testcases.Configuration_Settings_Testcases.Dispatch;
...
public class Hana_T_ZoneBasedDeliveryFee_Functionality extends TestBaseClass {
    private LoginPage lp;
    private HanaDashBoardPage dashboard;
    private OrderEntry_Alais_PhoneOrderPage phoneorder;

    @Epic("Configuration Settings Module - Dispatch settings")
    @Test(enabled = true, groups = {"Regression", "Sanity"})
    public void Validate_Hana_T_ZoneBasedDeliveryFee_Functionality_Test() {
        ...
        try {
            ...
            delayWithGivenTime(2000);
            settingsPage.Select_DeliveryFeeType_on_OrderEntrySettings("Zone");
